...
import uk.co.real_logic.artio.builder.MultilegOrderCancelReplaceRequestEncoder;
...
import static uk.co.real_logic.artio.builder.MultilegOrderCancelReplaceRequestEncoder.AllocsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MultilegOrderCancelReplaceRequestEncoder.TradingSessionsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MultilegOrderCancelReplaceRequestEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MultilegOrderCancelReplaceRequestEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MultilegOrderCancelReplaceRequestEncoder.LegsGroupEncoder.LegAllocsGroupEncoder;
...
public class MultilegOrderCancelReplaceRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, OrderQtyDataDecoder, CommissionDataDecoder, PegInstructionsDecoder, DiscretionInstructionsDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(254);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(254);
    ...
    public boolean validate()
    {
        ...
        if (hasLocateReqd)
        {
        if (CODEC_VALIDATION_ENABLED && locateReqdLength > 1)
        {
            invalidTagId = 114;
            rejectReason = 5;
            return false;
        ...
        if (hasForexReq)
        {
        if (CODEC_VALIDATION_ENABLED && forexReqLength > 1)
        {
            invalidTagId = 121;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 17217L;

    public static final String MESSAGE_TYPE_AS_STRING = "AC";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(630);
    ...
    /* OrigOrdModTime = 586 */
    public AsciiSequenceView origOrdModTime(final AsciiSequenceView view)
    {
        if (!hasOrigOrdModTime)
        {
            throw new IllegalArgumentException("No value for optional field: OrigOrdModTime");
        ...
        return view.wrap(buffer, origOrdModTimeOffset, origOrdModTimeLength);
    }
...
public class AllocsGroupDecoder extends CommonDecoderImpl implements NestedParties3Decoder
{
        ...
        while (position < end)
        {
            ...
            case Constants.NO_NESTED3_PARTY_IDS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noNested3PartyIDsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = nested3PartyIDsGroupCurrent.decode(buffer, position, end - position);
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (nested3PartyIDsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (nested3PartyIDsGroupCurrent != null) 
                            {
    ...
    public MultilegOrderCancelReplaceRequestEncoder.AllocsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MultilegOrderCancelReplaceRequestEncoder.AllocsGroupEncoder)encoder);
    }

    public MultilegOrderCancelReplaceRequestEncoder.AllocsGroupEncoder toEncoder(final MultilegOrderCancelReplaceRequestEncoder.AllocsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasAllocAccount())
        {
    ...
    {
        private final MultilegOrderCancelReplaceRequestDecoder parent;
        private int remainder;
        private AllocsGroupDecoder current;

        public AllocsGroupIterator(final MultilegOrderCancelReplaceRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradingSessionsGroupDecoder extends CommonDecoderImpl
{
    ...
    public MultilegOrderCancelReplaceRequestEncoder.TradingSessionsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MultilegOrderCancelReplaceRequestEncoder.TradingSessionsGroupEncoder)encoder);
    }

    public MultilegOrderCancelReplaceRequestEncoder.TradingSessionsGroupEncoder toEncoder(final MultilegOrderCancelReplaceRequestEncoder.TradingSessionsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradingSessionID())
        {
    ...
    public class TradingSessionsGroupIterator implements Iterable<TradingSessionsGroupDecoder>, java.util.Iterator<TradingSessionsGroupDecoder>
    {
        ...
        public TradingSessionsGroupIterator(final MultilegOrderCancelReplaceRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public MultilegOrderCancelReplaceRequestEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MultilegOrderCancelReplaceRequestEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public MultilegOrderCancelReplaceRequestEncoder.UnderlyingsGroupEncoder toEncoder(final MultilegOrderCancelReplaceRequestEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final MultilegOrderCancelReplaceRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegAllocsGroupDecoder extends CommonDecoderImpl implements NestedParties2Decoder
{
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.LEG_ALLOC_QTY:
                hasLegAllocQty = true;
                legAllocQty = getFloat(buffer, legAllocQty, valueOffset, valueLength, 673, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
        ...
        while (position < end)
        {
            ...
            case Constants.NO_LEG_ALLOCS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noLegAllocsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = legAllocsGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (legAllocsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (legAllocsGroupCurrent != null) 
                            {
    ...
    public MultilegOrderCancelReplaceRequestEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MultilegOrderCancelReplaceRequestEncoder.LegsGroupEncoder)encoder);
    }

    public MultilegOrderCancelReplaceRequestEncoder.LegsGroupEncoder toEncoder(final MultilegOrderCancelReplaceRequestEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final MultilegOrderCancelReplaceRequestDecoder parent)
        {
            this.parent = parent;
        }
    ...
    private int locateReqdLength = 0;
    public int locateReqdLength()    {
       return locateReqdLength;
    }
 ...
 return CustOrderCapacity.NULL_VAL;
    ...
    private int forexReqLength = 0;
    public int forexReqLength()    {
       return forexReqLength;
    }
 ...
 return MultiLegRptTypeReq.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        // Decode MultilegOrderCancelReplaceRequest
        int seenFieldCount = 0;
        if (CODEC_VALIDATION_ENABLED)
        {
            missingRequiredFields.copy(REQUIRED_FIELDS);
        ...
        while (position < end)
        {
            ...
            case Constants.PREV_CLOSE_PX:
                hasPrevClosePx = true;
                prevClosePx = getFloat(buffer, prevClosePx, valueOffset, valueLength, 140, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    public MultilegOrderCancelReplaceRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MultilegOrderCancelReplaceRequestEncoder)encoder);
    }

    public MultilegOrderCancelReplaceRequestEncoder toEncoder(final MultilegOrderCancelReplaceRequestEncoder encoder)
    {
        encoder.reset();
        if (hasOrderID())
        {
