...
public class HeaderDecoder extends CommonDecoderImpl implements SessionHeaderDecoder
{
    ...
    /* OnBehalfOfCompID = 115 */
    public AsciiSequenceView onBehalfOfCompID(final AsciiSequenceView view)
    {
        if (!hasOnBehalfOfCompID)
        {
            throw new IllegalArgumentException("No value for optional field: OnBehalfOfCompID");
        ...
        return view.wrap(buffer, onBehalfOfCompIDOffset, onBehalfOfCompIDLength);
    }
    ...
    /* DeliverToCompID = 128 */
    public AsciiSequenceView deliverToCompID(final AsciiSequenceView view)
    {
        if (!hasDeliverToCompID)
        {
            throw new IllegalArgumentException("No value for optional field: DeliverToCompID");
        ...
        return view.wrap(buffer, deliverToCompIDOffset, deliverToCompIDLength);
    }
    ...
    /* OnBehalfOfSubID = 116 */
    public AsciiSequenceView onBehalfOfSubID(final AsciiSequenceView view)
    {
        if (!hasOnBehalfOfSubID)
        {
            throw new IllegalArgumentException("No value for optional field: OnBehalfOfSubID");
        ...
        return view.wrap(buffer, onBehalfOfSubIDOffset, onBehalfOfSubIDLength);
    }
    ...
    /* OnBehalfOfLocationID = 144 */
    public AsciiSequenceView onBehalfOfLocationID(final AsciiSequenceView view)
    {
        if (!hasOnBehalfOfLocationID)
        {
            throw new IllegalArgumentException("No value for optional field: OnBehalfOfLocationID");
        ...
        return view.wrap(buffer, onBehalfOfLocationIDOffset, onBehalfOfLocationIDLength);
    }
    ...
    /* DeliverToSubID = 129 */
    public AsciiSequenceView deliverToSubID(final AsciiSequenceView view)
    {
        if (!hasDeliverToSubID)
        {
            throw new IllegalArgumentException("No value for optional field: DeliverToSubID");
        ...
        return view.wrap(buffer, deliverToSubIDOffset, deliverToSubIDLength);
    }
    ...
    /* DeliverToLocationID = 145 */
    public AsciiSequenceView deliverToLocationID(final AsciiSequenceView view)
    {
        if (!hasDeliverToLocationID)
        {
            throw new IllegalArgumentException("No value for optional field: DeliverToLocationID");
        ...
        return view.wrap(buffer, deliverToLocationIDOffset, deliverToLocationIDLength);
    }
    ...
    /* MessageEncoding = 347 */
    public AsciiSequenceView messageEncoding(final AsciiSequenceView view)
    {
        if (!hasMessageEncoding)
        {
            throw new IllegalArgumentException("No value for optional field: MessageEncoding");
        ...
        return view.wrap(buffer, messageEncodingOffset, messageEncodingLength);
    }
