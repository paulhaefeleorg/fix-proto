...
import uk.co.real_logic.artio.builder.ListStatusEncoder;
import static uk.co.real_logic.artio.builder.ListStatusEncoder.OrdersGroupEncoder;
...
public class ListStatusDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    /* ListStatusText = 444 */
    public AsciiSequenceView listStatusText(final AsciiSequenceView view)
    {
        if (!hasListStatusText)
        {
            throw new IllegalArgumentException("No value for optional field: ListStatusText");
        ...
        return view.wrap(buffer, listStatusTextOffset, listStatusTextLength);
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.CXL_QTY:
                cxlQty = getFloat(buffer, cxlQty, valueOffset, valueLength, 84, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
