...
import uk.co.real_logic.artio.builder.OrderMassStatusRequestEncoder;
...
public class OrderMassStatusRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, UnderlyingInstrumentDecoder, MessageDecoder
{
...

    {
        ...
        {
            REQUIRED_FIELDS.add(Constants.MASS_STATUS_REQ_ID);
            REQUIRED_FIELDS.add(Constants.MASS_STATUS_REQ_TYPE);
        }
    }
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.MASS_STATUS_REQ_TYPE);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(186);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !MassStatusReqType.isValid(massStatusReqType()))
        {
            invalidTagId = 585;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 17985L;

    public static final String MESSAGE_TYPE_AS_STRING = "AF";
...

    {
        ...
        messageFields.add(Constants.MASS_STATUS_REQ_TYPE);
    ...
    {
        return new String(massStatusReqID, 0, massStatusReqIDLength);
    }
    ...
    private int massStatusReqType = MISSING_INT;
    ...
    private final CharArrayWrapper massStatusReqTypeWrapper = new CharArrayWrapper();
    /* MassStatusReqType = 585 */
    public MassStatusReqType massStatusReqTypeAsEnum()
    {
        return MassStatusReqType.decode(massStatusReqType);
    }
 ...
 return Side.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.MASS_STATUS_REQ_TYPE:
                massStatusReqType = getInt(buffer, valueOffset, endOfField, 585, CODEC_VALIDATION_ENABLED);
                break;
    ...
    public OrderMassStatusRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((OrderMassStatusRequestEncoder)encoder);
    }

    public OrderMassStatusRequestEncoder toEncoder(final OrderMassStatusRequestEncoder encoder)
    {
        encoder.reset();
