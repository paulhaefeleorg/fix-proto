...
import uk.co.real_logic.artio.builder.CollateralReportEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralReportEncoder.ExecsGroupEncoder;
import static uk.co.real_logic.artio.builder.CollateralReportEncoder.TradesGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralReportEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralReportEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralReportEncoder.MiscFeesGroupEncoder;
...
public class CollateralReportDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, TrdRegTimestampsDecoder, SpreadOrBenchmarkCurveDataDecoder, StipulationsDecoder, SettlInstructionsDataDecoder, MessageDecoder
{
...

    {
        ...
        {
            REQUIRED_FIELDS.add(Constants.COLL_RPT_ID);
            REQUIRED_FIELDS.add(Constants.COLL_STATUS);
        }
    }

    public final IntHashSet GROUP_FIELDS = new IntHashSet(190);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            GROUP_FIELDS.add(Constants.COLL_RPT_ID);
            GROUP_FIELDS.add(Constants.COLL_INQUIRY_ID);
            GROUP_FIELDS.add(Constants.COLL_STATUS);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(190);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !CollStatus.isValid(collStatus()))
        {
            invalidTagId = 910;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 16706L;

    public static final String MESSAGE_TYPE_AS_STRING = "BA";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(526);

    {
        ...
        messageFields.add(Constants.COLL_RPT_ID);
        messageFields.add(Constants.COLL_INQUIRY_ID);
        messageFields.add(Constants.COLL_STATUS);
    ...
    private char[] collRptID = new char[1];

    /* CollRptID = 908 */
    public char[] collRptID()
    {
        return collRptID;
    }


    private int collRptIDOffset;

    private int collRptIDLength;

    /* CollRptID = 908 */
    public int collRptIDLength()
    {
        return collRptIDLength;
    }

    /* CollRptID = 908 */
    public String collRptIDAsString()
    {
        return new String(collRptID, 0, collRptIDLength);
    }

    /* CollRptID = 908 */
    public AsciiSequenceView collRptID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, collRptIDOffset, collRptIDLength);
    }


    private final CharArrayWrapper collRptIDWrapper = new CharArrayWrapper();
    ...
    private int collStatus = MISSING_INT;
    ...
    private final CharArrayWrapper collStatusWrapper = new CharArrayWrapper();
    /* CollStatus = 910 */
    public CollStatus collStatusAsEnum()
    {
        return CollStatus.decode(collStatus);
    }
...
public class ExecsGroupDecoder extends CommonDecoderImpl
{
    ...
    public CollateralReportEncoder.ExecsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralReportEncoder.ExecsGroupEncoder)encoder);
    }

    public CollateralReportEncoder.ExecsGroupEncoder toEncoder(final CollateralReportEncoder.ExecsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasExecID())
        {
    ...
    {
        private final CollateralReportDecoder parent;
        private int remainder;
        private ExecsGroupDecoder current;

        public ExecsGroupIterator(final CollateralReportDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradesGroupDecoder extends CommonDecoderImpl
{
    ...
    public CollateralReportEncoder.TradesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralReportEncoder.TradesGroupEncoder)encoder);
    }

    public CollateralReportEncoder.TradesGroupEncoder toEncoder(final CollateralReportEncoder.TradesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradeReportID())
        {
    ...
    public class TradesGroupIterator implements Iterable<TradesGroupDecoder>, java.util.Iterator<TradesGroupDecoder>
    {
        ...
        public TradesGroupIterator(final CollateralReportDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public CollateralReportEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralReportEncoder.LegsGroupEncoder)encoder);
    }

    public CollateralReportEncoder.LegsGroupEncoder toEncoder(final CollateralReportEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final CollateralReportDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public CollateralReportEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralReportEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public CollateralReportEncoder.UnderlyingsGroupEncoder toEncoder(final CollateralReportEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final CollateralReportDecoder parent)
        {
            this.parent = parent;
        }
...
public class MiscFeesGroupDecoder extends CommonDecoderImpl
{
 ...
 return MiscFeeBasis.NULL_VAL;
    ...
    public CollateralReportEncoder.MiscFeesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralReportEncoder.MiscFeesGroupEncoder)encoder);
    }

    public CollateralReportEncoder.MiscFeesGroupEncoder toEncoder(final CollateralReportEncoder.MiscFeesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasMiscFeeAmt())
        {
    ...
    public class MiscFeesGroupIterator implements Iterable<MiscFeesGroupDecoder>, java.util.Iterator<MiscFeesGroupDecoder>
    {
        ...
        public MiscFeesGroupIterator(final CollateralReportDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return StandInstDbType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            switch (tag)
            {
            case Constants.COLL_RPT_ID:
                collRptID = buffer.getChars(collRptID, valueOffset, valueLength);
                collRptIDOffset = valueOffset;
                collRptIDLength = valueLength;
                break;
            ...
            case Constants.COLL_STATUS:
                collStatus = getInt(buffer, valueOffset, endOfField, 910, CODEC_VALIDATION_ENABLED);
                break;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        builder.append(this.collRptID(), 0, collRptIDLength());
        builder.append("\",\n");
    ...
    public CollateralReportEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralReportEncoder)encoder);
    }

    public CollateralReportEncoder toEncoder(final CollateralReportEncoder encoder)
    {
        encoder.reset();
        encoder.collRptID(this.collRptID(), 0, collRptIDLength());
        if (hasCollInquiryID())
        {
