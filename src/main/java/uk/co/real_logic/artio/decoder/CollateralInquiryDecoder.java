...
import uk.co.real_logic.artio.builder.CollateralInquiryEncoder;
import static uk.co.real_logic.artio.builder.CollateralInquiryEncoder.CollInquiryQualifierGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralInquiryEncoder.ExecsGroupEncoder;
import static uk.co.real_logic.artio.builder.CollateralInquiryEncoder.TradesGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralInquiryEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralInquiryEncoder.UnderlyingsGroupEncoder;
...
public class CollateralInquiryDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, TrdRegTimestampsDecoder, SpreadOrBenchmarkCurveDataDecoder, StipulationsDecoder, SettlInstructionsDataDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(188);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            GROUP_FIELDS.add(Constants.COLL_INQUIRY_ID);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(188);
    ...
    public boolean validate()
    {
        ...
        if (hasNoCollInquiryQualifierGroupCounter)
        {
            {
                int count = 0;
                final CollInquiryQualifierGroupIterator iterator = collInquiryQualifierGroupIterator.iterator();
                for (final CollInquiryQualifierGroupDecoder group : iterator)
                {
    ...
    public static final long MESSAGE_TYPE = 16962L;

    public static final String MESSAGE_TYPE_AS_STRING = "BB";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(518);

    {
        ...
        messageFields.add(Constants.COLL_INQUIRY_ID);
        messageFields.add(Constants.NO_COLL_INQUIRY_QUALIFIER_GROUP_COUNTER);
        messageFields.add(Constants.COLL_INQUIRY_QUALIFIER);
    ...
    private char[] collInquiryID = new char[1];

    private boolean hasCollInquiryID;

    /* CollInquiryID = 909 */
    public char[] collInquiryID()
    {
        if (!hasCollInquiryID)
        {
            throw new IllegalArgumentException("No value for optional field: CollInquiryID");
        }
    ...
    {
        return hasCollInquiryID;
    }


    private int collInquiryIDOffset;

    private int collInquiryIDLength;

    /* CollInquiryID = 909 */
    public int collInquiryIDLength()
    {
        if (!hasCollInquiryID)
        {
            throw new IllegalArgumentException("No value for optional field: CollInquiryID");
        ...
        return collInquiryIDLength;
    }

    /* CollInquiryID = 909 */
    public String collInquiryIDAsString()
    {
        return hasCollInquiryID ? new String(collInquiryID, 0, collInquiryIDLength) : null;
    }

    /* CollInquiryID = 909 */
    public AsciiSequenceView collInquiryID(final AsciiSequenceView view)
    {
        if (!hasCollInquiryID)
        {
            throw new IllegalArgumentException("No value for optional field: CollInquiryID");
        ...
        return view.wrap(buffer, collInquiryIDOffset, collInquiryIDLength);
    }


    private final CharArrayWrapper collInquiryIDWrapper = new CharArrayWrapper();
...
public class CollInquiryQualifierGroupDecoder extends CommonDecoderImpl
{
 ...
 return CollInquiryQualifier.NULL_VAL;
    ...
    public CollateralInquiryEncoder.CollInquiryQualifierGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralInquiryEncoder.CollInquiryQualifierGroupEncoder)encoder);
    }

    public CollateralInquiryEncoder.CollInquiryQualifierGroupEncoder toEncoder(final CollateralInquiryEncoder.CollInquiryQualifierGroupEncoder encoder)
    {
        encoder.reset();
        if (hasCollInquiryQualifier())
        {
    ...
    {
        private final CollateralInquiryDecoder parent;
        private int remainder;
        private CollInquiryQualifierGroupDecoder current;

        public CollInquiryQualifierGroupIterator(final CollateralInquiryDecoder parent)
        {
            this.parent = parent;
        }
    ...
    private CollInquiryQualifierGroupDecoder collInquiryQualifierGroup = null;
    public CollInquiryQualifierGroupDecoder collInquiryQualifierGroup()
    {
        return collInquiryQualifierGroup;
    }

    private int noCollInquiryQualifierGroupCounter = MISSING_INT;
    ...
    public int noCollInquiryQualifierGroupCounter()
    {
        if (!hasNoCollInquiryQualifierGroupCounter)
        {
            throw new IllegalArgumentException("No value for optional field: NoCollInquiryQualifierGroupCounter");
        }
    ...
    private CollInquiryQualifierGroupIterator collInquiryQualifierGroupIterator = new CollInquiryQualifierGroupIterator(this);
    public CollInquiryQualifierGroupIterator collInquiryQualifierGroupIterator()
    {
        return collInquiryQualifierGroupIterator.iterator();
    }
...
public class ExecsGroupDecoder extends CommonDecoderImpl
{
    ...
    public CollateralInquiryEncoder.ExecsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralInquiryEncoder.ExecsGroupEncoder)encoder);
    }

    public CollateralInquiryEncoder.ExecsGroupEncoder toEncoder(final CollateralInquiryEncoder.ExecsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasExecID())
        {
    ...
    public class ExecsGroupIterator implements Iterable<ExecsGroupDecoder>, java.util.Iterator<ExecsGroupDecoder>
    {
        ...
        public ExecsGroupIterator(final CollateralInquiryDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradesGroupDecoder extends CommonDecoderImpl
{
    ...
    public CollateralInquiryEncoder.TradesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralInquiryEncoder.TradesGroupEncoder)encoder);
    }

    public CollateralInquiryEncoder.TradesGroupEncoder toEncoder(final CollateralInquiryEncoder.TradesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradeReportID())
        {
    ...
    public class TradesGroupIterator implements Iterable<TradesGroupDecoder>, java.util.Iterator<TradesGroupDecoder>
    {
        ...
        public TradesGroupIterator(final CollateralInquiryDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public CollateralInquiryEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralInquiryEncoder.LegsGroupEncoder)encoder);
    }

    public CollateralInquiryEncoder.LegsGroupEncoder toEncoder(final CollateralInquiryEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final CollateralInquiryDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public CollateralInquiryEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralInquiryEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public CollateralInquiryEncoder.UnderlyingsGroupEncoder toEncoder(final CollateralInquiryEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final CollateralInquiryDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return StandInstDbType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            switch (tag)
            {
            case Constants.COLL_INQUIRY_ID:
                hasCollInquiryID = true;
                collInquiryID = buffer.getChars(collInquiryID, valueOffset, valueLength);
                collInquiryIDOffset = valueOffset;
                collInquiryIDLength = valueLength;
                break;

            case Constants.NO_COLL_INQUIRY_QUALIFIER_GROUP_COUNTER:
                hasNoCollInquiryQualifierGroupCounter = true;
                noCollInquiryQualifierGroupCounter = getInt(buffer, valueOffset, endOfField, 938, CODEC_VALIDATION_ENABLED);
                if (collInquiryQualifierGroup == null)
                {
                    collInquiryQualifierGroup = new CollInquiryQualifierGroupDecoder(trailer, messageFields);
                }
                CollInquiryQualifierGroupDecoder collInquiryQualifierGroupCurrent = collInquiryQualifierGroup;
                position = endOfField + 1;
                final int noCollInquiryQualifierGroupCounter = this.noCollInquiryQualifierGroupCounter;
                for (int i = 0; i < noCollInquiryQualifierGroupCounter && position < end; i++)
                {
                    if (collInquiryQualifierGroupCurrent != null)
                    {
                        positionIter = collInquiryQualifierGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                        ...
                        collInquiryQualifierGroupCurrent = collInquiryQualifierGroupCurrent.next();
                    }
                }
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    {
                        final int checkTag = buffer.getInt(position, checkEqualsPosition);
                        if (collInquiryQualifierGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (collInquiryQualifierGroupCurrent != null) 
                            {
                               position += collInquiryQualifierGroupCurrent.decode(buffer, position, end - position);
                               collInquiryQualifierGroupCurrent = collInquiryQualifierGroupCurrent.next();
                            }
                            return position - offset;
                        }
            ...
            case Constants.NO_TRADES_GROUP_COUNTER:
                ...
                for (int i = 0; i < noTradesGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = tradesGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
            ...
            case Constants.MARGIN_EXCESS:
                ...
                marginExcess = getFloat(buffer, marginExcess, valueOffset, valueLength, 899, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.TOTAL_NET_VALUE:
                hasTotalNetValue = true;
                totalNetValue = getFloat(buffer, totalNetValue, valueOffset, valueLength, 900, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.CASH_OUTSTANDING:
                hasCashOutstanding = true;
                cashOutstanding = getFloat(buffer, cashOutstanding, valueOffset, valueLength, 901, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    {
        for (final CollInquiryQualifierGroupDecoder collInquiryQualifierGroupDecoder : collInquiryQualifierGroupIterator.iterator())
        {
            collInquiryQualifierGroupDecoder.reset();
            if (collInquiryQualifierGroupDecoder.next() == null)
            {
                break;
            }
        }
        noCollInquiryQualifierGroupCounter = MISSING_INT;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasCollInquiryID())
        {
            ...
            builder.append(this.collInquiryID(), 0, collInquiryIDLength());
            builder.append("\",\n");
        }
        ...
        if (hasNoCollInquiryQualifierGroupCounter)
        {
            ...
            CollInquiryQualifierGroupDecoder collInquiryQualifierGroup = this.collInquiryQualifierGroup;
            for (int i = 0, size = this.noCollInquiryQualifierGroupCounter; i < size; i++)
            {
                indent(builder, level);
                collInquiryQualifierGroup.appendTo(builder, level + 1);
                if (collInquiryQualifierGroup.next() != null)
                {
                    builder.append(',');
                }
                builder.append('\n');
    ...
    public CollateralInquiryEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralInquiryEncoder)encoder);
    }

    public CollateralInquiryEncoder toEncoder(final CollateralInquiryEncoder encoder)
    {
        encoder.reset();
        if (hasCollInquiryID())
        {
            encoder.collInquiryID(this.collInquiryID(), 0, collInquiryIDLength());
        }
        ...
        if (hasNoCollInquiryQualifierGroupCounter)
        {
            ...
            for (int i = 0; i < size; i++)
            {
                if (collInquiryQualifierGroup != null)
                {
                    collInquiryQualifierGroup.toEncoder(collInquiryQualifierGroupEncoder);
                    collInquiryQualifierGroup = collInquiryQualifierGroup.next();
