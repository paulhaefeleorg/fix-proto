...
import uk.co.real_logic.artio.builder.SecurityTypeRequestEncoder;

@Generated("uk.co.real_logic.artio")
public class SecurityTypeRequestDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    public static final long MESSAGE_TYPE = 118L;
 ...
 return SecurityType.NULL_VAL;
    ...
    public SecurityTypeRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityTypeRequestEncoder)encoder);
    }

    public SecurityTypeRequestEncoder toEncoder(final SecurityTypeRequestEncoder encoder)
    {
        encoder.reset();
