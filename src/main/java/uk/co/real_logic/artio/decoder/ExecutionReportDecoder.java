...
public class ExecutionReportDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, StipulationsDecoder, OrderQtyDataDecoder, PegInstructionsDecoder, DiscretionInstructionsDecoder, CommissionDataDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(418);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(418);
    ...
    public boolean validate()
    {
        ...
        {
        if (CODEC_VALIDATION_ENABLED && lastRptRequestedLength > 1)
        {
            invalidTagId = 912;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_VALIDATION_ENABLED && ordStatusLength > 1)
        {
            invalidTagId = 39;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_VALIDATION_ENABLED && workingIndicatorLength > 1)
        {
            invalidTagId = 636;
            rejectReason = 5;
            return false;
        ...
        if (hasDayBookingInst)
        {
        if (CODEC_VALIDATION_ENABLED && dayBookingInstLength > 1)
        {
            invalidTagId = 589;
            rejectReason = 5;
            return false;
        ...
        if (hasBookingUnit)
        {
        if (CODEC_VALIDATION_ENABLED && bookingUnitLength > 1)
        {
            invalidTagId = 590;
            rejectReason = 5;
            return false;
        ...
        if (hasCashMargin)
        {
        if (CODEC_VALIDATION_ENABLED && cashMarginLength > 1)
        {
            invalidTagId = 544;
            rejectReason = 5;
            return false;
        ...
        if (hasRoundingDirection)
        {
        if (CODEC_VALIDATION_ENABLED && roundingDirectionLength > 1)
        {
            invalidTagId = 468;
            rejectReason = 5;
            return false;
        ...
        if (hasDiscretionInst)
        {
        if (CODEC_VALIDATION_ENABLED && discretionInstLength > 1)
        {
            invalidTagId = 388;
            rejectReason = 5;
            return false;
        ...
        if (hasSolicitedFlag)
        {
        if (CODEC_VALIDATION_ENABLED && solicitedFlagLength > 1)
        {
            invalidTagId = 377;
            rejectReason = 5;
            return false;
        ...
        if (hasReportToExch)
        {
        if (CODEC_VALIDATION_ENABLED && reportToExchLength > 1)
        {
            invalidTagId = 113;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_VALIDATION_ENABLED && tradedFlatSwitchLength > 1)
        {
            invalidTagId = 258;
            rejectReason = 5;
            return false;
        ...
        if (hasMultiLegReportingType)
        {
        if (CODEC_VALIDATION_ENABLED && multiLegReportingTypeLength > 1)
        {
            invalidTagId = 442;
            rejectReason = 5;
            return false;
        ...
        if (hasCancellationRights)
        {
        if (CODEC_VALIDATION_ENABLED && cancellationRightsLength > 1)
        {
            invalidTagId = 480;
            rejectReason = 5;
            return false;
        ...
        if (hasMoneyLaunderingStatus)
        {
        if (CODEC_VALIDATION_ENABLED && moneyLaunderingStatusLength > 1)
        {
            invalidTagId = 481;
            rejectReason = 5;
            return false;
        ...
        if (hasExecPriceType)
        {
        if (CODEC_VALIDATION_ENABLED && execPriceTypeLength > 1)
        {
            invalidTagId = 484;
            rejectReason = 5;
            return false;
    ...
    private int lastRptRequestedLength = 0;
    public int lastRptRequestedLength()    {
       return lastRptRequestedLength;
    }
...
public class ContraBrokersGroupDecoder extends CommonDecoderImpl
{
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.CONTRA_TRADE_QTY:
                ...
                contraTradeQty = getFloat(buffer, contraTradeQty, valueOffset, valueLength, 437, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
 ...
 return CrossType.NULL_VAL;
    ...
    private int ordStatusLength = 0;
    public int ordStatusLength()    {
       return ordStatusLength;
    }
    /* OrdStatus = 39 */
    ...
    private int workingIndicatorLength = 0;
    public int workingIndicatorLength()    {
       return workingIndicatorLength;
    }
 ...
 return AccountType.NULL_VAL;
    ...
    private int dayBookingInstLength = 0;
    public int dayBookingInstLength()    {
       return dayBookingInstLength;
    }
 ...
 return DayBookingInst.NULL_VAL;
    ...
    private int bookingUnitLength = 0;
    public int bookingUnitLength()    {
       return bookingUnitLength;
    }
 ...
 return SettlType.NULL_VAL;
    ...
    private int cashMarginLength = 0;
    public int cashMarginLength()    {
       return cashMarginLength;
    }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return QtyType.NULL_VAL;
    ...
    private int roundingDirectionLength = 0;
    public int roundingDirectionLength()    {
       return roundingDirectionLength;
    }
 ...
 return PegScope.NULL_VAL;
    ...
    private int discretionInstLength = 0;
    public int discretionInstLength()    {
       return discretionInstLength;
    }
 ...
 return DiscretionScope.NULL_VAL;
    ...
    private int solicitedFlagLength = 0;
    public int solicitedFlagLength()    {
       return solicitedFlagLength;
    }
 ...
 return GTBookingInst.NULL_VAL;
    ...
    private int reportToExchLength = 0;
    public int reportToExchLength()    {
       return reportToExchLength;
    }
 ...
 return YieldType.NULL_VAL;
    ...
    private int tradedFlatSwitchLength = 0;
    public int tradedFlatSwitchLength()    {
       return tradedFlatSwitchLength;
    }
 ...
 return BookingType.NULL_VAL;
    ...
    private int multiLegReportingTypeLength = 0;
    public int multiLegReportingTypeLength()    {
       return multiLegReportingTypeLength;
    }
 ...
 return MultiLegReportingType.NULL_VAL;
    ...
    private int cancellationRightsLength = 0;
    public int cancellationRightsLength()    {
       return cancellationRightsLength;
    }
 ...
 return CancellationRights.NULL_VAL;
    ...
    private int moneyLaunderingStatusLength = 0;
    public int moneyLaunderingStatusLength()    {
       return moneyLaunderingStatusLength;
    }
 ...
 return MoneyLaunderingStatus.NULL_VAL;
    ...
    private int execPriceTypeLength = 0;
    public int execPriceTypeLength()    {
       return execPriceTypeLength;
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.CONT_AMT_VALUE:
                ...
                contAmtValue = getFloat(buffer, contAmtValue, valueOffset, valueLength, 520, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.LAST_RPT_REQUESTED:
                ...
                lastRptRequestedLength = valueLength;
                break;
            ...
            case Constants.NO_CONTRA_BROKERS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noContraBrokersGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = contraBrokersGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (contraBrokersGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (contraBrokersGroupCurrent != null) 
                            {
            ...
            case Constants.CASH_ORDER_QTY:
                ...
                cashOrderQty = getFloat(buffer, cashOrderQty, valueOffset, valueLength, 152, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.ORDER_PERCENT:
                hasOrderPercent = true;
                orderPercent = getFloat(buffer, orderPercent, valueOffset, valueLength, 516, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.ROUNDING_DIRECTION:
                hasRoundingDirection = true;
                roundingDirection = buffer.getChar(valueOffset);
                roundingDirectionLength = valueLength;
                break;

            case Constants.ROUNDING_MODULUS:
                hasRoundingModulus = true;
                roundingModulus = getFloat(buffer, roundingModulus, valueOffset, valueLength, 469, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.STOP_PX:
                hasStopPx = true;
                stopPx = getFloat(buffer, stopPx, valueOffset, valueLength, 99, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.PEG_OFFSET_VALUE:
                hasPegOffsetValue = true;
                pegOffsetValue = getFloat(buffer, pegOffsetValue, valueOffset, valueLength, 211, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.DISCRETION_INST:
                ...
                discretionInstLength = valueLength;
                break;

            case Constants.DISCRETION_OFFSET_VALUE:
                hasDiscretionOffsetValue = true;
                discretionOffsetValue = getFloat(buffer, discretionOffsetValue, valueOffset, valueLength, 389, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.PEGGED_PRICE:
                hasPeggedPrice = true;
                peggedPrice = getFloat(buffer, peggedPrice, valueOffset, valueLength, 839, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.DISCRETION_PRICE:
                hasDiscretionPrice = true;
                discretionPrice = getFloat(buffer, discretionPrice, valueOffset, valueLength, 845, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.PARTICIPATION_RATE:
                ...
                participationRate = getFloat(buffer, participationRate, valueOffset, valueLength, 849, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.TARGET_STRATEGY_PERFORMANCE:
                hasTargetStrategyPerformance = true;
                targetStrategyPerformance = getFloat(buffer, targetStrategyPerformance, valueOffset, valueLength, 850, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.SOLICITED_FLAG:
                ...
                solicitedFlagLength = valueLength;
                break;
            ...
            case Constants.UNDERLYING_LAST_QTY:
                ...
                underlyingLastQty = getFloat(buffer, underlyingLastQty, valueOffset, valueLength, 652, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.UNDERLYING_LAST_PX:
                ...
                underlyingLastPx = getFloat(buffer, underlyingLastPx, valueOffset, valueLength, 651, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.LAST_SPOT_RATE:
                ...
                lastSpotRate = getFloat(buffer, lastSpotRate, valueOffset, valueLength, 194, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.LAST_FORWARD_POINTS:
                hasLastForwardPoints = true;
                lastForwardPoints = getFloat(buffer, lastForwardPoints, valueOffset, valueLength, 195, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.LEAVES_QTY:
                leavesQty = getFloat(buffer, leavesQty, valueOffset, valueLength, 151, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.CUM_QTY:
                cumQty = getFloat(buffer, cumQty, valueOffset, valueLength, 14, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.DAY_ORDER_QTY:
                hasDayOrderQty = true;
                dayOrderQty = getFloat(buffer, dayOrderQty, valueOffset, valueLength, 424, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.DAY_CUM_QTY:
                hasDayCumQty = true;
                dayCumQty = getFloat(buffer, dayCumQty, valueOffset, valueLength, 425, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.DAY_AVG_PX:
                hasDayAvgPx = true;
                dayAvgPx = getFloat(buffer, dayAvgPx, valueOffset, valueLength, 426, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.REPORT_TO_EXCH:
                ...
                reportToExchLength = valueLength;
                break;
            ...
            case Constants.TRADED_FLAT_SWITCH:
                ...
                tradedFlatSwitchLength = valueLength;
                break;
            ...
            case Constants.BASIS_FEATURE_PRICE:
                ...
                basisFeaturePrice = getFloat(buffer, basisFeaturePrice, valueOffset, valueLength, 260, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.MIN_QTY:
                hasMinQty = true;
                minQty = getFloat(buffer, minQty, valueOffset, valueLength, 110, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.MAX_FLOOR:
                hasMaxFloor = true;
                maxFloor = getFloat(buffer, maxFloor, valueOffset, valueLength, 111, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.MAX_SHOW:
                hasMaxShow = true;
                maxShow = getFloat(buffer, maxShow, valueOffset, valueLength, 210, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.EXEC_PRICE_TYPE:
                ...
                execPriceTypeLength = valueLength;
                break;

            case Constants.EXEC_PRICE_ADJUSTMENT:
                hasExecPriceAdjustment = true;
                execPriceAdjustment = getFloat(buffer, execPriceAdjustment, valueOffset, valueLength, 485, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.PRICE_IMPROVEMENT:
                ...
                priceImprovement = getFloat(buffer, priceImprovement, valueOffset, valueLength, 639, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.NO_CONT_AMTS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noContAmtsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = contAmtsGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (contAmtsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (contAmtsGroupCurrent != null) 
                            {
