...
import static uk.co.real_logic.artio.builder.QuoteRequestEncoder.RelatedSymGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteRequestEncoder.RelatedSymGroupEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteRequestEncoder.RelatedSymGroupEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteRequestEncoder.RelatedSymGroupEncoder.QuoteQualifiersGroupEncoder;
...
public class QuoteRequestDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    public static final long MESSAGE_TYPE = 82L;

    public static final String MESSAGE_TYPE_AS_STRING = "R";
    ...
    /* RFQReqID = 644 */
    public AsciiSequenceView rFQReqID(final AsciiSequenceView view)
    {
        if (!hasRFQReqID)
        {
            throw new IllegalArgumentException("No value for optional field: RFQReqID");
        ...
        return view.wrap(buffer, rFQReqIDOffset, rFQReqIDLength);
    }
...
@Generated("uk.co.real_logic.artio")
public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, FinancingDetailsDecoder, OrderQtyDataDecoder, StipulationsDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, PartiesDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(186);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.QUOTE_REQUEST_TYPE);
            ...
            GROUP_FIELDS.add(Constants.QUOTE_PRICE_TYPE);
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            ALL_GROUP_FIELDS.add(Constants.QUOTE_REQUEST_TYPE);
            ALL_GROUP_FIELDS.add(Constants.QUOTE_TYPE);
            ...
            ALL_GROUP_FIELDS.add(Constants.QUOTE_PRICE_TYPE);
            ALL_GROUP_FIELDS.add(Constants.ORD_TYPE);
            ALL_GROUP_FIELDS.add(Constants.VALID_UNTIL_TIME);
    ...
    public boolean validate()
    {
        ...
        {
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !QuoteRequestType.isValid(quoteRequestType()))
        {
            invalidTagId = 303;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !QuotePriceType.isValid(quotePriceType()))
        {
            invalidTagId = 692;
            rejectReason = 5;
            return false;
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public RelatedSymGroupEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RelatedSymGroupEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public RelatedSymGroupEncoder.UnderlyingsGroupEncoder toEncoder(final RelatedSymGroupEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final RelatedSymGroupDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final RelatedSymGroupDecoder parent)
        {
            this.parent = parent;
        }
    ...
    private int quoteRequestType = MISSING_INT;
    ...
    public int quoteRequestType()
    {
        if (!hasQuoteRequestType)
        {
            throw new IllegalArgumentException("No value for optional field: QuoteRequestType");
        }
    ...
    private final CharArrayWrapper quoteRequestTypeWrapper = new CharArrayWrapper();
    /* QuoteRequestType = 303 */
    public QuoteRequestType quoteRequestTypeAsEnum()
    {
        if (!hasQuoteRequestType)
 return QuoteRequestType.NULL_VAL;
        return QuoteRequestType.decode(quoteRequestType);
    }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder, NestedPartiesDecoder, LegBenchmarkCurveDataDecoder
{
 ...
 return LegSwapType.NULL_VAL;
    ...
    public RelatedSymGroupEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RelatedSymGroupEncoder.LegsGroupEncoder)encoder);
    }

    public RelatedSymGroupEncoder.LegsGroupEncoder toEncoder(final RelatedSymGroupEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final RelatedSymGroupDecoder parent)
        {
            this.parent = parent;
        }
...
public class QuoteQualifiersGroupDecoder extends CommonDecoderImpl
{
    ...
    public RelatedSymGroupEncoder.QuoteQualifiersGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RelatedSymGroupEncoder.QuoteQualifiersGroupEncoder)encoder);
    }

    public RelatedSymGroupEncoder.QuoteQualifiersGroupEncoder toEncoder(final RelatedSymGroupEncoder.QuoteQualifiersGroupEncoder encoder)
    {
        encoder.reset();
        if (hasQuoteQualifier())
        {
    ...
    public class QuoteQualifiersGroupIterator implements Iterable<QuoteQualifiersGroupDecoder>, java.util.Iterator<QuoteQualifiersGroupDecoder>
    {
        ...
        public QuoteQualifiersGroupIterator(final RelatedSymGroupDecoder parent)
        {
            this.parent = parent;
        }
    ...
    private int quotePriceType = MISSING_INT;
    ...
    public int quotePriceType()
    {
        if (!hasQuotePriceType)
        {
            throw new IllegalArgumentException("No value for optional field: QuotePriceType");
        }
    ...
    private final CharArrayWrapper quotePriceTypeWrapper = new CharArrayWrapper();
    /* QuotePriceType = 692 */
    public QuotePriceType quotePriceTypeAsEnum()
    {
        if (!hasQuotePriceType)
 return QuotePriceType.NULL_VAL;
        return QuotePriceType.decode(quotePriceType);
    }
 ...
 return YieldType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.QUOTE_REQUEST_TYPE:
                hasQuoteRequestType = true;
                quoteRequestType = getInt(buffer, valueOffset, endOfField, 303, CODEC_VALIDATION_ENABLED);
                break;
            ...
            case Constants.QUOTE_PRICE_TYPE:
                hasQuotePriceType = true;
                quotePriceType = getInt(buffer, valueOffset, endOfField, 692, CODEC_VALIDATION_ENABLED);
                break;
            ...
            case Constants.PRICE2:
                hasPrice2 = true;
                price2 = getFloat(buffer, price2, valueOffset, valueLength, 640, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    public QuoteRequestEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteRequestEncoder.RelatedSymGroupEncoder)encoder);
    }

    public QuoteRequestEncoder.RelatedSymGroupEncoder toEncoder(final QuoteRequestEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final QuoteRequestDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final QuoteRequestDecoder parent)
        {
            this.parent = parent;
        }
        ...
        while (position < end)
        {
            ...
            case Constants.NO_RELATED_SYM_GROUP_COUNTER:
                ...
                for (int i = 0; i < noRelatedSymGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = relatedSymGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (relatedSymGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (relatedSymGroupCurrent != null) 
                            {
    ...
    public QuoteRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteRequestEncoder)encoder);
    }

    public QuoteRequestEncoder toEncoder(final QuoteRequestEncoder encoder)
    {
        encoder.reset();
