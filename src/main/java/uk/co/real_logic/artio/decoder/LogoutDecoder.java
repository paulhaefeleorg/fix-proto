...
public class LogoutDecoder extends CommonDecoderImpl implements MessageDecoder, AbstractLogoutDecoder
{
    ...
    public static final long MESSAGE_TYPE = 53L;
    ...
    public final IntHashSet messageFields = new IntHashSet(64);
    ...
    public LogoutEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((LogoutEncoder)encoder);
    }

    public LogoutEncoder toEncoder(final LogoutEncoder encoder)
    {
        encoder.reset();
        if (hasText())
        {
