...
public class NewOrderListDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    public boolean validate()
    {
        ...
        if (hasListExecInstType)
        {
        if (CODEC_VALIDATION_ENABLED && listExecInstTypeLength > 1)
        {
            invalidTagId = 433;
            rejectReason = 5;
            return false;
    ...
    public final IntHashSet messageFields = new IntHashSet(548);
 ...
 return MoneyLaunderingStatus.NULL_VAL;
    ...
    private int listExecInstTypeLength = 0;
    public int listExecInstTypeLength()    {
       return listExecInstTypeLength;
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.LIST_EXEC_INST_TYPE:
                ...
                listExecInstTypeLength = valueLength;
                break;
            ...
            case Constants.ALLOWABLE_ONE_SIDEDNESS_PCT:
                ...
                allowableOneSidednessPct = getFloat(buffer, allowableOneSidednessPct, valueOffset, valueLength, 765, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.ALLOWABLE_ONE_SIDEDNESS_VALUE:
                hasAllowableOneSidednessValue = true;
                allowableOneSidednessValue = getFloat(buffer, allowableOneSidednessValue, valueOffset, valueLength, 766, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
