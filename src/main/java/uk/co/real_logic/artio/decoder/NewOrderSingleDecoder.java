...
import static uk.co.real_logic.artio.builder.NewOrderSingleEncoder.AllocsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.NewOrderSingleEncoder.TradingSessionsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.NewOrderSingleEncoder.UnderlyingsGroupEncoder;
...
public class NewOrderSingleDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, StipulationsDecoder, OrderQtyDataDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, CommissionDataDecoder, PegInstructionsDecoder, DiscretionInstructionsDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(298);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(298);
    ...
    public final IntHashSet messageFields = new IntHashSet(528);
...
public class AllocsGroupDecoder extends CommonDecoderImpl implements NestedPartiesDecoder
{
    ...
    public NewOrderSingleEncoder.AllocsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewOrderSingleEncoder.AllocsGroupEncoder)encoder);
    }

    public NewOrderSingleEncoder.AllocsGroupEncoder toEncoder(final NewOrderSingleEncoder.AllocsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasAllocAccount())
        {
    ...
    {
        private final NewOrderSingleDecoder parent;
        private int remainder;
        private AllocsGroupDecoder current;

        public AllocsGroupIterator(final NewOrderSingleDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradingSessionsGroupDecoder extends CommonDecoderImpl
{
    ...
    public NewOrderSingleEncoder.TradingSessionsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewOrderSingleEncoder.TradingSessionsGroupEncoder)encoder);
    }

    public NewOrderSingleEncoder.TradingSessionsGroupEncoder toEncoder(final NewOrderSingleEncoder.TradingSessionsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradingSessionID())
        {
    ...
    public class TradingSessionsGroupIterator implements Iterable<TradingSessionsGroupDecoder>, java.util.Iterator<TradingSessionsGroupDecoder>
    {
        ...
        public TradingSessionsGroupIterator(final NewOrderSingleDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public NewOrderSingleEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewOrderSingleEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public NewOrderSingleEncoder.UnderlyingsGroupEncoder toEncoder(final NewOrderSingleEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final NewOrderSingleDecoder parent)
        {
            this.parent = parent;
        }
