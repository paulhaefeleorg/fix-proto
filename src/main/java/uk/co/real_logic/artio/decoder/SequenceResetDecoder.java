...
public class SequenceResetDecoder extends CommonDecoderImpl implements MessageDecoder, AbstractSequenceResetDecoder
{
    ...
    public boolean validate()
    {
        ...
        if (hasGapFillFlag)
        {
        if (CODEC_VALIDATION_ENABLED && gapFillFlagLength > 1)
        {
            invalidTagId = 123;
            rejectReason = 5;
            return false;
    ...
    public final IntHashSet messageFields = new IntHashSet(62);
    ...
    private int gapFillFlagLength = 0;
    public int gapFillFlagLength()    {
       return gapFillFlagLength;
    }
