...
import static uk.co.real_logic.artio.builder.LogonEncoder.MsgTypesGroupEncoder;
...
public class LogonDecoder extends CommonDecoderImpl implements MessageDecoder, AbstractLogonDecoder
{
    ...
    public boolean validate()
    {
        ...
        {
        if (CODEC_VALIDATION_ENABLED && testMessageIndicatorLength > 1)
        {
            invalidTagId = 464;
            rejectReason = 5;
            return false;
...
public class MsgTypesGroupDecoder extends CommonDecoderImpl
{
    ...
    public boolean validate()
    {
        ...
        if (hasMsgDirection)
        {
        if (CODEC_VALIDATION_ENABLED && msgDirectionLength > 1)
        {
            invalidTagId = 385;
            rejectReason = 5;
            return false;
    ...
    /* RefMsgType = 372 */
    public AsciiSequenceView refMsgType(final AsciiSequenceView view)
    {
        if (!hasRefMsgType)
        {
            throw new IllegalArgumentException("No value for optional field: RefMsgType");
        ...
        return view.wrap(buffer, refMsgTypeOffset, refMsgTypeLength);
    }
    ...
    private int msgDirectionLength = 0;
    public int msgDirectionLength()    {
       return msgDirectionLength;
    }
 ...
 return MsgDirection.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.MSG_DIRECTION:
                ...
                msgDirectionLength = valueLength;
                break;
    ...
    private int testMessageIndicatorLength = 0;
    public int testMessageIndicatorLength()    {
       return testMessageIndicatorLength;
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.TEST_MESSAGE_INDICATOR:
                ...
                testMessageIndicatorLength = valueLength;
                break;
