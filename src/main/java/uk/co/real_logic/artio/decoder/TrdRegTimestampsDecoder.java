...
public class TrdRegTimestampsGroupDecoder extends CommonDecoderImpl
{
    ...
    /* TrdRegTimestamp = 769 */
    public AsciiSequenceView trdRegTimestamp(final AsciiSequenceView view)
    {
        if (!hasTrdRegTimestamp)
        {
            throw new IllegalArgumentException("No value for optional field: TrdRegTimestamp");
        ...
        return view.wrap(buffer, trdRegTimestampOffset, trdRegTimestampLength);
    }
 ...
 return TrdRegTimestampType.NULL_VAL;
    ...
    /* TrdRegTimestampOrigin = 771 */
    public AsciiSequenceView trdRegTimestampOrigin(final AsciiSequenceView view)
    {
        if (!hasTrdRegTimestampOrigin)
        {
            throw new IllegalArgumentException("No value for optional field: TrdRegTimestampOrigin");
        ...
        return view.wrap(buffer, trdRegTimestampOriginOffset, trdRegTimestampOriginLength);
    }
