...
import uk.co.real_logic.artio.builder.TradeCaptureReportRequestAckEncoder;
...
import static uk.co.real_logic.artio.builder.TradeCaptureReportRequestAckEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.TradeCaptureReportRequestAckEncoder.LegsGroupEncoder;
...
public class TradeCaptureReportRequestAckDecoder extends CommonDecoderImpl implements InstrumentDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.TRADE_REQUEST_RESULT);
            REQUIRED_FIELDS.add(Constants.TRADE_REQUEST_STATUS);
        }
    }
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.TRADE_REQUEST_RESULT);
            GROUP_FIELDS.add(Constants.TRADE_REQUEST_STATUS);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(106);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !TradeRequestResult.isValid(tradeRequestResult()))
        {
            invalidTagId = 749;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !TradeRequestStatus.isValid(tradeRequestStatus()))
        {
            invalidTagId = 750;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 20801L;

    public static final String MESSAGE_TYPE_AS_STRING = "AQ";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(374);

    {
        ...
        messageFields.add(Constants.TRADE_REQUEST_RESULT);
        messageFields.add(Constants.TRADE_REQUEST_STATUS);
 ...
 return SubscriptionRequestType.NULL_VAL;
    ...
    private int tradeRequestResult = MISSING_INT;
    ...
    private final CharArrayWrapper tradeRequestResultWrapper = new CharArrayWrapper();
    /* TradeRequestResult = 749 */
    public TradeRequestResult tradeRequestResultAsEnum()
    {
        return TradeRequestResult.decode(tradeRequestResult);
    }

    private int tradeRequestStatus = MISSING_INT;
    ...
    private final CharArrayWrapper tradeRequestStatusWrapper = new CharArrayWrapper();
    /* TradeRequestStatus = 750 */
    public TradeRequestStatus tradeRequestStatusAsEnum()
    {
        return TradeRequestStatus.decode(tradeRequestStatus);
    }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public TradeCaptureReportRequestAckEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((TradeCaptureReportRequestAckEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public TradeCaptureReportRequestAckEncoder.UnderlyingsGroupEncoder toEncoder(final TradeCaptureReportRequestAckEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final TradeCaptureReportRequestAckDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final TradeCaptureReportRequestAckDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public TradeCaptureReportRequestAckEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((TradeCaptureReportRequestAckEncoder.LegsGroupEncoder)encoder);
    }

    public TradeCaptureReportRequestAckEncoder.LegsGroupEncoder toEncoder(final TradeCaptureReportRequestAckEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final TradeCaptureReportRequestAckDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return ResponseTransportType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        // Decode TradeCaptureReportRequestAck
        int seenFieldCount = 0;
        if (CODEC_VALIDATION_ENABLED)
        {
            missingRequiredFields.copy(REQUIRED_FIELDS);
        ...
        while (position < end)
        {
            ...
            case Constants.TRADE_REQUEST_RESULT:
                tradeRequestResult = getInt(buffer, valueOffset, endOfField, 749, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.TRADE_REQUEST_STATUS:
                tradeRequestStatus = getInt(buffer, valueOffset, endOfField, 750, CODEC_VALIDATION_ENABLED);
                break;
    ...
    {
        tradeRequestResult = MISSING_INT;
    }

    public void resetTradeRequestStatus()
    {
        tradeRequestStatus = MISSING_INT;
    }
    ...
    public TradeCaptureReportRequestAckEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((TradeCaptureReportRequestAckEncoder)encoder);
    }

    public TradeCaptureReportRequestAckEncoder toEncoder(final TradeCaptureReportRequestAckEncoder encoder)
    {
        encoder.reset();
