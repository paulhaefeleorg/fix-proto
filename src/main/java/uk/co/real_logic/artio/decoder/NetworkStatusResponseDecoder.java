...
import uk.co.real_logic.artio.builder.NetworkStatusResponseEncoder;
import static uk.co.real_logic.artio.builder.NetworkStatusResponseEncoder.CompIDsGroupEncoder;
...
public class NetworkStatusResponseDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    /* NetworkRequestID = 933 */
    public AsciiSequenceView networkRequestID(final AsciiSequenceView view)
    {
        if (!hasNetworkRequestID)
        {
            throw new IllegalArgumentException("No value for optional field: NetworkRequestID");
        ...
        return view.wrap(buffer, networkRequestIDOffset, networkRequestIDLength);
    }
    ...
    /* NetworkResponseID = 932 */
    public AsciiSequenceView networkResponseID(final AsciiSequenceView view)
    {
        if (!hasNetworkResponseID)
        {
            throw new IllegalArgumentException("No value for optional field: NetworkResponseID");
        ...
        return view.wrap(buffer, networkResponseIDOffset, networkResponseIDLength);
    }
    ...
    /* LastNetworkResponseID = 934 */
    public AsciiSequenceView lastNetworkResponseID(final AsciiSequenceView view)
    {
        if (!hasLastNetworkResponseID)
        {
            throw new IllegalArgumentException("No value for optional field: LastNetworkResponseID");
        ...
        return view.wrap(buffer, lastNetworkResponseIDOffset, lastNetworkResponseIDLength);
    }
...
public class CompIDsGroupDecoder extends CommonDecoderImpl
{
    ...
    /* RefCompID = 930 */
    public AsciiSequenceView refCompID(final AsciiSequenceView view)
    {
        if (!hasRefCompID)
        {
            throw new IllegalArgumentException("No value for optional field: RefCompID");
        ...
        return view.wrap(buffer, refCompIDOffset, refCompIDLength);
    }
    ...
    /* RefSubID = 931 */
    public AsciiSequenceView refSubID(final AsciiSequenceView view)
    {
        if (!hasRefSubID)
        {
            throw new IllegalArgumentException("No value for optional field: RefSubID");
        ...
        return view.wrap(buffer, refSubIDOffset, refSubIDLength);
    }
 ...
 return StatusValue.NULL_VAL;
    ...
    /* StatusText = 929 */
    public AsciiSequenceView statusText(final AsciiSequenceView view)
    {
        if (!hasStatusText)
        {
            throw new IllegalArgumentException("No value for optional field: StatusText");
        ...
        return view.wrap(buffer, statusTextOffset, statusTextLength);
    }
        ...
        while (position < end)
        {
            ...
            case Constants.NO_COMP_IDS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noCompIDsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = compIDsGroupCurrent.decode(buffer, position, end - position);
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (compIDsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (compIDsGroupCurrent != null) 
                            {
