...
import uk.co.real_logic.artio.builder.SecurityListEncoder;
import static uk.co.real_logic.artio.builder.SecurityListEncoder.RelatedSymGroupEncoder;
...
import static uk.co.real_logic.artio.builder.SecurityListEncoder.RelatedSymGroupEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.SecurityListEncoder.RelatedSymGroupEncoder.LegsGroupEncoder;
...
public class SecurityListDecoder extends CommonDecoderImpl implements MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.SECURITY_REQUEST_RESULT);
        }
    }
    ...
    public static final long MESSAGE_TYPE = 121L;
    ...
    public final IntHashSet messageFields = new IntHashSet(462);
    ...
    /* SecurityReqID = 320 */
    public AsciiSequenceView securityReqID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, securityReqIDOffset, securityReqIDLength);
    }
    ...
    /* SecurityResponseID = 322 */
    public AsciiSequenceView securityResponseID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, securityResponseIDOffset, securityResponseIDLength);
    }
...
@Generated("uk.co.real_logic.artio")
public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrumentExtensionDecoder, FinancingDetailsDecoder, StipulationsDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(150);
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            ALL_GROUP_FIELDS.add(Constants.ROUND_LOT);
            ALL_GROUP_FIELDS.add(Constants.MIN_TRADE_VOL);
            ALL_GROUP_FIELDS.add(Constants.TRADING_SESSION_ID);
            ALL_GROUP_FIELDS.add(Constants.TRADING_SESSION_SUB_ID);
            ALL_GROUP_FIELDS.add(Constants.EXPIRATION_CYCLE);
    ...
    private IntHashSet seenFields = new IntHashSet(34);
...
@Generated("uk.co.real_logic.artio")
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder, LegBenchmarkCurveDataDecoder
{
    public final IntHashSet REQUIRED_FIELDS = new IntHashSet(0);
 ...
 return ExpirationCycle.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.ROUND_LOT:
                hasRoundLot = true;
                roundLot = getFloat(buffer, roundLot, valueOffset, valueLength, 561, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.MIN_TRADE_VOL:
                hasMinTradeVol = true;
                minTradeVol = getFloat(buffer, minTradeVol, valueOffset, valueLength, 562, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    public SecurityListEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityListEncoder.RelatedSymGroupEncoder)encoder);
    }

    public SecurityListEncoder.RelatedSymGroupEncoder toEncoder(final SecurityListEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final SecurityListDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final SecurityListDecoder parent)
        {
            this.parent = parent;
        }
    ...
    {
        securityRequestResult = MISSING_INT;
    }
    ...
    public SecurityListEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityListEncoder)encoder);
    }

    public SecurityListEncoder toEncoder(final SecurityListEncoder encoder)
    {
        encoder.reset();
