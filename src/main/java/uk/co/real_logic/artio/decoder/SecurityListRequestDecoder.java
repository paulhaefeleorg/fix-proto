...
import uk.co.real_logic.artio.builder.SecurityListRequestEncoder;
...
import static uk.co.real_logic.artio.builder.SecurityListRequestEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.SecurityListRequestEncoder.LegsGroupEncoder;
...
public class SecurityListRequestDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrumentExtensionDecoder, FinancingDetailsDecoder, MessageDecoder
{
    ...
    public static final long MESSAGE_TYPE = 120L;
    ...
    public final IntHashSet messageFields = new IntHashSet(396);
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public SecurityListRequestEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityListRequestEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public SecurityListRequestEncoder.UnderlyingsGroupEncoder toEncoder(final SecurityListRequestEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final SecurityListRequestDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final SecurityListRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public SecurityListRequestEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityListRequestEncoder.LegsGroupEncoder)encoder);
    }

    public SecurityListRequestEncoder.LegsGroupEncoder toEncoder(final SecurityListRequestEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final SecurityListRequestDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return SubscriptionRequestType.NULL_VAL;
    ...
    public SecurityListRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityListRequestEncoder)encoder);
    }

    public SecurityListRequestEncoder toEncoder(final SecurityListRequestEncoder encoder)
    {
        encoder.reset();
