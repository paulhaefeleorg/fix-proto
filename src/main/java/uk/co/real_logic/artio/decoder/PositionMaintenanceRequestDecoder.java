...
import uk.co.real_logic.artio.builder.PositionMaintenanceRequestEncoder;
...
import static uk.co.real_logic.artio.builder.PositionMaintenanceRequestEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.PositionMaintenanceRequestEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.PositionMaintenanceRequestEncoder.TradingSessionsGroupEncoder;
...
public class PositionMaintenanceRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, PositionQtyDecoder, MessageDecoder
{
...

    {
        ...
        {
            REQUIRED_FIELDS.add(Constants.POS_REQ_ID);
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.CONTRARY_INSTRUCTION_INDICATOR);
            GROUP_FIELDS.add(Constants.PRIOR_SPREAD_INDICATOR);
    ...
    public boolean validate()
    {
        ...
        {
        if (CODEC_VALIDATION_ENABLED && contraryInstructionIndicatorLength > 1)
        {
            invalidTagId = 719;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_VALIDATION_ENABLED && priorSpreadIndicatorLength > 1)
        {
            invalidTagId = 720;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 19521L;

    public static final String MESSAGE_TYPE_AS_STRING = "AL";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(434);

    {
        ...
        messageFields.add(Constants.CONTRARY_INSTRUCTION_INDICATOR);
        messageFields.add(Constants.PRIOR_SPREAD_INDICATOR);
    ...
    {
        return new String(posReqID, 0, posReqIDLength);
    }
    ...
    private boolean hasOrigPosReqRefID;
    ...
    public char[] origPosReqRefID()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: OrigPosReqRefID");
        }
    ...
    {
        return hasOrigPosReqRefID ? new String(origPosReqRefID, 0, origPosReqRefIDLength) : null;
    }
    ...
    /* PosMaintRptRefID = 714 */
    public AsciiSequenceView posMaintRptRefID(final AsciiSequenceView view)
    {
        if (!hasPosMaintRptRefID)
        {
            throw new IllegalArgumentException("No value for optional field: PosMaintRptRefID");
        ...
        return view.wrap(buffer, posMaintRptRefIDOffset, posMaintRptRefIDLength);
    }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public PositionMaintenanceRequestEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((PositionMaintenanceRequestEncoder.LegsGroupEncoder)encoder);
    }

    public PositionMaintenanceRequestEncoder.LegsGroupEncoder toEncoder(final PositionMaintenanceRequestEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final PositionMaintenanceRequestDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final PositionMaintenanceRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public PositionMaintenanceRequestEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((PositionMaintenanceRequestEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public PositionMaintenanceRequestEncoder.UnderlyingsGroupEncoder toEncoder(final PositionMaintenanceRequestEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final PositionMaintenanceRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradingSessionsGroupDecoder extends CommonDecoderImpl
{
    ...
    public PositionMaintenanceRequestEncoder.TradingSessionsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((PositionMaintenanceRequestEncoder.TradingSessionsGroupEncoder)encoder);
    }

    public PositionMaintenanceRequestEncoder.TradingSessionsGroupEncoder toEncoder(final PositionMaintenanceRequestEncoder.TradingSessionsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradingSessionID())
        {
    ...
    public class TradingSessionsGroupIterator implements Iterable<TradingSessionsGroupDecoder>, java.util.Iterator<TradingSessionsGroupDecoder>
    {
        ...
        public TradingSessionsGroupIterator(final PositionMaintenanceRequestDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return AdjustmentType.NULL_VAL;
    ...
    private int contraryInstructionIndicatorLength = 0;
    public int contraryInstructionIndicatorLength()    {
       return contraryInstructionIndicatorLength;
    }
    ...
    public boolean contraryInstructionIndicator()
    {
        if (!hasContraryInstructionIndicator)
        {
            throw new IllegalArgumentException("No value for optional field: ContraryInstructionIndicator");
        }
    ...
    private int priorSpreadIndicatorLength = 0;
    public int priorSpreadIndicatorLength()    {
       return priorSpreadIndicatorLength;
    }
    ...
    public boolean priorSpreadIndicator()
    {
        if (!hasPriorSpreadIndicator)
        {
            throw new IllegalArgumentException("No value for optional field: PriorSpreadIndicator");
        }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        // Decode PositionMaintenanceRequest
        int seenFieldCount = 0;
        if (CODEC_VALIDATION_ENABLED)
        {
            missingRequiredFields.copy(REQUIRED_FIELDS);
        ...
        while (position < end)
        {
            ...
            case Constants.CONTRARY_INSTRUCTION_INDICATOR:
                hasContraryInstructionIndicator = true;
                contraryInstructionIndicator = buffer.getBoolean(valueOffset);
                contraryInstructionIndicatorLength = valueLength;
                break;

            case Constants.PRIOR_SPREAD_INDICATOR:
                hasPriorSpreadIndicator = true;
                priorSpreadIndicator = buffer.getBoolean(valueOffset);
                priorSpreadIndicatorLength = valueLength;
                break;
    ...
    public PositionMaintenanceRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((PositionMaintenanceRequestEncoder)encoder);
    }

    public PositionMaintenanceRequestEncoder toEncoder(final PositionMaintenanceRequestEncoder encoder)
    {
        encoder.reset();
