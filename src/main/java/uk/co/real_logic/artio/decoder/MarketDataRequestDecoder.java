...
import uk.co.real_logic.artio.builder.MarketDataRequestEncoder;
import static uk.co.real_logic.artio.builder.MarketDataRequestEncoder.MDEntryTypesGroupEncoder;
import static uk.co.real_logic.artio.builder.MarketDataRequestEncoder.RelatedSymGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MarketDataRequestEncoder.RelatedSymGroupEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MarketDataRequestEncoder.RelatedSymGroupEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MarketDataRequestEncoder.TradingSessionsGroupEncoder;

@Generated("uk.co.real_logic.artio")
public class MarketDataRequestDecoder extends CommonDecoderImpl implements MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.NO_M_D_ENTRY_TYPES_GROUP_COUNTER);
    ...
    public boolean validate()
    {
        ...
        {
        if (CODEC_VALIDATION_ENABLED && aggregatedBookLength > 1)
        {
            invalidTagId = 266;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_VALIDATION_ENABLED && mDImplicitDeleteLength > 1)
        {
            invalidTagId = 547;
            rejectReason = 5;
            return false;
    ...
    public final IntHashSet messageFields = new IntHashSet(382);

    {
        ...
        messageFields.add(Constants.NO_M_D_ENTRY_TYPES_GROUP_COUNTER);
 ...
 return MDUpdateType.NULL_VAL;
    ...
    private int aggregatedBookLength = 0;
    public int aggregatedBookLength()    {
       return aggregatedBookLength;
    }
    ...
    private int mDImplicitDeleteLength = 0;
    public int mDImplicitDeleteLength()    {
       return mDImplicitDeleteLength;
    }
...
public class MDEntryTypesGroupDecoder extends CommonDecoderImpl
{
    ...
    public MarketDataRequestEncoder.MDEntryTypesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MarketDataRequestEncoder.MDEntryTypesGroupEncoder)encoder);
    }

    public MarketDataRequestEncoder.MDEntryTypesGroupEncoder toEncoder(final MarketDataRequestEncoder.MDEntryTypesGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final MarketDataRequestDecoder parent;
        private int remainder;
        private MDEntryTypesGroupDecoder current;

        public MDEntryTypesGroupIterator(final MarketDataRequestDecoder parent)
        {
            this.parent = parent;
        }
    ...
    /* NoMDEntryTypesGroupCounter = 267 */
...
@Generated("uk.co.real_logic.artio")
public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder
{
    public final IntHashSet REQUIRED_FIELDS = new IntHashSet(2);
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public MarketDataRequestEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MarketDataRequestEncoder.RelatedSymGroupEncoder)encoder);
    }

    public MarketDataRequestEncoder.RelatedSymGroupEncoder toEncoder(final MarketDataRequestEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class RelatedSymGroupIterator implements Iterable<RelatedSymGroupDecoder>, java.util.Iterator<RelatedSymGroupDecoder>
    {
        ...
        public RelatedSymGroupIterator(final MarketDataRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradingSessionsGroupDecoder extends CommonDecoderImpl
{
    ...
    public MarketDataRequestEncoder.TradingSessionsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MarketDataRequestEncoder.TradingSessionsGroupEncoder)encoder);
    }

    public MarketDataRequestEncoder.TradingSessionsGroupEncoder toEncoder(final MarketDataRequestEncoder.TradingSessionsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradingSessionID())
        {
    ...
    public class TradingSessionsGroupIterator implements Iterable<TradingSessionsGroupDecoder>, java.util.Iterator<TradingSessionsGroupDecoder>
    {
        ...
        public TradingSessionsGroupIterator(final MarketDataRequestDecoder parent)
        {
            this.parent = parent;
        }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.AGGREGATED_BOOK:
                ...
                aggregatedBookLength = valueLength;
                break;
            ...
            case Constants.M_D_IMPLICIT_DELETE:
                ...
                mDImplicitDeleteLength = valueLength;
                break;

            case Constants.NO_M_D_ENTRY_TYPES_GROUP_COUNTER:
                ...
                for (int i = 0; i < noMDEntryTypesGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = mDEntryTypesGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (mDEntryTypesGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (mDEntryTypesGroupCurrent != null) 
                            {
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasNoMDEntryTypesGroupCounter)
        {
            ...
            for (int i = 0, size = this.noMDEntryTypesGroupCounter; i < size; i++)
            {
                ...
                if (mDEntryTypesGroup.next() != null)
                {
                    builder.append(',');
                }
                builder.append('\n');
