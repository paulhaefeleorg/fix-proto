...
import uk.co.real_logic.artio.builder.OrderCancelRejectEncoder;
...
public class OrderCancelRejectDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    public boolean validate()
    {
        ...
        if (CODEC_VALIDATION_ENABLED && cxlRejResponseToLength > 1)
        {
            invalidTagId = 434;
            rejectReason = 5;
            return false;
 ...
 return AccountType.NULL_VAL;
    ...
    private int cxlRejResponseToLength = 0;
    public int cxlRejResponseToLength()    {
       return cxlRejResponseToLength;
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.CXL_REJ_RESPONSE_TO:
                ...
                cxlRejResponseToLength = valueLength;
                break;
