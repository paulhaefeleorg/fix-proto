...
import uk.co.real_logic.artio.builder.CollateralRequestEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralRequestEncoder.ExecsGroupEncoder;
import static uk.co.real_logic.artio.builder.CollateralRequestEncoder.TradesGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralRequestEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralRequestEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralRequestEncoder.MiscFeesGroupEncoder;
...
public class CollateralRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, TrdRegTimestampsDecoder, SpreadOrBenchmarkCurveDataDecoder, StipulationsDecoder, MessageDecoder
{
...

    {
        ...
        {
            REQUIRED_FIELDS.add(Constants.COLL_REQ_ID);
            REQUIRED_FIELDS.add(Constants.COLL_ASGN_REASON);
            REQUIRED_FIELDS.add(Constants.TRANSACT_TIME);
        }
    }

    public final IntHashSet GROUP_FIELDS = new IntHashSet(180);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(180);
    ...
    public static final long MESSAGE_TYPE = 22593L;

    public static final String MESSAGE_TYPE_AS_STRING = "AX";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(498);
    ...
    {
        return new String(collReqID, 0, collReqIDLength);
    }
...
public class ExecsGroupDecoder extends CommonDecoderImpl
{
    ...
    public CollateralRequestEncoder.ExecsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralRequestEncoder.ExecsGroupEncoder)encoder);
    }

    public CollateralRequestEncoder.ExecsGroupEncoder toEncoder(final CollateralRequestEncoder.ExecsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasExecID())
        {
    ...
    {
        private final CollateralRequestDecoder parent;
        private int remainder;
        private ExecsGroupDecoder current;

        public ExecsGroupIterator(final CollateralRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradesGroupDecoder extends CommonDecoderImpl
{
    ...
    public CollateralRequestEncoder.TradesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralRequestEncoder.TradesGroupEncoder)encoder);
    }

    public CollateralRequestEncoder.TradesGroupEncoder toEncoder(final CollateralRequestEncoder.TradesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradeReportID())
        {
    ...
    public class TradesGroupIterator implements Iterable<TradesGroupDecoder>, java.util.Iterator<TradesGroupDecoder>
    {
        ...
        public TradesGroupIterator(final CollateralRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public CollateralRequestEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralRequestEncoder.LegsGroupEncoder)encoder);
    }

    public CollateralRequestEncoder.LegsGroupEncoder toEncoder(final CollateralRequestEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final CollateralRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return CollAction.NULL_VAL;
    ...
    public CollateralRequestEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralRequestEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public CollateralRequestEncoder.UnderlyingsGroupEncoder toEncoder(final CollateralRequestEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final CollateralRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class MiscFeesGroupDecoder extends CommonDecoderImpl
{
 ...
 return MiscFeeBasis.NULL_VAL;
    ...
    public CollateralRequestEncoder.MiscFeesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralRequestEncoder.MiscFeesGroupEncoder)encoder);
    }

    public CollateralRequestEncoder.MiscFeesGroupEncoder toEncoder(final CollateralRequestEncoder.MiscFeesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasMiscFeeAmt())
        {
    ...
    public class MiscFeesGroupIterator implements Iterable<MiscFeesGroupDecoder>, java.util.Iterator<MiscFeesGroupDecoder>
    {
        ...
        public MiscFeesGroupIterator(final CollateralRequestDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return BenchmarkSecurityIDSource.NULL_VAL;
    ...
    public CollateralRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralRequestEncoder)encoder);
    }

    public CollateralRequestEncoder toEncoder(final CollateralRequestEncoder encoder)
    {
        encoder.reset();
