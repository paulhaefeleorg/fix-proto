...
public class TradeCaptureReportDecoder extends CommonDecoderImpl implements InstrumentDecoder, FinancingDetailsDecoder, OrderQtyDataDecoder, YieldDataDecoder, SpreadOrBenchmarkCurveDataDecoder, PositionAmountDataDecoder, TrdRegTimestampsDecoder, MessageDecoder
{
    ...
    public boolean validate()
    {
        ...
        {
        if (CODEC_VALIDATION_ENABLED && unsolicitedIndicatorLength > 1)
        {
            invalidTagId = 325;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_VALIDATION_ENABLED && publishTrdIndicatorLength > 1)
        {
            invalidTagId = 852;
            rejectReason = 5;
            return false;
 ...
 return ExecType.NULL_VAL;
    ...
    private int unsolicitedIndicatorLength = 0;
    public int unsolicitedIndicatorLength()    {
       return unsolicitedIndicatorLength;
    }
...
public class SidesGroupDecoder extends CommonDecoderImpl implements PartiesDecoder, CommissionDataDecoder, StipulationsDecoder
{
    ...
    public boolean validate()
    {
        ...
        if (hasOddLot)
        {
        if (CODEC_VALIDATION_ENABLED && oddLotLength > 1)
        {
            invalidTagId = 575;
            rejectReason = 5;
            return false;
 ...
 return ProcessCode.NULL_VAL;
    ...
    private int oddLotLength = 0;
    public int oddLotLength()    {
       return oddLotLength;
    }
...
public class AllocsGroupDecoder extends CommonDecoderImpl implements NestedParties2Decoder
{
    ...
    private int publishTrdIndicatorLength = 0;
    public int publishTrdIndicatorLength()    {
       return publishTrdIndicatorLength;
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.UNSOLICITED_INDICATOR:
                ...
                unsolicitedIndicatorLength = valueLength;
                break;
            ...
            case Constants.PUBLISH_TRD_INDICATOR:
                ...
                publishTrdIndicatorLength = valueLength;
                break;
