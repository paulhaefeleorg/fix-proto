...
import uk.co.real_logic.artio.builder.AllocationReportEncoder;
import static uk.co.real_logic.artio.builder.AllocationReportEncoder.OrdersGroupEncoder;
...
import static uk.co.real_logic.artio.builder.AllocationReportEncoder.ExecsGroupEncoder;
...
import uk.co.real_logic.artio.builder.InstrumentExtensionEncoder;
import static uk.co.real_logic.artio.builder.InstrumentExtensionEncoder.InstrAttribGroupEncoder;
import uk.co.real_logic.artio.builder.FinancingDetailsEncoder;
import static uk.co.real_logic.artio.builder.AllocationReportEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.AllocationReportEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.AllocationReportEncoder.AllocsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.AllocationReportEncoder.AllocsGroupEncoder.MiscFeesGroupEncoder;
import static uk.co.real_logic.artio.builder.AllocationReportEncoder.AllocsGroupEncoder.ClearingInstructionsGroupEncoder;
...
public class AllocationReportDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrumentExtensionDecoder, FinancingDetailsDecoder, SpreadOrBenchmarkCurveDataDecoder, PartiesDecoder, StipulationsDecoder, YieldDataDecoder, MessageDecoder
{
    public final IntHashSet REQUIRED_FIELDS = new IntHashSet(22);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.ALLOC_REPORT_TYPE);
            ...
            REQUIRED_FIELDS.add(Constants.NO_ALLOCS_GROUP_COUNTER);
        }
    }

    public final IntHashSet GROUP_FIELDS = new IntHashSet(242);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.ALLOC_REPORT_REF_ID);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(242);

    private final IntHashSet unknownFields = new IntHashSet(10);

    private final IntHashSet missingRequiredFields = new IntHashSet(22);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_VALIDATION_ENABLED && allocTransTypeLength > 1)
        {
            invalidTagId = 71;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_VALIDATION_ENABLED && previouslyReportedLength > 1)
        {
            invalidTagId = 570;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_VALIDATION_ENABLED && reversalIndicatorLength > 1)
        {
            invalidTagId = 700;
            rejectReason = 5;
            return false;
        ...
        if (hasSettlType)
        {
        if (CODEC_VALIDATION_ENABLED && settlTypeLength > 1)
        {
            invalidTagId = 63;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_VALIDATION_ENABLED && autoAcceptIndicatorLength > 1)
        {
            invalidTagId = 754;
            rejectReason = 5;
            return false;
        ...
        if (hasLegalConfirm)
        {
        if (CODEC_VALIDATION_ENABLED && legalConfirmLength > 1)
        {
            invalidTagId = 650;
            rejectReason = 5;
            return false;
        ...
        if (hasLastFragment)
        {
        if (CODEC_VALIDATION_ENABLED && lastFragmentLength > 1)
        {
            invalidTagId = 893;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 21313L;

    public static final String MESSAGE_TYPE_AS_STRING = "AS";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(696);

    {
        ...
        messageFields.add(Constants.ALLOC_REPORT_REF_ID);
    ...
    /* AllocReportID = 755 */
    public AsciiSequenceView allocReportID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, allocReportIDOffset, allocReportIDLength);
    }
    ...
    private int allocTransTypeLength = 0;
    public int allocTransTypeLength()    {
       return allocTransTypeLength;
    }
    /* AllocTransType = 71 */
    ...
    private char[] allocReportRefID = new char[1];

    private boolean hasAllocReportRefID;

    /* AllocReportRefID = 795 */
    public char[] allocReportRefID()
    {
        if (!hasAllocReportRefID)
        {
            throw new IllegalArgumentException("No value for optional field: AllocReportRefID");
        }
    ...
    {
        return hasAllocReportRefID;
    }


    private int allocReportRefIDOffset;

    private int allocReportRefIDLength;

    /* AllocReportRefID = 795 */
    public int allocReportRefIDLength()
    {
        if (!hasAllocReportRefID)
        {
            throw new IllegalArgumentException("No value for optional field: AllocReportRefID");
        ...
        return allocReportRefIDLength;
    }

    /* AllocReportRefID = 795 */
    public String allocReportRefIDAsString()
    {
        return hasAllocReportRefID ? new String(allocReportRefID, 0, allocReportRefIDLength) : null;
    }

    /* AllocReportRefID = 795 */
    public AsciiSequenceView allocReportRefID(final AsciiSequenceView view)
    {
        if (!hasAllocReportRefID)
        {
            throw new IllegalArgumentException("No value for optional field: AllocReportRefID");
        ...
        return view.wrap(buffer, allocReportRefIDOffset, allocReportRefIDLength);
    }
 ...
 return AllocCancReplaceReason.NULL_VAL;
    ...
    /* SecondaryAllocID = 793 */
    public AsciiSequenceView secondaryAllocID(final AsciiSequenceView view)
    {
        if (!hasSecondaryAllocID)
        {
            throw new IllegalArgumentException("No value for optional field: SecondaryAllocID");
        ...
        return view.wrap(buffer, secondaryAllocIDOffset, secondaryAllocIDLength);
    }
 ...
 return AllocRejCode.NULL_VAL;
    ...
    /* RefAllocID = 72 */
    public AsciiSequenceView refAllocID(final AsciiSequenceView view)
    {
        if (!hasRefAllocID)
        {
            throw new IllegalArgumentException("No value for optional field: RefAllocID");
        ...
        return view.wrap(buffer, refAllocIDOffset, refAllocIDLength);
    }
 ...
 return AllocIntermedReqType.NULL_VAL;
    ...
    /* AllocLinkID = 196 */
    public AsciiSequenceView allocLinkID(final AsciiSequenceView view)
    {
        if (!hasAllocLinkID)
        {
            throw new IllegalArgumentException("No value for optional field: AllocLinkID");
        ...
        return view.wrap(buffer, allocLinkIDOffset, allocLinkIDLength);
    }
 ...
 return AllocLinkType.NULL_VAL;
    ...
    /* BookingRefID = 466 */
    public AsciiSequenceView bookingRefID(final AsciiSequenceView view)
    {
        if (!hasBookingRefID)
        {
            throw new IllegalArgumentException("No value for optional field: BookingRefID");
        ...
        return view.wrap(buffer, bookingRefIDOffset, bookingRefIDLength);
    }
...
public class OrdersGroupDecoder extends CommonDecoderImpl implements NestedParties2Decoder
{
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.ORDER_AVG_PX:
                hasOrderAvgPx = true;
                orderAvgPx = getFloat(buffer, orderAvgPx, valueOffset, valueLength, 799, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.ORDER_BOOKING_QTY:
                hasOrderBookingQty = true;
                orderBookingQty = getFloat(buffer, orderBookingQty, valueOffset, valueLength, 800, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    public AllocationReportEncoder.OrdersGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocationReportEncoder.OrdersGroupEncoder)encoder);
    }

    public AllocationReportEncoder.OrdersGroupEncoder toEncoder(final AllocationReportEncoder.OrdersGroupEncoder encoder)
    {
        encoder.reset();
        if (hasClOrdID())
        {
    ...
    {
        private final AllocationReportDecoder parent;
        private int remainder;
        private OrdersGroupDecoder current;

        public OrdersGroupIterator(final AllocationReportDecoder parent)
        {
            this.parent = parent;
        }
...
public class ExecsGroupDecoder extends CommonDecoderImpl
{
    ...
    public boolean validate()
    {
        ...
        if (hasLastCapacity)
        {
        if (CODEC_VALIDATION_ENABLED && lastCapacityLength > 1)
        {
            invalidTagId = 29;
            rejectReason = 5;
            return false;
    ...
    private int lastCapacityLength = 0;
    public int lastCapacityLength()    {
       return lastCapacityLength;
    }
 ...
 return LastCapacity.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.LAST_QTY:
                hasLastQty = true;
                lastQty = getFloat(buffer, lastQty, valueOffset, valueLength, 32, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.LAST_PX:
                hasLastPx = true;
                lastPx = getFloat(buffer, lastPx, valueOffset, valueLength, 31, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.LAST_PAR_PX:
                hasLastParPx = true;
                lastParPx = getFloat(buffer, lastParPx, valueOffset, valueLength, 669, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.LAST_CAPACITY:
                hasLastCapacity = true;
                lastCapacity = buffer.getChar(valueOffset);
                lastCapacityLength = valueLength;
                break;
    ...
    public AllocationReportEncoder.ExecsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocationReportEncoder.ExecsGroupEncoder)encoder);
    }

    public AllocationReportEncoder.ExecsGroupEncoder toEncoder(final AllocationReportEncoder.ExecsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasLastQty())
        {
    ...
    public class ExecsGroupIterator implements Iterable<ExecsGroupDecoder>, java.util.Iterator<ExecsGroupDecoder>
    {
        ...
        public ExecsGroupIterator(final AllocationReportDecoder parent)
        {
            this.parent = parent;
        }
    ...
    private int previouslyReportedLength = 0;
    public int previouslyReportedLength()    {
       return previouslyReportedLength;
    }
    ...
    private int reversalIndicatorLength = 0;
    public int reversalIndicatorLength()    {
       return reversalIndicatorLength;
    }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
    ...
    public boolean validate()
    {
        ...
        {
        if (CODEC_VALIDATION_ENABLED && underlyingOptAttributeLength > 1)
        {
            invalidTagId = 317;
            rejectReason = 5;
            return false;
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    /* UnderlyingRepoCollateralSecurityType = 243 */
    public AsciiSequenceView underlyingRepoCollateralSecurityType(final AsciiSequenceView view)
    {
        if (!hasUnderlyingRepoCollateralSecurityType)
        {
            throw new IllegalArgumentException("No value for optional field: UnderlyingRepoCollateralSecurityType");
        ...
        return view.wrap(buffer, underlyingRepoCollateralSecurityTypeOffset, underlyingRepoCollateralSecurityTypeLength);
    }
    ...
    private int underlyingOptAttributeLength = 0;
    public int underlyingOptAttributeLength()    {
       return underlyingOptAttributeLength;
    }
        ...
        while (position < end)
        {
            ...
            case Constants.NO_UNDERLYING_SECURITY_ALT_ID_GROUP_COUNTER:
                ...
                for (int i = 0; i < noUnderlyingSecurityAltIDGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = underlyingSecurityAltIDGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (underlyingSecurityAltIDGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (underlyingSecurityAltIDGroupCurrent != null) 
                            {
            ...
            case Constants.UNDERLYING_REPURCHASE_RATE:
                ...
                underlyingRepurchaseRate = getFloat(buffer, underlyingRepurchaseRate, valueOffset, valueLength, 245, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.UNDERLYING_FACTOR:
                hasUnderlyingFactor = true;
                underlyingFactor = getFloat(buffer, underlyingFactor, valueOffset, valueLength, 246, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.UNDERLYING_STRIKE_PRICE:
                ...
                underlyingStrikePrice = getFloat(buffer, underlyingStrikePrice, valueOffset, valueLength, 316, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.UNDERLYING_OPT_ATTRIBUTE:
                ...
                underlyingOptAttributeLength = valueLength;
                break;

            case Constants.UNDERLYING_CONTRACT_MULTIPLIER:
                hasUnderlyingContractMultiplier = true;
                underlyingContractMultiplier = getFloat(buffer, underlyingContractMultiplier, valueOffset, valueLength, 436, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.UNDERLYING_COUPON_RATE:
                hasUnderlyingCouponRate = true;
                underlyingCouponRate = getFloat(buffer, underlyingCouponRate, valueOffset, valueLength, 435, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.UNDERLYING_QTY:
                ...
                underlyingQty = getFloat(buffer, underlyingQty, valueOffset, valueLength, 879, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.UNDERLYING_PX:
                hasUnderlyingPx = true;
                underlyingPx = getFloat(buffer, underlyingPx, valueOffset, valueLength, 810, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.UNDERLYING_DIRTY_PRICE:
                hasUnderlyingDirtyPrice = true;
                underlyingDirtyPrice = getFloat(buffer, underlyingDirtyPrice, valueOffset, valueLength, 882, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.UNDERLYING_END_PRICE:
                hasUnderlyingEndPrice = true;
                underlyingEndPrice = getFloat(buffer, underlyingEndPrice, valueOffset, valueLength, 883, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.UNDERLYING_START_VALUE:
                hasUnderlyingStartValue = true;
                underlyingStartValue = getFloat(buffer, underlyingStartValue, valueOffset, valueLength, 884, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.UNDERLYING_CURRENT_VALUE:
                hasUnderlyingCurrentValue = true;
                underlyingCurrentValue = getFloat(buffer, underlyingCurrentValue, valueOffset, valueLength, 885, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.UNDERLYING_END_VALUE:
                hasUnderlyingEndValue = true;
                underlyingEndValue = getFloat(buffer, underlyingEndValue, valueOffset, valueLength, 886, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.NO_UNDERLYING_STIPS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noUnderlyingStipsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = underlyingStipsGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (underlyingStipsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (underlyingStipsGroupCurrent != null) 
                            {
    ...
    public AllocationReportEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocationReportEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public AllocationReportEncoder.UnderlyingsGroupEncoder toEncoder(final AllocationReportEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final AllocationReportDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public AllocationReportEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocationReportEncoder.LegsGroupEncoder)encoder);
    }

    public AllocationReportEncoder.LegsGroupEncoder toEncoder(final AllocationReportEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final AllocationReportDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return PositionEffect.NULL_VAL;
    ...
    private int autoAcceptIndicatorLength = 0;
    public int autoAcceptIndicatorLength()    {
       return autoAcceptIndicatorLength;
    }
    ...
    private int legalConfirmLength = 0;
    public int legalConfirmLength()    {
       return legalConfirmLength;
    }
 ...
 return YieldType.NULL_VAL;
    ...
    private int lastFragmentLength = 0;
    public int lastFragmentLength()    {
...
public class AllocsGroupDecoder extends CommonDecoderImpl implements NestedPartiesDecoder, CommissionDataDecoder, SettlInstructionsDataDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(64);
    ...
    public final IntHashSet ALL_GROUP_FIELDS = new IntHashSet(48);
    ...
    public boolean validate()
    {
        ...
        if (hasMatchStatus)
        {
        if (CODEC_VALIDATION_ENABLED && matchStatusLength > 1)
        {
            invalidTagId = 573;
            rejectReason = 5;
            return false;
        ...
        if (hasProcessCode)
        {
        if (CODEC_VALIDATION_ENABLED && processCodeLength > 1)
        {
            invalidTagId = 81;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_VALIDATION_ENABLED && notifyBrokerOfCreditLength > 1)
        {
            invalidTagId = 208;
            rejectReason = 5;
            return false;
        ...
        if (hasCommType)
        {
        if (CODEC_VALIDATION_ENABLED && commTypeLength > 1)
        {
            invalidTagId = 13;
            rejectReason = 5;
            return false;
        ...
        if (hasFundRenewWaiv)
        {
        if (CODEC_VALIDATION_ENABLED && fundRenewWaivLength > 1)
        {
            invalidTagId = 497;
            rejectReason = 5;
            return false;
        ...
        if (hasSettlCurrFxRateCalc)
        {
        if (CODEC_VALIDATION_ENABLED && settlCurrFxRateCalcLength > 1)
        {
            invalidTagId = 156;
            rejectReason = 5;
            return false;
    ...
    private IntHashSet seenFields = new IntHashSet(58);
    ...
    private int matchStatusLength = 0;
    public int matchStatusLength()    {
       return matchStatusLength;
    }
 ...
 return MatchStatus.NULL_VAL;
    ...
    private int processCodeLength = 0;
    public int processCodeLength()    {
       return processCodeLength;
    }
 ...
 return ProcessCode.NULL_VAL;
    ...
    private int notifyBrokerOfCreditLength = 0;
    public int notifyBrokerOfCreditLength()    {
       return notifyBrokerOfCreditLength;
    }
 ...
 return AllocHandlInst.NULL_VAL;
    ...
    /* AllocText = 161 */
    public AsciiSequenceView allocText(final AsciiSequenceView view)
    {
        if (!hasAllocText)
        {
            throw new IllegalArgumentException("No value for optional field: AllocText");
        ...
        return view.wrap(buffer, allocTextOffset, allocTextLength);
    }
    ...
    private int commTypeLength = 0;
    public int commTypeLength()    {
       return commTypeLength;
    }
 ...
 return CommType.NULL_VAL;
    ...
    private int fundRenewWaivLength = 0;
    public int fundRenewWaivLength()    {
       return fundRenewWaivLength;
    }
 ...
 return FundRenewWaiv.NULL_VAL;
    ...
    private int settlCurrFxRateCalcLength = 0;
    public int settlCurrFxRateCalcLength()    {
       return settlCurrFxRateCalcLength;
    }
...
public class MiscFeesGroupDecoder extends CommonDecoderImpl
{
    ...
    /* MiscFeeType = 139 */
    public AsciiSequenceView miscFeeType(final AsciiSequenceView view)
    {
        if (!hasMiscFeeType)
        {
            throw new IllegalArgumentException("No value for optional field: MiscFeeType");
        ...
        return view.wrap(buffer, miscFeeTypeOffset, miscFeeTypeLength);
    }
 ...
 return MiscFeeBasis.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.MISC_FEE_AMT:
                hasMiscFeeAmt = true;
                miscFeeAmt = getFloat(buffer, miscFeeAmt, valueOffset, valueLength, 137, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    public AllocsGroupEncoder.MiscFeesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocsGroupEncoder.MiscFeesGroupEncoder)encoder);
    }

    public AllocsGroupEncoder.MiscFeesGroupEncoder toEncoder(final AllocsGroupEncoder.MiscFeesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasMiscFeeAmt())
        {
...
public class ClearingInstructionsGroupDecoder extends CommonDecoderImpl
{
 ...
 return ClearingInstruction.NULL_VAL;
    ...
    public AllocsGroupEncoder.ClearingInstructionsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocsGroupEncoder.ClearingInstructionsGroupEncoder)encoder);
    }

    public AllocsGroupEncoder.ClearingInstructionsGroupEncoder toEncoder(final AllocsGroupEncoder.ClearingInstructionsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasClearingInstruction())
        {
    ...
    public class ClearingInstructionsGroupIterator implements Iterable<ClearingInstructionsGroupDecoder>, java.util.Iterator<ClearingInstructionsGroupDecoder>
    {
        ...
        public ClearingInstructionsGroupIterator(final AllocsGroupDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return StandInstDbType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.MATCH_STATUS:
                ...
                matchStatusLength = valueLength;
                break;

            case Constants.ALLOC_PRICE:
                hasAllocPrice = true;
                allocPrice = getFloat(buffer, allocPrice, valueOffset, valueLength, 366, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.NOTIFY_BROKER_OF_CREDIT:
                ...
                notifyBrokerOfCreditLength = valueLength;
                break;
            ...
            case Constants.COMMISSION:
                hasCommission = true;
                commission = getFloat(buffer, commission, valueOffset, valueLength, 12, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.COMM_TYPE:
                hasCommType = true;
                commType = buffer.getChar(valueOffset);
                commTypeLength = valueLength;
                break;
            ...
            case Constants.FUND_RENEW_WAIV:
                ...
                fundRenewWaivLength = valueLength;
                break;


            case Constants.ALLOC_AVG_PX:
                hasAllocAvgPx = true;
                allocAvgPx = getFloat(buffer, allocAvgPx, valueOffset, valueLength, 153, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.ALLOC_NET_MONEY:
                hasAllocNetMoney = true;
                allocNetMoney = getFloat(buffer, allocNetMoney, valueOffset, valueLength, 154, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.SETTL_CURR_AMT:
                hasSettlCurrAmt = true;
                settlCurrAmt = getFloat(buffer, settlCurrAmt, valueOffset, valueLength, 119, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.ALLOC_SETTL_CURR_AMT:
                hasAllocSettlCurrAmt = true;
                allocSettlCurrAmt = getFloat(buffer, allocSettlCurrAmt, valueOffset, valueLength, 737, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.SETTL_CURR_FX_RATE:
                ...
                settlCurrFxRate = getFloat(buffer, settlCurrFxRate, valueOffset, valueLength, 155, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.SETTL_CURR_FX_RATE_CALC:
                hasSettlCurrFxRateCalc = true;
                settlCurrFxRateCalc = buffer.getChar(valueOffset);
                settlCurrFxRateCalcLength = valueLength;
                break;

            case Constants.ALLOC_ACCRUED_INTEREST_AMT:
                hasAllocAccruedInterestAmt = true;
                allocAccruedInterestAmt = getFloat(buffer, allocAccruedInterestAmt, valueOffset, valueLength, 742, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.ALLOC_INTEREST_AT_MATURITY:
                hasAllocInterestAtMaturity = true;
                allocInterestAtMaturity = getFloat(buffer, allocInterestAtMaturity, valueOffset, valueLength, 741, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.NO_MISC_FEES_GROUP_COUNTER:
                ...
                for (int i = 0; i < noMiscFeesGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = miscFeesGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (miscFeesGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (miscFeesGroupCurrent != null) 
                            {
            ...
            case Constants.NO_CLEARING_INSTRUCTIONS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noClearingInstructionsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = clearingInstructionsGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (clearingInstructionsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (clearingInstructionsGroupCurrent != null) 
                            {
            ...
            case Constants.NO_DLVY_INST_GROUP_COUNTER:
                ...
                for (int i = 0; i < noDlvyInstGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = dlvyInstGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (dlvyInstGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (dlvyInstGroupCurrent != null) 
                            {
    ...
    public AllocationReportEncoder.AllocsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocationReportEncoder.AllocsGroupEncoder)encoder);
    }

    public AllocationReportEncoder.AllocsGroupEncoder toEncoder(final AllocationReportEncoder.AllocsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class AllocsGroupIterator implements Iterable<AllocsGroupDecoder>, java.util.Iterator<AllocsGroupDecoder>
    {
        ...
        public AllocsGroupIterator(final AllocationReportDecoder parent)
        {
            this.parent = parent;
        }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.ALLOC_TRANS_TYPE:
                ...
                allocTransTypeLength = valueLength;
                break;

            case Constants.ALLOC_REPORT_REF_ID:
                hasAllocReportRefID = true;
                allocReportRefID = buffer.getChars(allocReportRefID, valueOffset, valueLength);
                allocReportRefIDOffset = valueOffset;
                allocReportRefIDLength = valueLength;
                break;
            ...
            case Constants.NO_ORDERS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noOrdersGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = ordersGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
            ...
            case Constants.NO_EXECS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noExecsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = execsGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
            ...
            case Constants.PCT_AT_RISK:
                hasPctAtRisk = true;
                pctAtRisk = getFloat(buffer, pctAtRisk, valueOffset, valueLength, 869, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.NO_INSTR_ATTRIB_GROUP_COUNTER:
                ...
                for (int i = 0; i < noInstrAttribGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = instrAttribGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (instrAttribGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (instrAttribGroupCurrent != null) 
                            {
            ...
            case Constants.MARGIN_RATIO:
                hasMarginRatio = true;
                marginRatio = getFloat(buffer, marginRatio, valueOffset, valueLength, 898, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.NO_UNDERLYINGS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noUnderlyingsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = underlyingsGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (underlyingsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (underlyingsGroupCurrent != null) 
                            {
            ...
            case Constants.QUANTITY:
                quantity = getFloat(buffer, quantity, valueOffset, valueLength, 53, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.AVG_PX:
                avgPx = getFloat(buffer, avgPx, valueOffset, valueLength, 6, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.AVG_PAR_PX:
                hasAvgParPx = true;
                avgParPx = getFloat(buffer, avgParPx, valueOffset, valueLength, 860, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.SPREAD:
                hasSpread = true;
                spread = getFloat(buffer, spread, valueOffset, valueLength, 218, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.BENCHMARK_PRICE:
                ...
                benchmarkPrice = getFloat(buffer, benchmarkPrice, valueOffset, valueLength, 662, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.GROSS_TRADE_AMT:
                ...
                grossTradeAmt = getFloat(buffer, grossTradeAmt, valueOffset, valueLength, 381, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.CONCESSION:
                hasConcession = true;
                concession = getFloat(buffer, concession, valueOffset, valueLength, 238, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.TOTAL_TAKEDOWN:
                hasTotalTakedown = true;
                totalTakedown = getFloat(buffer, totalTakedown, valueOffset, valueLength, 237, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.NET_MONEY:
                hasNetMoney = true;
                netMoney = getFloat(buffer, netMoney, valueOffset, valueLength, 118, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.AUTO_ACCEPT_INDICATOR:
                ...
                autoAcceptIndicatorLength = valueLength;
                break;
            ...
            case Constants.ACCRUED_INTEREST_RATE:
                ...
                accruedInterestRate = getFloat(buffer, accruedInterestRate, valueOffset, valueLength, 158, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.ACCRUED_INTEREST_AMT:
                hasAccruedInterestAmt = true;
                accruedInterestAmt = getFloat(buffer, accruedInterestAmt, valueOffset, valueLength, 159, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.TOTAL_ACCRUED_INTEREST_AMT:
                hasTotalAccruedInterestAmt = true;
                totalAccruedInterestAmt = getFloat(buffer, totalAccruedInterestAmt, valueOffset, valueLength, 540, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.INTEREST_AT_MATURITY:
                hasInterestAtMaturity = true;
                interestAtMaturity = getFloat(buffer, interestAtMaturity, valueOffset, valueLength, 738, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.END_ACCRUED_INTEREST_AMT:
                hasEndAccruedInterestAmt = true;
                endAccruedInterestAmt = getFloat(buffer, endAccruedInterestAmt, valueOffset, valueLength, 920, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.START_CASH:
                hasStartCash = true;
                startCash = getFloat(buffer, startCash, valueOffset, valueLength, 921, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.END_CASH:
                hasEndCash = true;
                endCash = getFloat(buffer, endCash, valueOffset, valueLength, 922, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.LEGAL_CONFIRM:
                hasLegalConfirm = true;
                legalConfirm = buffer.getBoolean(valueOffset);
                legalConfirmLength = valueLength;
                break;
            ...
            case Constants.NO_STIPULATIONS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noStipulationsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = stipulationsGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (stipulationsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (stipulationsGroupCurrent != null) 
                            {
            ...
            case Constants.YIELD:
                hasYield = true;
                yield = getFloat(buffer, yield, valueOffset, valueLength, 236, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.YIELD_REDEMPTION_PRICE:
                ...
                yieldRedemptionPrice = getFloat(buffer, yieldRedemptionPrice, valueOffset, valueLength, 697, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.LAST_FRAGMENT:
                ...
                lastFragmentLength = valueLength;
                break;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasAllocReportRefID())
        {
            ...
            builder.append(this.allocReportRefID(), 0, allocReportRefIDLength());
            builder.append("\",\n");
        }
    ...
    public AllocationReportEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocationReportEncoder)encoder);
    }

    public AllocationReportEncoder toEncoder(final AllocationReportEncoder encoder)
    {
        encoder.reset();
        ...
        if (hasAllocReportRefID())
        {
            encoder.allocReportRefID(this.allocReportRefID(), 0, allocReportRefIDLength());
        }
