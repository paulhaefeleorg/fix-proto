...
public class InstrAttribGroupDecoder extends CommonDecoderImpl
{
 ...
 return InstrAttribType.NULL_VAL;
    ...
    /* InstrAttribValue = 872 */
    public AsciiSequenceView instrAttribValue(final AsciiSequenceView view)
    {
        if (!hasInstrAttribValue)
        {
            throw new IllegalArgumentException("No value for optional field: InstrAttribValue");
        ...
        return view.wrap(buffer, instrAttribValueOffset, instrAttribValueLength);
    }
    ...
    public InstrumentExtensionEncoder.InstrAttribGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((InstrumentExtensionEncoder.InstrAttribGroupEncoder)encoder);
    }

    public InstrumentExtensionEncoder.InstrAttribGroupEncoder toEncoder(final InstrumentExtensionEncoder.InstrAttribGroupEncoder encoder)
    {
        encoder.reset();
        if (hasInstrAttribType())
        {
