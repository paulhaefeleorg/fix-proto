...
import uk.co.real_logic.artio.builder.SecurityDefinitionEncoder;
...
import static uk.co.real_logic.artio.builder.SecurityDefinitionEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.SecurityDefinitionEncoder.LegsGroupEncoder;
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public SecurityDefinitionEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityDefinitionEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public SecurityDefinitionEncoder.UnderlyingsGroupEncoder toEncoder(final SecurityDefinitionEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public SecurityDefinitionEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityDefinitionEncoder.LegsGroupEncoder)encoder);
    }

    public SecurityDefinitionEncoder.LegsGroupEncoder toEncoder(final SecurityDefinitionEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
