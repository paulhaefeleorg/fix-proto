...
import uk.co.real_logic.artio.builder.MarketDataIncrementalRefreshEncoder;
import static uk.co.real_logic.artio.builder.MarketDataIncrementalRefreshEncoder.MDEntriesGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MarketDataIncrementalRefreshEncoder.MDEntriesGroupEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MarketDataIncrementalRefreshEncoder.MDEntriesGroupEncoder.LegsGroupEncoder;
...
public class MarketDataIncrementalRefreshDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(438);
    ...
    /* MDReqID = 262 */
    public AsciiSequenceView mDReqID(final AsciiSequenceView view)
    {
        if (!hasMDReqID)
        {
            throw new IllegalArgumentException("No value for optional field: MDReqID");
        ...
        return view.wrap(buffer, mDReqIDOffset, mDReqIDLength);
    }
...
@Generated("uk.co.real_logic.artio")
public class MDEntriesGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder
{
    public final IntHashSet REQUIRED_FIELDS = new IntHashSet(2);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            REQUIRED_FIELDS.add(Constants.M_D_UPDATE_ACTION);
        }
    }
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            GROUP_FIELDS.add(Constants.M_D_UPDATE_ACTION);
            GROUP_FIELDS.add(Constants.DELETE_REASON);
            GROUP_FIELDS.add(Constants.M_D_ENTRY_TYPE);
            GROUP_FIELDS.add(Constants.M_D_ENTRY_ID);
            GROUP_FIELDS.add(Constants.M_D_ENTRY_REF_ID);
            ...
            GROUP_FIELDS.add(Constants.NET_CHG_PREV_DAY);
    ...
    public final IntHashSet ALL_GROUP_FIELDS = new IntHashSet(80);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ALL_GROUP_FIELDS.add(Constants.M_D_UPDATE_ACTION);
            ALL_GROUP_FIELDS.add(Constants.DELETE_REASON);
            ALL_GROUP_FIELDS.add(Constants.M_D_ENTRY_TYPE);
            ALL_GROUP_FIELDS.add(Constants.M_D_ENTRY_ID);
            ALL_GROUP_FIELDS.add(Constants.M_D_ENTRY_REF_ID);
            ALL_GROUP_FIELDS.add(Constants.FINANCIAL_STATUS);
            ALL_GROUP_FIELDS.add(Constants.CORPORATE_ACTION);
            ...
            ALL_GROUP_FIELDS.add(Constants.NET_CHG_PREV_DAY);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !MDUpdateAction.isValid(mDUpdateAction()))
        {
            invalidTagId = 279;
            rejectReason = 5;
            return false;
        ...
        if (hasDeleteReason)
        {
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !DeleteReason.isValid(deleteReason()))
        {
            invalidTagId = 285;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_VALIDATION_ENABLED && mDUpdateActionLength > 1)
        {
            invalidTagId = 279;
            rejectReason = 5;
            return false;
        ...
        if (hasDeleteReason)
        {
        if (CODEC_VALIDATION_ENABLED && deleteReasonLength > 1)
        {
            invalidTagId = 285;
            rejectReason = 5;
            return false;
        ...
        if (hasMDEntryType)
        {
        if (CODEC_VALIDATION_ENABLED && mDEntryTypeLength > 1)
        {
            invalidTagId = 269;
            rejectReason = 5;
            return false;
        ...
        if (hasTickDirection)
        {
        if (CODEC_VALIDATION_ENABLED && tickDirectionLength > 1)
        {
            invalidTagId = 274;
            rejectReason = 5;
            return false;
    ...
    private IntHashSet seenFields = new IntHashSet(86);

    private char mDUpdateAction = MISSING_CHAR;

    private int mDUpdateActionLength = 0;
    public int mDUpdateActionLength()    {
       return mDUpdateActionLength;
    }
    /* MDUpdateAction = 279 */
    ...
    private final CharArrayWrapper mDUpdateActionWrapper = new CharArrayWrapper();
    /* MDUpdateAction = 279 */
    public MDUpdateAction mDUpdateActionAsEnum()
    {
        return MDUpdateAction.decode(mDUpdateAction);
    }

    private char deleteReason = MISSING_CHAR;

    private int deleteReasonLength = 0;
    public int deleteReasonLength()    {
       return deleteReasonLength;
    }
    ...
    public char deleteReason()
    {
        if (!hasDeleteReason)
        {
            throw new IllegalArgumentException("No value for optional field: DeleteReason");
        }
    ...
    private final CharArrayWrapper deleteReasonWrapper = new CharArrayWrapper();
    /* DeleteReason = 285 */
    public DeleteReason deleteReasonAsEnum()
    {
        if (!hasDeleteReason)
 return DeleteReason.NULL_VAL;
        return DeleteReason.decode(deleteReason);
    }

    private char mDEntryType = MISSING_CHAR;

    private int mDEntryTypeLength = 0;
    public int mDEntryTypeLength()    {
       return mDEntryTypeLength;
    }
    ...
    public char mDEntryType()
    {
        if (!hasMDEntryType)
        {
            throw new IllegalArgumentException("No value for optional field: MDEntryType");
        }
 ...
 return MDEntryType.NULL_VAL;
    ...
    /* MDEntryID = 278 */
    public AsciiSequenceView mDEntryID(final AsciiSequenceView view)
    {
        if (!hasMDEntryID)
        {
            throw new IllegalArgumentException("No value for optional field: MDEntryID");
        ...
        return view.wrap(buffer, mDEntryIDOffset, mDEntryIDLength);
    }
    ...
    /* MDEntryRefID = 280 */
    public char[] mDEntryRefID()
    {
        if (!hasMDEntryRefID)
        {
            throw new IllegalArgumentException("No value for optional field: MDEntryRefID");
        }
    ...
    {
        return hasMDEntryRefID;
    }


    private int mDEntryRefIDOffset;

    private int mDEntryRefIDLength;
    ...
    public int mDEntryRefIDLength()
    {
        ...
        return mDEntryRefIDLength;
    }

    /* MDEntryRefID = 280 */
    public String mDEntryRefIDAsString()
    {
        return hasMDEntryRefID ? new String(mDEntryRefID, 0, mDEntryRefIDLength) : null;
    }

    /* MDEntryRefID = 280 */
    public AsciiSequenceView mDEntryRefID(final AsciiSequenceView view)
    {
        if (!hasMDEntryRefID)
        {
            throw new IllegalArgumentException("No value for optional field: MDEntryRefID");
        ...
        return view.wrap(buffer, mDEntryRefIDOffset, mDEntryRefIDLength);
    }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public MDEntriesGroupEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MDEntriesGroupEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public MDEntriesGroupEncoder.UnderlyingsGroupEncoder toEncoder(final MDEntriesGroupEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final MDEntriesGroupDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final MDEntriesGroupDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public MDEntriesGroupEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MDEntriesGroupEncoder.LegsGroupEncoder)encoder);
    }

    public MDEntriesGroupEncoder.LegsGroupEncoder toEncoder(final MDEntriesGroupEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final MDEntriesGroupDecoder parent)
        {
            this.parent = parent;
        }
    ...
    /* FinancialStatus = 291 */
    public AsciiSequenceView financialStatus(final AsciiSequenceView view)
    {
        if (!hasFinancialStatus)
        {
            throw new IllegalArgumentException("No value for optional field: FinancialStatus");
        ...
        return view.wrap(buffer, financialStatusOffset, financialStatusLength);
    }
    ...
    /* CorporateAction = 292 */
    public AsciiSequenceView corporateAction(final AsciiSequenceView view)
    {
        if (!hasCorporateAction)
        {
            throw new IllegalArgumentException("No value for optional field: CorporateAction");
        ...
        return view.wrap(buffer, corporateActionOffset, corporateActionLength);
    }
    ...
    /* MDEntryDate = 272 */
    public AsciiSequenceView mDEntryDate(final AsciiSequenceView view)
    {
        if (!hasMDEntryDate)
        {
            throw new IllegalArgumentException("No value for optional field: MDEntryDate");
        ...
        return view.wrap(buffer, mDEntryDateOffset, mDEntryDateLength);
    }
    ...
    /* MDEntryTime = 273 */
    public AsciiSequenceView mDEntryTime(final AsciiSequenceView view)
    {
        if (!hasMDEntryTime)
        {
            throw new IllegalArgumentException("No value for optional field: MDEntryTime");
        ...
        return view.wrap(buffer, mDEntryTimeOffset, mDEntryTimeLength);
    }


    private char tickDirection = MISSING_CHAR;

    private int tickDirectionLength = 0;
    public int tickDirectionLength()    {
       return tickDirectionLength;
    }
 ...
 return TickDirection.NULL_VAL;
    ...
    /* MDMkt = 275 */
    public AsciiSequenceView mDMkt(final AsciiSequenceView view)
    {
        if (!hasMDMkt)
        {
            throw new IllegalArgumentException("No value for optional field: MDMkt");
        ...
        return view.wrap(buffer, mDMktOffset, mDMktLength);
    }
    ...
    /* QuoteCondition = 276 */
    public AsciiSequenceView quoteCondition(final AsciiSequenceView view)
    {
        if (!hasQuoteCondition)
        {
            throw new IllegalArgumentException("No value for optional field: QuoteCondition");
        ...
        return view.wrap(buffer, quoteConditionOffset, quoteConditionLength);
    }
    ...
    /* TradeCondition = 277 */
    public AsciiSequenceView tradeCondition(final AsciiSequenceView view)
    {
        if (!hasTradeCondition)
        {
            throw new IllegalArgumentException("No value for optional field: TradeCondition");
        ...
        return view.wrap(buffer, tradeConditionOffset, tradeConditionLength);
    }
    ...
    /* MDEntryOriginator = 282 */
    public AsciiSequenceView mDEntryOriginator(final AsciiSequenceView view)
    {
        if (!hasMDEntryOriginator)
        {
            throw new IllegalArgumentException("No value for optional field: MDEntryOriginator");
        ...
        return view.wrap(buffer, mDEntryOriginatorOffset, mDEntryOriginatorLength);
    }
    ...
    /* LocationID = 283 */
    public AsciiSequenceView locationID(final AsciiSequenceView view)
    {
        if (!hasLocationID)
        {
            throw new IllegalArgumentException("No value for optional field: LocationID");
        ...
        return view.wrap(buffer, locationIDOffset, locationIDLength);
    }
    ...
    /* DeskID = 284 */
    public AsciiSequenceView deskID(final AsciiSequenceView view)
    {
        if (!hasDeskID)
        {
            throw new IllegalArgumentException("No value for optional field: DeskID");
        ...
        return view.wrap(buffer, deskIDOffset, deskIDLength);
    }
    ...
    /* OpenCloseSettlFlag = 286 */
    public AsciiSequenceView openCloseSettlFlag(final AsciiSequenceView view)
    {
        if (!hasOpenCloseSettlFlag)
        {
            throw new IllegalArgumentException("No value for optional field: OpenCloseSettlFlag");
        ...
        return view.wrap(buffer, openCloseSettlFlagOffset, openCloseSettlFlagLength);
    }
 ...
 return TimeInForce.NULL_VAL;
    ...
    /* QuoteEntryID = 299 */
    public AsciiSequenceView quoteEntryID(final AsciiSequenceView view)
    {
        if (!hasQuoteEntryID)
        {
            throw new IllegalArgumentException("No value for optional field: QuoteEntryID");
        ...
        return view.wrap(buffer, quoteEntryIDOffset, quoteEntryIDLength);
    }
    ...
    /* MDEntryBuyer = 288 */
    public AsciiSequenceView mDEntryBuyer(final AsciiSequenceView view)
    {
        if (!hasMDEntryBuyer)
        {
            throw new IllegalArgumentException("No value for optional field: MDEntryBuyer");
        ...
        return view.wrap(buffer, mDEntryBuyerOffset, mDEntryBuyerLength);
    }
    ...
    /* MDEntrySeller = 289 */
    public AsciiSequenceView mDEntrySeller(final AsciiSequenceView view)
    {
        if (!hasMDEntrySeller)
        {
            throw new IllegalArgumentException("No value for optional field: MDEntrySeller");
        ...
        return view.wrap(buffer, mDEntrySellerOffset, mDEntrySellerLength);
    }
    ...
    /* Scope = 546 */
    public AsciiSequenceView scope(final AsciiSequenceView view)
    {
        if (!hasScope)
        {
            throw new IllegalArgumentException("No value for optional field: Scope");
        ...
        return view.wrap(buffer, scopeOffset, scopeLength);
    }
    ...
    private DecimalFloat netChgPrevDay = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat netChgPrevDay()
    {
        if (!hasNetChgPrevDay)
        {
            throw new IllegalArgumentException("No value for optional field: NetChgPrevDay");
        }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            switch (tag)
            {
            case Constants.M_D_UPDATE_ACTION:
                mDUpdateAction = buffer.getChar(valueOffset);
                mDUpdateActionLength = valueLength;
                break;

            case Constants.DELETE_REASON:
                hasDeleteReason = true;
                deleteReason = buffer.getChar(valueOffset);
                deleteReasonLength = valueLength;
                break;

            case Constants.M_D_ENTRY_TYPE:
                hasMDEntryType = true;
                mDEntryType = buffer.getChar(valueOffset);
                mDEntryTypeLength = valueLength;
                break;
            ...
            case Constants.M_D_ENTRY_REF_ID:
                hasMDEntryRefID = true;
                mDEntryRefID = buffer.getChars(mDEntryRefID, valueOffset, valueLength);
                mDEntryRefIDOffset = valueOffset;
                mDEntryRefIDLength = valueLength;
                break;
            ...
            case Constants.M_D_ENTRY_PX:
                hasMDEntryPx = true;
                mDEntryPx = getFloat(buffer, mDEntryPx, valueOffset, valueLength, 270, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.M_D_ENTRY_SIZE:
                hasMDEntrySize = true;
                mDEntrySize = getFloat(buffer, mDEntrySize, valueOffset, valueLength, 271, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.TICK_DIRECTION:
                ...
                tickDirectionLength = valueLength;
                break;
            ...
            case Constants.PRICE_DELTA:
                hasPriceDelta = true;
                priceDelta = getFloat(buffer, priceDelta, valueOffset, valueLength, 811, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.NET_CHG_PREV_DAY:
                hasNetChgPrevDay = true;
                netChgPrevDay = getFloat(buffer, netChgPrevDay, valueOffset, valueLength, 451, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasMDEntryRefID())
        {
            ...
            builder.append(this.mDEntryRefID(), 0, mDEntryRefIDLength());
            builder.append("\",\n");
        }
    ...
    public MarketDataIncrementalRefreshEncoder.MDEntriesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MarketDataIncrementalRefreshEncoder.MDEntriesGroupEncoder)encoder);
    }

    public MarketDataIncrementalRefreshEncoder.MDEntriesGroupEncoder toEncoder(final MarketDataIncrementalRefreshEncoder.MDEntriesGroupEncoder encoder)
    {
        encoder.reset();
        ...
        if (hasMDEntryRefID())
        {
            encoder.mDEntryRefID(this.mDEntryRefID(), 0, mDEntryRefIDLength());
        }
    ...
    {
        private final MarketDataIncrementalRefreshDecoder parent;
        private int remainder;
        private MDEntriesGroupDecoder current;

        public MDEntriesGroupIterator(final MarketDataIncrementalRefreshDecoder parent)
        {
            this.parent = parent;
        }
        ...
        while (position < end)
        {
            ...
            case Constants.NO_M_D_ENTRIES_GROUP_COUNTER:
                ...
                for (int i = 0; i < noMDEntriesGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = mDEntriesGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (mDEntriesGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (mDEntriesGroupCurrent != null) 
                            {
