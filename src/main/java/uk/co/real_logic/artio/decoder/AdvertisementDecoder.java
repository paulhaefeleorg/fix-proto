...
import uk.co.real_logic.artio.builder.AdvertisementEncoder;
...
import static uk.co.real_logic.artio.builder.AdvertisementEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.AdvertisementEncoder.UnderlyingsGroupEncoder;
...
public class AdvertisementDecoder extends CommonDecoderImpl implements InstrumentDecoder, MessageDecoder
{
...

    {
        ...
        {
            REQUIRED_FIELDS.add(Constants.ADV_ID);
            REQUIRED_FIELDS.add(Constants.ADV_TRANS_TYPE);
            REQUIRED_FIELDS.add(Constants.SYMBOL);
            REQUIRED_FIELDS.add(Constants.ADV_SIDE);
            REQUIRED_FIELDS.add(Constants.QUANTITY);
        }
    }

    public final IntHashSet GROUP_FIELDS = new IntHashSet(116);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            GROUP_FIELDS.add(Constants.ADV_ID);
            GROUP_FIELDS.add(Constants.ADV_TRANS_TYPE);
            GROUP_FIELDS.add(Constants.ADV_REF_ID);
            ...
            GROUP_FIELDS.add(Constants.ADV_SIDE);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(116);
    ...
    public boolean validate()
    {
        ...
        advTransTypeWrapper.wrap(this.advTransType(), advTransTypeLength);
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !AdvTransType.isValid(advTransTypeWrapper))
        {
            invalidTagId = 5;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !AdvSide.isValid(advSide()))
        {
            invalidTagId = 4;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_VALIDATION_ENABLED && advSideLength > 1)
        {
            invalidTagId = 4;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 55L;

    public static final String MESSAGE_TYPE_AS_STRING = "7";
...

    {
        ...
        messageFields.add(Constants.ADV_ID);
        messageFields.add(Constants.ADV_TRANS_TYPE);
        messageFields.add(Constants.ADV_REF_ID);
        ...
        messageFields.add(Constants.ADV_SIDE);
    ...
    private int advIdOffset;

    private int advIdLength;

    /* AdvId = 2 */
    public int advIdLength()
    {
        return advIdLength;
    }
    ...
    {
        return new String(advId, 0, advIdLength);
    }

    /* AdvId = 2 */
    public AsciiSequenceView advId(final AsciiSequenceView view)
    {
        return view.wrap(buffer, advIdOffset, advIdLength);
    }
    ...
    private int advTransTypeOffset;

    private int advTransTypeLength;

    /* AdvTransType = 5 */
    public int advTransTypeLength()
    {
        return advTransTypeLength;
    }

    /* AdvTransType = 5 */
    public String advTransTypeAsString()
    {
        return new String(advTransType, 0, advTransTypeLength);
    }

    /* AdvTransType = 5 */
    public AsciiSequenceView advTransType(final AsciiSequenceView view)
    {
        return view.wrap(buffer, advTransTypeOffset, advTransTypeLength);
    }


    private final CharArrayWrapper advTransTypeWrapper = new CharArrayWrapper();
    /* AdvTransType = 5 */
    public AdvTransType advTransTypeAsEnum()
    {
        advTransTypeWrapper.wrap(this.advTransType(), advTransTypeLength);
        return AdvTransType.decode(advTransTypeWrapper);
    }

    private char[] advRefID = new char[1];

    private boolean hasAdvRefID;

    /* AdvRefID = 3 */
    public char[] advRefID()
    {
        if (!hasAdvRefID)
        {
            throw new IllegalArgumentException("No value for optional field: AdvRefID");
        }
    ...
    private int advRefIDOffset;

    private int advRefIDLength;

    /* AdvRefID = 3 */
    public int advRefIDLength()
    {
        if (!hasAdvRefID)
        {
            throw new IllegalArgumentException("No value for optional field: AdvRefID");
        ...
        return advRefIDLength;
    }

    /* AdvRefID = 3 */
    public String advRefIDAsString()
    {
        return hasAdvRefID ? new String(advRefID, 0, advRefIDLength) : null;
    }

    /* AdvRefID = 3 */
    public AsciiSequenceView advRefID(final AsciiSequenceView view)
    {
        if (!hasAdvRefID)
        {
            throw new IllegalArgumentException("No value for optional field: AdvRefID");
        ...
        return view.wrap(buffer, advRefIDOffset, advRefIDLength);
    }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public AdvertisementEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AdvertisementEncoder.LegsGroupEncoder)encoder);
    }

    public AdvertisementEncoder.LegsGroupEncoder toEncoder(final AdvertisementEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final AdvertisementDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final AdvertisementDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            REQUIRED_FIELDS.add(Constants.UNDERLYING_SYMBOL);
        }
    }
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public AdvertisementEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AdvertisementEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public AdvertisementEncoder.UnderlyingsGroupEncoder toEncoder(final AdvertisementEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final AdvertisementDecoder parent)
        {
            this.parent = parent;
        }
    ...
    private char advSide = MISSING_CHAR;

    private int advSideLength = 0;
    public int advSideLength()    {
       return advSideLength;
    }
    /* AdvSide = 4 */
    public char advSide()
    {
    ...
    private final CharArrayWrapper advSideWrapper = new CharArrayWrapper();
    /* AdvSide = 4 */
    public AdvSide advSideAsEnum()
    {
        return AdvSide.decode(advSide);
    }
 ...
 return QtyType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            switch (tag)
            {
            case Constants.ADV_ID:
                advId = buffer.getChars(advId, valueOffset, valueLength);
                advIdOffset = valueOffset;
                advIdLength = valueLength;
                break;

            case Constants.ADV_TRANS_TYPE:
                advTransType = buffer.getChars(advTransType, valueOffset, valueLength);
                advTransTypeOffset = valueOffset;
                advTransTypeLength = valueLength;
                break;

            case Constants.ADV_REF_ID:
                hasAdvRefID = true;
                advRefID = buffer.getChars(advRefID, valueOffset, valueLength);
                advRefIDOffset = valueOffset;
                advRefIDLength = valueLength;
                break;
            ...
            case Constants.ADV_SIDE:
                advSide = buffer.getChar(valueOffset);
                advSideLength = valueLength;
                break;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        builder.append(this.advId(), 0, advIdLength());
        builder.append("\",\n");

        indent(builder, level);
        builder.append("\"AdvTransType\": \"");
        builder.append(this.advTransType(), 0, advTransTypeLength());
        builder.append("\",\n");
        ...
        if (hasAdvRefID())
        {
            ...
            builder.append(this.advRefID(), 0, advRefIDLength());
            builder.append("\",\n");
        }
    ...
    public AdvertisementEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AdvertisementEncoder)encoder);
    }

    public AdvertisementEncoder toEncoder(final AdvertisementEncoder encoder)
    {
        encoder.reset();
        encoder.advId(this.advId(), 0, advIdLength());
        encoder.advTransType(this.advTransType(), 0, advTransTypeLength());
        if (hasAdvRefID())
        {
            encoder.advRefID(this.advRefID(), 0, advRefIDLength());
        }
