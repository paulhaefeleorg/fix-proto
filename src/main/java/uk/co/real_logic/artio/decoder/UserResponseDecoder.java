...
import uk.co.real_logic.artio.builder.UserResponseEncoder;
...
public class UserResponseDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    /* UserRequestID = 923 */
    public AsciiSequenceView userRequestID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, userRequestIDOffset, userRequestIDLength);
    }
 ...
 return UserStatus.NULL_VAL;
    ...
    /* UserStatusText = 927 */
    public AsciiSequenceView userStatusText(final AsciiSequenceView view)
    {
        if (!hasUserStatusText)
        {
            throw new IllegalArgumentException("No value for optional field: UserStatusText");
        ...
        return view.wrap(buffer, userStatusTextOffset, userStatusTextLength);
    }
