...
import uk.co.real_logic.artio.builder.OrderStatusRequestEncoder;
...
import static uk.co.real_logic.artio.builder.OrderStatusRequestEncoder.UnderlyingsGroupEncoder;
...
public class OrderStatusRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(308);
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public OrderStatusRequestEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((OrderStatusRequestEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public OrderStatusRequestEncoder.UnderlyingsGroupEncoder toEncoder(final OrderStatusRequestEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final OrderStatusRequestDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final OrderStatusRequestDecoder parent)
        {
            this.parent = parent;
        }
