...
import uk.co.real_logic.artio.builder.CollateralAssignmentEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralAssignmentEncoder.ExecsGroupEncoder;
import static uk.co.real_logic.artio.builder.CollateralAssignmentEncoder.TradesGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralAssignmentEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralAssignmentEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralAssignmentEncoder.MiscFeesGroupEncoder;
...
public class CollateralAssignmentDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, TrdRegTimestampsDecoder, SpreadOrBenchmarkCurveDataDecoder, StipulationsDecoder, SettlInstructionsDataDecoder, MessageDecoder
{
...

    {
        ...
        {
            REQUIRED_FIELDS.add(Constants.COLL_ASGN_ID);
            REQUIRED_FIELDS.add(Constants.COLL_ASGN_REASON);
            REQUIRED_FIELDS.add(Constants.COLL_ASGN_TRANS_TYPE);
            REQUIRED_FIELDS.add(Constants.TRANSACT_TIME);
        }
    }

    public final IntHashSet GROUP_FIELDS = new IntHashSet(194);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.COLL_ASGN_REF_ID);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(194);
    ...
    public static final long MESSAGE_TYPE = 22849L;

    public static final String MESSAGE_TYPE_AS_STRING = "AY";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(532);

    {
        ...
        messageFields.add(Constants.COLL_ASGN_REF_ID);
    ...
    {
        return new String(collAsgnID, 0, collAsgnIDLength);
    }

    /* CollAsgnID = 902 */
    public AsciiSequenceView collAsgnID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, collAsgnIDOffset, collAsgnIDLength);
    }
    ...
    /* CollReqID = 894 */
    public AsciiSequenceView collReqID(final AsciiSequenceView view)
    {
        if (!hasCollReqID)
        {
            throw new IllegalArgumentException("No value for optional field: CollReqID");
        ...
        return view.wrap(buffer, collReqIDOffset, collReqIDLength);
    }
    ...
    private char[] collAsgnRefID = new char[1];

    private boolean hasCollAsgnRefID;

    /* CollAsgnRefID = 907 */
    public char[] collAsgnRefID()
    {
        if (!hasCollAsgnRefID)
        {
            throw new IllegalArgumentException("No value for optional field: CollAsgnRefID");
        }
    ...
    {
        return hasCollAsgnRefID;
    }


    private int collAsgnRefIDOffset;

    private int collAsgnRefIDLength;

    /* CollAsgnRefID = 907 */
    public int collAsgnRefIDLength()
    {
        if (!hasCollAsgnRefID)
        {
            throw new IllegalArgumentException("No value for optional field: CollAsgnRefID");
        ...
        return collAsgnRefIDLength;
    }

    /* CollAsgnRefID = 907 */
    public String collAsgnRefIDAsString()
    {
        return hasCollAsgnRefID ? new String(collAsgnRefID, 0, collAsgnRefIDLength) : null;
    }

    /* CollAsgnRefID = 907 */
    public AsciiSequenceView collAsgnRefID(final AsciiSequenceView view)
    {
        if (!hasCollAsgnRefID)
        {
            throw new IllegalArgumentException("No value for optional field: CollAsgnRefID");
        ...
        return view.wrap(buffer, collAsgnRefIDOffset, collAsgnRefIDLength);
    }


    private final CharArrayWrapper collAsgnRefIDWrapper = new CharArrayWrapper();
...
public class ExecsGroupDecoder extends CommonDecoderImpl
{
    ...
    public CollateralAssignmentEncoder.ExecsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralAssignmentEncoder.ExecsGroupEncoder)encoder);
    }

    public CollateralAssignmentEncoder.ExecsGroupEncoder toEncoder(final CollateralAssignmentEncoder.ExecsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasExecID())
        {
    ...
    {
        private final CollateralAssignmentDecoder parent;
        private int remainder;
        private ExecsGroupDecoder current;

        public ExecsGroupIterator(final CollateralAssignmentDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradesGroupDecoder extends CommonDecoderImpl
{
    ...
    public CollateralAssignmentEncoder.TradesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralAssignmentEncoder.TradesGroupEncoder)encoder);
    }

    public CollateralAssignmentEncoder.TradesGroupEncoder toEncoder(final CollateralAssignmentEncoder.TradesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradeReportID())
        {
    ...
    public class TradesGroupIterator implements Iterable<TradesGroupDecoder>, java.util.Iterator<TradesGroupDecoder>
    {
        ...
        public TradesGroupIterator(final CollateralAssignmentDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public CollateralAssignmentEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralAssignmentEncoder.LegsGroupEncoder)encoder);
    }

    public CollateralAssignmentEncoder.LegsGroupEncoder toEncoder(final CollateralAssignmentEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final CollateralAssignmentDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(92);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.COLL_ACTION);
        }
    }
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ALL_GROUP_FIELDS.add(Constants.COLL_ACTION);
        }
    }
    ...
    public boolean validate()
    {
        ...
        if (hasCollAction)
        {
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !CollAction.isValid(collAction()))
        {
            invalidTagId = 944;
            rejectReason = 5;
            return false;
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    private int collAction = MISSING_INT;
    ...
    public int collAction()
    {
        if (!hasCollAction)
        {
            throw new IllegalArgumentException("No value for optional field: CollAction");
        }
    ...
    private final CharArrayWrapper collActionWrapper = new CharArrayWrapper();
    /* CollAction = 944 */
    public CollAction collActionAsEnum()
    {
        if (!hasCollAction)
 return CollAction.NULL_VAL;
        return CollAction.decode(collAction);
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.COLL_ACTION:
                hasCollAction = true;
                collAction = getInt(buffer, valueOffset, endOfField, 944, CODEC_VALIDATION_ENABLED);
                break;
    ...
    public CollateralAssignmentEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralAssignmentEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public CollateralAssignmentEncoder.UnderlyingsGroupEncoder toEncoder(final CollateralAssignmentEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final CollateralAssignmentDecoder parent)
        {
            this.parent = parent;
        }
...
public class MiscFeesGroupDecoder extends CommonDecoderImpl
{
 ...
 return MiscFeeBasis.NULL_VAL;
    ...
    public CollateralAssignmentEncoder.MiscFeesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralAssignmentEncoder.MiscFeesGroupEncoder)encoder);
    }

    public CollateralAssignmentEncoder.MiscFeesGroupEncoder toEncoder(final CollateralAssignmentEncoder.MiscFeesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasMiscFeeAmt())
        {
    ...
    public class MiscFeesGroupIterator implements Iterable<MiscFeesGroupDecoder>, java.util.Iterator<MiscFeesGroupDecoder>
    {
        ...
        public MiscFeesGroupIterator(final CollateralAssignmentDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return StandInstDbType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.COLL_ASGN_REF_ID:
                hasCollAsgnRefID = true;
                collAsgnRefID = buffer.getChars(collAsgnRefID, valueOffset, valueLength);
                collAsgnRefIDOffset = valueOffset;
                collAsgnRefIDLength = valueLength;
                break;
    ...
    {
        collAsgnReason = MISSING_INT;
    }

    public void resetCollAsgnTransType()
    {
        collAsgnTransType = MISSING_INT;
    }

    public void resetCollAsgnRefID()
    {
        hasCollAsgnRefID = false;
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasCollAsgnRefID())
        {
            ...
            builder.append(this.collAsgnRefID(), 0, collAsgnRefIDLength());
            builder.append("\",\n");
        }
    ...
    public CollateralAssignmentEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralAssignmentEncoder)encoder);
    }

    public CollateralAssignmentEncoder toEncoder(final CollateralAssignmentEncoder encoder)
    {
        encoder.reset();
        ...
        if (hasCollAsgnRefID())
        {
            encoder.collAsgnRefID(this.collAsgnRefID(), 0, collAsgnRefIDLength());
        }
