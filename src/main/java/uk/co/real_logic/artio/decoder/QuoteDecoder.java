...
import static uk.co.real_logic.artio.builder.QuoteEncoder.QuoteQualifiersGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteEncoder.LegsGroupEncoder;
...
public class QuoteDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, OrderQtyDataDecoder, StipulationsDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, MessageDecoder
{
    ...
    public static final long MESSAGE_TYPE = 83L;

    public static final String MESSAGE_TYPE_AS_STRING = "S";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(572);
...
public class QuoteQualifiersGroupDecoder extends CommonDecoderImpl
{
    ...
    public QuoteEncoder.QuoteQualifiersGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteEncoder.QuoteQualifiersGroupEncoder)encoder);
    }

    public QuoteEncoder.QuoteQualifiersGroupEncoder toEncoder(final QuoteEncoder.QuoteQualifiersGroupEncoder encoder)
    {
        encoder.reset();
        if (hasQuoteQualifier())
        {
    ...
    {
        private final QuoteDecoder parent;
        private int remainder;
        private QuoteQualifiersGroupDecoder current;

        public QuoteQualifiersGroupIterator(final QuoteDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public QuoteEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public QuoteEncoder.UnderlyingsGroupEncoder toEncoder(final QuoteEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final QuoteDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder, NestedPartiesDecoder, LegBenchmarkCurveDataDecoder
{
 ...
 return LegSwapType.NULL_VAL;
    ...
    /* LegBenchmarkCurveCurrency = 676 */
    public AsciiSequenceView legBenchmarkCurveCurrency(final AsciiSequenceView view)
    {
        if (!hasLegBenchmarkCurveCurrency)
        {
            throw new IllegalArgumentException("No value for optional field: LegBenchmarkCurveCurrency");
        ...
        return view.wrap(buffer, legBenchmarkCurveCurrencyOffset, legBenchmarkCurveCurrencyLength);
    }
    ...
    /* LegBenchmarkCurveName = 677 */
    public AsciiSequenceView legBenchmarkCurveName(final AsciiSequenceView view)
    {
        if (!hasLegBenchmarkCurveName)
        {
            throw new IllegalArgumentException("No value for optional field: LegBenchmarkCurveName");
        ...
        return view.wrap(buffer, legBenchmarkCurveNameOffset, legBenchmarkCurveNameLength);
    }
    ...
    /* LegBenchmarkCurvePoint = 678 */
    public AsciiSequenceView legBenchmarkCurvePoint(final AsciiSequenceView view)
    {
        if (!hasLegBenchmarkCurvePoint)
        {
            throw new IllegalArgumentException("No value for optional field: LegBenchmarkCurvePoint");
        ...
        return view.wrap(buffer, legBenchmarkCurvePointOffset, legBenchmarkCurvePointLength);
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.LEG_BID_PX:
                hasLegBidPx = true;
                legBidPx = getFloat(buffer, legBidPx, valueOffset, valueLength, 681, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.LEG_OFFER_PX:
                hasLegOfferPx = true;
                legOfferPx = getFloat(buffer, legOfferPx, valueOffset, valueLength, 684, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.LEG_BENCHMARK_PRICE:
                ...
                legBenchmarkPrice = getFloat(buffer, legBenchmarkPrice, valueOffset, valueLength, 679, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    public QuoteEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteEncoder.LegsGroupEncoder)encoder);
    }

    public QuoteEncoder.LegsGroupEncoder toEncoder(final QuoteEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final QuoteDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return YieldType.NULL_VAL;
    ...
    public QuoteEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteEncoder)encoder);
    }

    public QuoteEncoder toEncoder(final QuoteEncoder encoder)
    {
        encoder.reset();
        if (hasQuoteReqID())
        {
