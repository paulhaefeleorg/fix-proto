...
import static uk.co.real_logic.artio.builder.OrderCancelReplaceRequestEncoder.AllocsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.OrderCancelReplaceRequestEncoder.TradingSessionsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.OrderCancelReplaceRequestEncoder.UnderlyingsGroupEncoder;
...
public class OrderCancelReplaceRequestDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, OrderQtyDataDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, PegInstructionsDecoder, DiscretionInstructionsDecoder, CommissionDataDecoder, MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(522);
...
public class AllocsGroupDecoder extends CommonDecoderImpl implements NestedPartiesDecoder
{
    ...
    public OrderCancelReplaceRequestEncoder.AllocsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((OrderCancelReplaceRequestEncoder.AllocsGroupEncoder)encoder);
    }

    public OrderCancelReplaceRequestEncoder.AllocsGroupEncoder toEncoder(final OrderCancelReplaceRequestEncoder.AllocsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasAllocAccount())
        {
    ...
    {
        private final OrderCancelReplaceRequestDecoder parent;
        private int remainder;
        private AllocsGroupDecoder current;

        public AllocsGroupIterator(final OrderCancelReplaceRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradingSessionsGroupDecoder extends CommonDecoderImpl
{
    ...
    public OrderCancelReplaceRequestEncoder.TradingSessionsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((OrderCancelReplaceRequestEncoder.TradingSessionsGroupEncoder)encoder);
    }

    public OrderCancelReplaceRequestEncoder.TradingSessionsGroupEncoder toEncoder(final OrderCancelReplaceRequestEncoder.TradingSessionsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradingSessionID())
        {
    ...
    public class TradingSessionsGroupIterator implements Iterable<TradingSessionsGroupDecoder>, java.util.Iterator<TradingSessionsGroupDecoder>
    {
        ...
        public TradingSessionsGroupIterator(final OrderCancelReplaceRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public OrderCancelReplaceRequestEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((OrderCancelReplaceRequestEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public OrderCancelReplaceRequestEncoder.UnderlyingsGroupEncoder toEncoder(final OrderCancelReplaceRequestEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final OrderCancelReplaceRequestDecoder parent)
        {
            this.parent = parent;
        }
