...
public class TestRequestDecoder extends CommonDecoderImpl implements MessageDecoder, AbstractTestRequestDecoder
{
...

    {
        ...
        {
            REQUIRED_FIELDS.add(Constants.TEST_REQ_ID);
        }
    }
    ...
    public static final long MESSAGE_TYPE = 49L;
    ...
    public final IntHashSet messageFields = new IntHashSet(60);
    ...
    {
        return new String(testReqID, 0, testReqIDLength);
    }

    /* TestReqID = 112 */
    public AsciiSequenceView testReqID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, testReqIDOffset, testReqIDLength);
    }
    ...
    public TestRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((TestRequestEncoder)encoder);
    }

    public TestRequestEncoder toEncoder(final TestRequestEncoder encoder)
    {
        encoder.reset();
        encoder.testReqID(this.testReqID(), 0, testReqIDLength());        return encoder;
    }
