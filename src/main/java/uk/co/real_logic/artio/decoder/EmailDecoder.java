...
import uk.co.real_logic.artio.builder.EmailEncoder;
import static uk.co.real_logic.artio.builder.EmailEncoder.RoutingIDsGroupEncoder;
import static uk.co.real_logic.artio.builder.EmailEncoder.RelatedSymGroupEncoder;
...
import static uk.co.real_logic.artio.builder.EmailEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.EmailEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.EmailEncoder.LinesOfTextGroupEncoder;

@Generated("uk.co.real_logic.artio")
public class EmailDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    public boolean validate()
    {
        ...
        if (CODEC_VALIDATION_ENABLED && emailTypeLength > 1)
        {
            invalidTagId = 94;
            rejectReason = 5;
            return false;
    ...
    public final IntHashSet messageFields = new IntHashSet(386);
    ...
    /* EmailThreadID = 164 */
    public AsciiSequenceView emailThreadID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, emailThreadIDOffset, emailThreadIDLength);
    }
    ...
    private int emailTypeLength = 0;
    public int emailTypeLength()    {
       return emailTypeLength;
    }
    /* EmailType = 94 */
    ...
    /* OrigTime = 42 */
    public AsciiSequenceView origTime(final AsciiSequenceView view)
    {
        if (!hasOrigTime)
        {
            throw new IllegalArgumentException("No value for optional field: OrigTime");
        ...
        return view.wrap(buffer, origTimeOffset, origTimeLength);
    }
    ...
    /* Subject = 147 */
    public AsciiSequenceView subject(final AsciiSequenceView view)
    {
        return view.wrap(buffer, subjectOffset, subjectLength);
    }
...
public class RoutingIDsGroupDecoder extends CommonDecoderImpl
{
 ...
 return RoutingType.NULL_VAL;
    ...
    public EmailEncoder.RoutingIDsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((EmailEncoder.RoutingIDsGroupEncoder)encoder);
    }

    public EmailEncoder.RoutingIDsGroupEncoder toEncoder(final EmailEncoder.RoutingIDsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasRoutingType())
        {
    ...
    {
        private final EmailDecoder parent;
        private int remainder;
        private RoutingIDsGroupDecoder current;

        public RoutingIDsGroupIterator(final EmailDecoder parent)
        {
            this.parent = parent;
        }
...
public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder
{
 ...
 return PutOrCall.NULL_VAL;
    ...
    public EmailEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((EmailEncoder.RelatedSymGroupEncoder)encoder);
    }

    public EmailEncoder.RelatedSymGroupEncoder toEncoder(final EmailEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class RelatedSymGroupIterator implements Iterable<RelatedSymGroupDecoder>, java.util.Iterator<RelatedSymGroupDecoder>
    {
        ...
        public RelatedSymGroupIterator(final EmailDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public EmailEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((EmailEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public EmailEncoder.UnderlyingsGroupEncoder toEncoder(final EmailEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final EmailDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public EmailEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((EmailEncoder.LegsGroupEncoder)encoder);
    }

    public EmailEncoder.LegsGroupEncoder toEncoder(final EmailEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final EmailDecoder parent)
        {
            this.parent = parent;
        }
...
public class LinesOfTextGroupDecoder extends CommonDecoderImpl
{
    ...
    public EmailEncoder.LinesOfTextGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((EmailEncoder.LinesOfTextGroupEncoder)encoder);
    }

    public EmailEncoder.LinesOfTextGroupEncoder toEncoder(final EmailEncoder.LinesOfTextGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LinesOfTextGroupIterator implements Iterable<LinesOfTextGroupDecoder>, java.util.Iterator<LinesOfTextGroupDecoder>
    {
        ...
        public LinesOfTextGroupIterator(final EmailDecoder parent)
        {
            this.parent = parent;
        }
        ...
        while (position < end)
        {
            ...
            case Constants.NO_ROUTING_IDS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noRoutingIDsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = routingIDsGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (routingIDsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (routingIDsGroupCurrent != null) 
                            {
            ...
            case Constants.NO_LINES_OF_TEXT_GROUP_COUNTER:
                ...
                for (int i = 0; i < noLinesOfTextGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = linesOfTextGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (linesOfTextGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (linesOfTextGroupCurrent != null) 
                            {
