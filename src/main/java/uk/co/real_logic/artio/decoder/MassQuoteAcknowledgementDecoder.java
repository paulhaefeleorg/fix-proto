...
import uk.co.real_logic.artio.builder.MassQuoteAcknowledgementEncoder;
...
import static uk.co.real_logic.artio.builder.MassQuoteAcknowledgementEncoder.QuoteSetsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MassQuoteAcknowledgementEncoder.QuoteSetsGroupEncoder.QuoteEntriesGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MassQuoteAcknowledgementEncoder.QuoteSetsGroupEncoder.QuoteEntriesGroupEncoder.LegsGroupEncoder;
...
public class MassQuoteAcknowledgementDecoder extends CommonDecoderImpl implements PartiesDecoder, MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(446);
...
@Generated("uk.co.real_logic.artio")
public class QuoteSetsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(96);
    ...
    /* QuoteSetID = 302 */
    public AsciiSequenceView quoteSetID(final AsciiSequenceView view)
    {
        if (!hasQuoteSetID)
        {
            throw new IllegalArgumentException("No value for optional field: QuoteSetID");
        ...
        return view.wrap(buffer, quoteSetIDOffset, quoteSetIDLength);
    }
...
@Generated("uk.co.real_logic.artio")
public class QuoteEntriesGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder
{
    public final IntHashSet REQUIRED_FIELDS = new IntHashSet(0);
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(132);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.QUOTE_ENTRY_REJECT_REASON);
        }
    }

    public final IntHashSet ALL_GROUP_FIELDS = new IntHashSet(50);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ALL_GROUP_FIELDS.add(Constants.QUOTE_ENTRY_ID);
            ALL_GROUP_FIELDS.add(Constants.BID_PX);
            ALL_GROUP_FIELDS.add(Constants.OFFER_PX);
            ALL_GROUP_FIELDS.add(Constants.BID_SIZE);
            ALL_GROUP_FIELDS.add(Constants.OFFER_SIZE);
            ALL_GROUP_FIELDS.add(Constants.VALID_UNTIL_TIME);
            ALL_GROUP_FIELDS.add(Constants.BID_SPOT_RATE);
            ALL_GROUP_FIELDS.add(Constants.OFFER_SPOT_RATE);
            ALL_GROUP_FIELDS.add(Constants.BID_FORWARD_POINTS);
            ALL_GROUP_FIELDS.add(Constants.OFFER_FORWARD_POINTS);
            ALL_GROUP_FIELDS.add(Constants.MID_PX);
            ALL_GROUP_FIELDS.add(Constants.BID_YIELD);
            ALL_GROUP_FIELDS.add(Constants.MID_YIELD);
            ALL_GROUP_FIELDS.add(Constants.OFFER_YIELD);
            ...
            ALL_GROUP_FIELDS.add(Constants.BID_FORWARD_POINTS2);
            ALL_GROUP_FIELDS.add(Constants.OFFER_FORWARD_POINTS2);
            ALL_GROUP_FIELDS.add(Constants.CURRENCY);
            ALL_GROUP_FIELDS.add(Constants.QUOTE_ENTRY_REJECT_REASON);
        }
    }
    ...
    public boolean validate()
    {
        ...
        {
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !QuoteEntryRejectReason.isValid(quoteEntryRejectReason()))
        {
            invalidTagId = 368;
            rejectReason = 5;
            return false;
    ...
    private final TrailerDecoder trailer;
    private final IntHashSet messageFields;
    public QuoteEntriesGroupDecoder(final TrailerDecoder trailer, final IntHashSet messageFields)
    {
        this.trailer = trailer;
        this.messageFields = messageFields;
    }

    private QuoteEntriesGroupDecoder next = null;

    public QuoteEntriesGroupDecoder next()
    {
        return next;
    }

    private IntHashSet seenFields = new IntHashSet(54);
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public QuoteEntriesGroupEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteEntriesGroupEncoder.LegsGroupEncoder)encoder);
    }

    public QuoteEntriesGroupEncoder.LegsGroupEncoder toEncoder(final QuoteEntriesGroupEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final QuoteEntriesGroupDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final QuoteEntriesGroupDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return OrdType.NULL_VAL;
    ...
    private int quoteEntryRejectReason = MISSING_INT;
    ...
    public int quoteEntryRejectReason()
    {
        if (!hasQuoteEntryRejectReason)
        {
            throw new IllegalArgumentException("No value for optional field: QuoteEntryRejectReason");
        }
    ...
    private final CharArrayWrapper quoteEntryRejectReasonWrapper = new CharArrayWrapper();
    /* QuoteEntryRejectReason = 368 */
    public QuoteEntryRejectReason quoteEntryRejectReasonAsEnum()
    {
        if (!hasQuoteEntryRejectReason)
 return QuoteEntryRejectReason.NULL_VAL;
        return QuoteEntryRejectReason.decode(quoteEntryRejectReason);
    }

    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        // Decode QuoteEntriesGroup
        int seenFieldCount = 0;
        if (CODEC_VALIDATION_ENABLED)
        {
            missingRequiredFields.copy(REQUIRED_FIELDS);
        ...
        while (position < end)
        {
            ...
            if (!seenFields.add(tag))
            {
                if (next == null)
                {
                    next = new QuoteEntriesGroupDecoder(trailer, messageFields);
                }
                return position - offset;
            }
            final int valueOffset = equalsPosition + 1;
            ...
            case Constants.QUOTE_ENTRY_REJECT_REASON:
                hasQuoteEntryRejectReason = true;
                quoteEntryRejectReason = getInt(buffer, valueOffset, endOfField, 368, CODEC_VALIDATION_ENABLED);
                break;
    ...
    public QuoteSetsGroupEncoder.QuoteEntriesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteSetsGroupEncoder.QuoteEntriesGroupEncoder)encoder);
    }

    public QuoteSetsGroupEncoder.QuoteEntriesGroupEncoder toEncoder(final QuoteSetsGroupEncoder.QuoteEntriesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasQuoteEntryID())
        {
    ...
    @Generated("uk.co.real_logic.artio")
    public class QuoteEntriesGroupIterator implements Iterable<QuoteEntriesGroupDecoder>, java.util.Iterator<QuoteEntriesGroupDecoder>
    {
        private final QuoteSetsGroupDecoder parent;
        private int remainder;
        private QuoteEntriesGroupDecoder current;

        public QuoteEntriesGroupIterator(final QuoteSetsGroupDecoder parent)
        {
            this.parent = parent;
        }
        ...
        {
            remainder--;
            final QuoteEntriesGroupDecoder value = current;
            current = current.next();
            return value;
        }
        ...
        public int numberFieldValue()
        {
            return parent.hasNoQuoteEntriesGroupCounter() ? parent.noQuoteEntriesGroupCounter() : 0;
        }

        public void reset()
        {
            remainder = numberFieldValue();
            current = parent.quoteEntriesGroup();
        }

        public QuoteEntriesGroupIterator iterator()
        {
            reset();
            return this;
        }
        ...
        while (position < end)
        {
            ...
            case Constants.NO_QUOTE_ENTRIES_GROUP_COUNTER:
                ...
                for (int i = 0; i < noQuoteEntriesGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = quoteEntriesGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (quoteEntriesGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (quoteEntriesGroupCurrent != null) 
                            {
    ...
    public MassQuoteAcknowledgementEncoder.QuoteSetsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MassQuoteAcknowledgementEncoder.QuoteSetsGroupEncoder)encoder);
    }

    public MassQuoteAcknowledgementEncoder.QuoteSetsGroupEncoder toEncoder(final MassQuoteAcknowledgementEncoder.QuoteSetsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasQuoteSetID())
        {
    ...
    {
        private final MassQuoteAcknowledgementDecoder parent;
        private int remainder;
        private QuoteSetsGroupDecoder current;

        public QuoteSetsGroupIterator(final MassQuoteAcknowledgementDecoder parent)
        {
            this.parent = parent;
        }
        ...
        while (position < end)
        {
            ...
            case Constants.NO_QUOTE_SETS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noQuoteSetsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = quoteSetsGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (quoteSetsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (quoteSetsGroupCurrent != null) 
                            {
