...
import uk.co.real_logic.artio.builder.AssignmentReportEncoder;
...
import static uk.co.real_logic.artio.builder.AssignmentReportEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.AssignmentReportEncoder.UnderlyingsGroupEncoder;
...
public class AssignmentReportDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, PositionQtyDecoder, PositionAmountDataDecoder, MessageDecoder
{
    public final IntHashSet REQUIRED_FIELDS = new IntHashSet(26);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            REQUIRED_FIELDS.add(Constants.ASGN_RPT_ID);
            ...
            REQUIRED_FIELDS.add(Constants.SETTL_PRICE);
            REQUIRED_FIELDS.add(Constants.SETTL_PRICE_TYPE);
            REQUIRED_FIELDS.add(Constants.UNDERLYING_SETTL_PRICE);
            REQUIRED_FIELDS.add(Constants.ASSIGNMENT_METHOD);
            REQUIRED_FIELDS.add(Constants.OPEN_INTEREST);
            REQUIRED_FIELDS.add(Constants.EXERCISE_METHOD);
            REQUIRED_FIELDS.add(Constants.SETTL_SESS_ID);
            REQUIRED_FIELDS.add(Constants.SETTL_SESS_SUB_ID);
            REQUIRED_FIELDS.add(Constants.CLEARING_BUSINESS_DATE);
        }
    }

    public final IntHashSet GROUP_FIELDS = new IntHashSet(124);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            GROUP_FIELDS.add(Constants.ASGN_RPT_ID);
            GROUP_FIELDS.add(Constants.TOT_NUM_ASSIGNMENT_REPORTS);
            ...
            GROUP_FIELDS.add(Constants.SETTL_PRICE_TYPE);
            GROUP_FIELDS.add(Constants.UNDERLYING_SETTL_PRICE);
            GROUP_FIELDS.add(Constants.EXPIRE_DATE);
            GROUP_FIELDS.add(Constants.ASSIGNMENT_METHOD);
            GROUP_FIELDS.add(Constants.ASSIGNMENT_UNIT);
            GROUP_FIELDS.add(Constants.OPEN_INTEREST);
            GROUP_FIELDS.add(Constants.EXERCISE_METHOD);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(124);

    private final IntHashSet unknownFields = new IntHashSet(10);

    private final IntHashSet missingRequiredFields = new IntHashSet(26);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !SettlPriceType.isValid(settlPriceType()))
        {
            invalidTagId = 731;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !AssignmentMethod.isValid(assignmentMethod()))
        {
            invalidTagId = 744;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !ExerciseMethod.isValid(exerciseMethod()))
        {
            invalidTagId = 747;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_VALIDATION_ENABLED && assignmentMethodLength > 1)
        {
            invalidTagId = 744;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_VALIDATION_ENABLED && exerciseMethodLength > 1)
        {
            invalidTagId = 747;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 22337L;

    public static final String MESSAGE_TYPE_AS_STRING = "AW";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(436);

    {
        ...
        messageFields.add(Constants.ASGN_RPT_ID);
        messageFields.add(Constants.TOT_NUM_ASSIGNMENT_REPORTS);
        ...
        messageFields.add(Constants.SETTL_PRICE_TYPE);
        messageFields.add(Constants.UNDERLYING_SETTL_PRICE);
        messageFields.add(Constants.EXPIRE_DATE);
        messageFields.add(Constants.ASSIGNMENT_METHOD);
        messageFields.add(Constants.ASSIGNMENT_UNIT);
        messageFields.add(Constants.OPEN_INTEREST);
        messageFields.add(Constants.EXERCISE_METHOD);
    ...
    private char[] asgnRptID = new char[1];

    /* AsgnRptID = 833 */
    public char[] asgnRptID()
    {
        return asgnRptID;
    }


    private int asgnRptIDOffset;

    private int asgnRptIDLength;

    /* AsgnRptID = 833 */
    public int asgnRptIDLength()
    {
        return asgnRptIDLength;
    }

    /* AsgnRptID = 833 */
    public String asgnRptIDAsString()
    {
        return new String(asgnRptID, 0, asgnRptIDLength);
    }

    /* AsgnRptID = 833 */
    public AsciiSequenceView asgnRptID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, asgnRptIDOffset, asgnRptIDLength);
    }


    private final CharArrayWrapper asgnRptIDWrapper = new CharArrayWrapper();
    private int totNumAssignmentReports = MISSING_INT;
    ...
    public int totNumAssignmentReports()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: TotNumAssignmentReports");
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public AssignmentReportEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AssignmentReportEncoder.LegsGroupEncoder)encoder);
    }

    public AssignmentReportEncoder.LegsGroupEncoder toEncoder(final AssignmentReportEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final AssignmentReportDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final AssignmentReportDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public AssignmentReportEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AssignmentReportEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public AssignmentReportEncoder.UnderlyingsGroupEncoder toEncoder(final AssignmentReportEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final AssignmentReportDecoder parent)
        {
            this.parent = parent;
        }
    ...
    private int settlPriceType = MISSING_INT;
    ...
    private final CharArrayWrapper settlPriceTypeWrapper = new CharArrayWrapper();
    /* SettlPriceType = 731 */
    public SettlPriceType settlPriceTypeAsEnum()
    {
        return SettlPriceType.decode(settlPriceType);
    }
    ...
    private char assignmentMethod = MISSING_CHAR;

    private int assignmentMethodLength = 0;
    public int assignmentMethodLength()    {
       return assignmentMethodLength;
    }
    ...
    private final CharArrayWrapper assignmentMethodWrapper = new CharArrayWrapper();
    /* AssignmentMethod = 744 */
    public AssignmentMethod assignmentMethodAsEnum()
    {
        return AssignmentMethod.decode(assignmentMethod);
    }

    private DecimalFloat assignmentUnit = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat assignmentUnit()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: AssignmentUnit");
        }
    ...
    private DecimalFloat openInterest = DecimalFloat.newNaNValue();
    ...
    private char exerciseMethod = MISSING_CHAR;

    private int exerciseMethodLength = 0;
    public int exerciseMethodLength()    {
       return exerciseMethodLength;
    }
    /* ExerciseMethod = 747 */
    ...
    private final CharArrayWrapper exerciseMethodWrapper = new CharArrayWrapper();
    /* ExerciseMethod = 747 */
    public ExerciseMethod exerciseMethodAsEnum()
    {
        return ExerciseMethod.decode(exerciseMethod);
    }
    ...
    {
        return new String(settlSessID, 0, settlSessIDLength);
    }
    ...
    {
        return new String(settlSessSubID, 0, settlSessSubIDLength);
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            switch (tag)
            {
            case Constants.ASGN_RPT_ID:
                asgnRptID = buffer.getChars(asgnRptID, valueOffset, valueLength);
                asgnRptIDOffset = valueOffset;
                asgnRptIDLength = valueLength;
                break;

            case Constants.TOT_NUM_ASSIGNMENT_REPORTS:
                hasTotNumAssignmentReports = true;
                totNumAssignmentReports = getInt(buffer, valueOffset, endOfField, 832, CODEC_VALIDATION_ENABLED);
                break;
            ...
            case Constants.SETTL_PRICE:
                settlPrice = getFloat(buffer, settlPrice, valueOffset, valueLength, 730, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.SETTL_PRICE_TYPE:
                settlPriceType = getInt(buffer, valueOffset, endOfField, 731, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.UNDERLYING_SETTL_PRICE:
                underlyingSettlPrice = getFloat(buffer, underlyingSettlPrice, valueOffset, valueLength, 732, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.ASSIGNMENT_METHOD:
                assignmentMethod = buffer.getChar(valueOffset);
                assignmentMethodLength = valueLength;
                break;

            case Constants.ASSIGNMENT_UNIT:
                hasAssignmentUnit = true;
                assignmentUnit = getFloat(buffer, assignmentUnit, valueOffset, valueLength, 745, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.OPEN_INTEREST:
                openInterest = getFloat(buffer, openInterest, valueOffset, valueLength, 746, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.EXERCISE_METHOD:
                exerciseMethod = buffer.getChar(valueOffset);
                exerciseMethodLength = valueLength;
                break;
    ...
    {
        settlPriceType = MISSING_INT;
    }

    public void resetUnderlyingSettlPrice()
    {
        underlyingSettlPrice.reset();
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        builder.append(this.asgnRptID(), 0, asgnRptIDLength());
        builder.append("\",\n");
    ...
    public AssignmentReportEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AssignmentReportEncoder)encoder);
    }

    public AssignmentReportEncoder toEncoder(final AssignmentReportEncoder encoder)
    {
        encoder.reset();
        encoder.asgnRptID(this.asgnRptID(), 0, asgnRptIDLength());
        if (hasTotNumAssignmentReports())
        {
