...
public class IndicationOfInterestDecoder extends CommonDecoderImpl implements InstrumentDecoder, FinancingDetailsDecoder, OrderQtyDataDecoder, StipulationsDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, MessageDecoder
{
...

    {
        ...
        {
            REQUIRED_FIELDS.add(Constants.I_O_I_ID);
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(172);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(172);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_VALIDATION_ENABLED && iOITransTypeLength > 1)
        {
            invalidTagId = 28;
            rejectReason = 5;
            return false;
        ...
        if (hasIOIQltyInd)
        {
        if (CODEC_VALIDATION_ENABLED && iOIQltyIndLength > 1)
        {
            invalidTagId = 25;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_VALIDATION_ENABLED && iOINaturalFlagLength > 1)
        {
            invalidTagId = 130;
            rejectReason = 5;
            return false;
    ...
    public final IntHashSet messageFields = new IntHashSet(464);
    ...
    private int iOITransTypeLength = 0;
    public int iOITransTypeLength()    {
       return iOITransTypeLength;
    }
    /* IOITransType = 28 */
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder
{
 ...
 return PriceType.NULL_VAL;
    ...
    private int iOIQltyIndLength = 0;
    public int iOIQltyIndLength()    {
       return iOIQltyIndLength;
    }
 ...
 return IOIQltyInd.NULL_VAL;
    ...
    private int iOINaturalFlagLength = 0;
    public int iOINaturalFlagLength()    {
       return iOINaturalFlagLength;
    }
...
public class IOIQualifiersGroupDecoder extends CommonDecoderImpl
{
    ...
    public boolean validate()
    {
        ...
        if (hasIOIQualifier)
        {
        if (CODEC_VALIDATION_ENABLED && iOIQualifierLength > 1)
        {
            invalidTagId = 104;
            rejectReason = 5;
            return false;
    ...
    private int iOIQualifierLength = 0;
    public int iOIQualifierLength()    {
       return iOIQualifierLength;
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.I_O_I_QUALIFIER:
                ...
                iOIQualifierLength = valueLength;
                break;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.I_O_I_TRANS_TYPE:
                ...
                iOITransTypeLength = valueLength;
                break;
            ...
            case Constants.NO_I_O_I_QUALIFIERS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noIOIQualifiersGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = iOIQualifiersGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (iOIQualifiersGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (iOIQualifiersGroupCurrent != null) 
                            {
