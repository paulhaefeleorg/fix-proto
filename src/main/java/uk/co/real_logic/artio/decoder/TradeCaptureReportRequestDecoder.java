...
import uk.co.real_logic.artio.builder.TradeCaptureReportRequestEncoder;
...
import static uk.co.real_logic.artio.builder.TradeCaptureReportRequestEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.TradeCaptureReportRequestEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.TradeCaptureReportRequestEncoder.DatesGroupEncoder;
        ...
        while (position < end)
        {
            ...
            case Constants.NO_DATES_GROUP_COUNTER:
                ...
                for (int i = 0; i < noDatesGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = datesGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
