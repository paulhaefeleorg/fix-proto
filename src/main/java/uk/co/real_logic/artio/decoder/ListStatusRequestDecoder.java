...
import uk.co.real_logic.artio.builder.ListStatusRequestEncoder;

@Generated("uk.co.real_logic.artio")
public class ListStatusRequestDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    public static final long MESSAGE_TYPE = 77L;
    ...
    public ListStatusRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((ListStatusRequestEncoder)encoder);
    }

    public ListStatusRequestEncoder toEncoder(final ListStatusRequestEncoder encoder)
    {
        encoder.reset();
