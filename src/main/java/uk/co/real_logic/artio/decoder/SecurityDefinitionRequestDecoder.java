...
import uk.co.real_logic.artio.builder.SecurityDefinitionRequestEncoder;
...
import static uk.co.real_logic.artio.builder.SecurityDefinitionRequestEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.SecurityDefinitionRequestEncoder.LegsGroupEncoder;
...
public class SecurityDefinitionRequestDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrumentExtensionDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.SECURITY_REQUEST_TYPE);
        }
    }
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.SECURITY_REQUEST_TYPE);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !SecurityRequestType.isValid(securityRequestType()))
        {
            invalidTagId = 321;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 99L;
    ...
    public final IntHashSet messageFields = new IntHashSet(380);

    {
        ...
        messageFields.add(Constants.SECURITY_REQUEST_TYPE);
    ...
    private int securityRequestType = MISSING_INT;
    ...
    private final CharArrayWrapper securityRequestTypeWrapper = new CharArrayWrapper();
    /* SecurityRequestType = 321 */
    public SecurityRequestType securityRequestTypeAsEnum()
    {
        return SecurityRequestType.decode(securityRequestType);
    }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public SecurityDefinitionRequestEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityDefinitionRequestEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public SecurityDefinitionRequestEncoder.UnderlyingsGroupEncoder toEncoder(final SecurityDefinitionRequestEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final SecurityDefinitionRequestDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final SecurityDefinitionRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public SecurityDefinitionRequestEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityDefinitionRequestEncoder.LegsGroupEncoder)encoder);
    }

    public SecurityDefinitionRequestEncoder.LegsGroupEncoder toEncoder(final SecurityDefinitionRequestEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final SecurityDefinitionRequestDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return SubscriptionRequestType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        // Decode SecurityDefinitionRequest
        int seenFieldCount = 0;
        if (CODEC_VALIDATION_ENABLED)
        {
            missingRequiredFields.copy(REQUIRED_FIELDS);
        ...
        while (position < end)
        {
            ...
            case Constants.SECURITY_REQUEST_TYPE:
                securityRequestType = getInt(buffer, valueOffset, endOfField, 321, CODEC_VALIDATION_ENABLED);
                break;
    ...
    {
        securityRequestType = MISSING_INT;
    }
    ...
    public SecurityDefinitionRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityDefinitionRequestEncoder)encoder);
    }

    public SecurityDefinitionRequestEncoder toEncoder(final SecurityDefinitionRequestEncoder encoder)
    {
        encoder.reset();
