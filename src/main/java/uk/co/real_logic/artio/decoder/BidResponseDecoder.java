...
import uk.co.real_logic.artio.builder.BidResponseEncoder;
import static uk.co.real_logic.artio.builder.BidResponseEncoder.BidComponentsGroupEncoder;
...
public class BidComponentsGroupDecoder extends CommonDecoderImpl implements CommissionDataDecoder
{
 ...
 return FundRenewWaiv.NULL_VAL;
    ...
    /* Country = 421 */
    public AsciiSequenceView country(final AsciiSequenceView view)
    {
        if (!hasCountry)
        {
            throw new IllegalArgumentException("No value for optional field: Country");
        ...
        return view.wrap(buffer, countryOffset, countryLength);
    }
 ...
 return SettlType.NULL_VAL;
    ...
    public BidResponseEncoder.BidComponentsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((BidResponseEncoder.BidComponentsGroupEncoder)encoder);
    }

    public BidResponseEncoder.BidComponentsGroupEncoder toEncoder(final BidResponseEncoder.BidComponentsGroupEncoder encoder)
    {
        encoder.reset();
