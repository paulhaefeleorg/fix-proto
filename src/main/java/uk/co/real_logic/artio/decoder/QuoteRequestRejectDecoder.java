...
import uk.co.real_logic.artio.builder.QuoteRequestRejectEncoder;
import static uk.co.real_logic.artio.builder.QuoteRequestRejectEncoder.RelatedSymGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteRequestRejectEncoder.RelatedSymGroupEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteRequestRejectEncoder.RelatedSymGroupEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteRequestRejectEncoder.QuoteQualifiersGroupEncoder;
...
public class QuoteRequestRejectDecoder extends CommonDecoderImpl implements SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, PartiesDecoder, MessageDecoder
{
...
@Generated("uk.co.real_logic.artio")
public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, FinancingDetailsDecoder, OrderQtyDataDecoder, StipulationsDecoder
{
    ...
    public final IntHashSet ALL_GROUP_FIELDS = new IntHashSet(32);
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder, NestedPartiesDecoder, LegBenchmarkCurveDataDecoder
{
 ...
 return LegSwapType.NULL_VAL;
    ...
    public QuoteRequestRejectEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteRequestRejectEncoder.RelatedSymGroupEncoder)encoder);
    }

    public QuoteRequestRejectEncoder.RelatedSymGroupEncoder toEncoder(final QuoteRequestRejectEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final QuoteRequestRejectDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final QuoteRequestRejectDecoder parent)
        {
            this.parent = parent;
        }
...
public class QuoteQualifiersGroupDecoder extends CommonDecoderImpl
{
    ...
    public QuoteRequestRejectEncoder.QuoteQualifiersGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteRequestRejectEncoder.QuoteQualifiersGroupEncoder)encoder);
    }

    public QuoteRequestRejectEncoder.QuoteQualifiersGroupEncoder toEncoder(final QuoteRequestRejectEncoder.QuoteQualifiersGroupEncoder encoder)
    {
        encoder.reset();
        if (hasQuoteQualifier())
        {
    ...
    public class QuoteQualifiersGroupIterator implements Iterable<QuoteQualifiersGroupDecoder>, java.util.Iterator<QuoteQualifiersGroupDecoder>
    {
        ...
        public QuoteQualifiersGroupIterator(final QuoteRequestRejectDecoder parent)
        {
            this.parent = parent;
        }
