...
@Generated("uk.co.real_logic.artio")
public class NestedPartyIDsGroupDecoder extends CommonDecoderImpl
{
    ...
    public boolean validate()
    {
        ...
        {
        if (CODEC_VALIDATION_ENABLED && nestedPartyIDSourceLength > 1)
        {
            invalidTagId = 525;
            rejectReason = 5;
            return false;
    ...
    /* NestedPartyID = 524 */
    public AsciiSequenceView nestedPartyID(final AsciiSequenceView view)
    {
        if (!hasNestedPartyID)
        {
            throw new IllegalArgumentException("No value for optional field: NestedPartyID");
        ...
        return view.wrap(buffer, nestedPartyIDOffset, nestedPartyIDLength);
    }


    private final CharArrayWrapper nestedPartyIDWrapper = new CharArrayWrapper();
    private char nestedPartyIDSource = MISSING_CHAR;

    private int nestedPartyIDSourceLength = 0;
    public int nestedPartyIDSourceLength()    {
       return nestedPartyIDSourceLength;
    }
...
public class NestedPartySubIDsGroupDecoder extends CommonDecoderImpl
{
    ...
    /* NestedPartySubID = 545 */
    public AsciiSequenceView nestedPartySubID(final AsciiSequenceView view)
    {
        if (!hasNestedPartySubID)
        {
            throw new IllegalArgumentException("No value for optional field: NestedPartySubID");
        ...
        return view.wrap(buffer, nestedPartySubIDOffset, nestedPartySubIDLength);
    }
    ...
    public NestedPartyIDsGroupEncoder.NestedPartySubIDsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NestedPartyIDsGroupEncoder.NestedPartySubIDsGroupEncoder)encoder);
    }

    public NestedPartyIDsGroupEncoder.NestedPartySubIDsGroupEncoder toEncoder(final NestedPartyIDsGroupEncoder.NestedPartySubIDsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasNestedPartySubID())
        {
    ...
    {
        private final NestedPartyIDsGroupDecoder parent;
        private int remainder;
        private NestedPartySubIDsGroupDecoder current;

        public NestedPartySubIDsGroupIterator(final NestedPartyIDsGroupDecoder parent)
        {
            this.parent = parent;
        }
    ...
    /* NoNestedPartySubIDsGroupCounter = 804 */
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.NESTED_PARTY_ID_SOURCE:
                ...
                nestedPartyIDSourceLength = valueLength;
                break;
            ...
            case Constants.NO_NESTED_PARTY_SUB_IDS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noNestedPartySubIDsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = nestedPartySubIDsGroupCurrent.decode(buffer, position, end - position);
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (nestedPartySubIDsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (nestedPartySubIDsGroupCurrent != null) 
                            {
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasNoNestedPartySubIDsGroupCounter)
        {
            ...
            for (int i = 0, size = this.noNestedPartySubIDsGroupCounter; i < size; i++)
            {
                ...
                if (nestedPartySubIDsGroup.next() != null)
                {
                    builder.append(',');
                }
                builder.append('\n');
    ...
    public NestedPartiesEncoder.NestedPartyIDsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NestedPartiesEncoder.NestedPartyIDsGroupEncoder)encoder);
    }

    public NestedPartiesEncoder.NestedPartyIDsGroupEncoder toEncoder(final NestedPartiesEncoder.NestedPartyIDsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasNestedPartyID())
        {
