...
import uk.co.real_logic.artio.builder.CrossOrderCancelRequestEncoder;
import static uk.co.real_logic.artio.builder.CrossOrderCancelRequestEncoder.SidesGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CrossOrderCancelRequestEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CrossOrderCancelRequestEncoder.LegsGroupEncoder;
...
public class CrossOrderCancelRequestDecoder extends CommonDecoderImpl implements InstrumentDecoder, MessageDecoder
{
    ...
    public static final long MESSAGE_TYPE = 117L;

    public static final String MESSAGE_TYPE_AS_STRING = "u";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(412);
...
public class SidesGroupDecoder extends CommonDecoderImpl implements PartiesDecoder, OrderQtyDataDecoder
{
 ...
 return RoundingDirection.NULL_VAL;
    ...
    public CrossOrderCancelRequestEncoder.SidesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CrossOrderCancelRequestEncoder.SidesGroupEncoder)encoder);
    }

    public CrossOrderCancelRequestEncoder.SidesGroupEncoder toEncoder(final CrossOrderCancelRequestEncoder.SidesGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final CrossOrderCancelRequestDecoder parent;
        private int remainder;
        private SidesGroupDecoder current;

        public SidesGroupIterator(final CrossOrderCancelRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public CrossOrderCancelRequestEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CrossOrderCancelRequestEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public CrossOrderCancelRequestEncoder.UnderlyingsGroupEncoder toEncoder(final CrossOrderCancelRequestEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final CrossOrderCancelRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public CrossOrderCancelRequestEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CrossOrderCancelRequestEncoder.LegsGroupEncoder)encoder);
    }

    public CrossOrderCancelRequestEncoder.LegsGroupEncoder toEncoder(final CrossOrderCancelRequestEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final CrossOrderCancelRequestDecoder parent)
        {
            this.parent = parent;
        }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        // Decode CrossOrderCancelRequest
        int seenFieldCount = 0;
        if (CODEC_VALIDATION_ENABLED)
        {
            missingRequiredFields.copy(REQUIRED_FIELDS);
    ...
    public CrossOrderCancelRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CrossOrderCancelRequestEncoder)encoder);
    }

    public CrossOrderCancelRequestEncoder toEncoder(final CrossOrderCancelRequestEncoder encoder)
    {
        encoder.reset();
        if (hasOrderID())
        {
        ...
        encoder.transactTimeAsCopy(this.transactTime(), 0, transactTimeLength());        return encoder;
    }
