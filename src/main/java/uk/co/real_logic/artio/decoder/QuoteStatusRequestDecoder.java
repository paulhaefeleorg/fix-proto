...
import uk.co.real_logic.artio.builder.QuoteStatusRequestEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteStatusRequestEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteStatusRequestEncoder.LegsGroupEncoder;
...
public class QuoteStatusRequestDecoder extends CommonDecoderImpl implements InstrumentDecoder, FinancingDetailsDecoder, PartiesDecoder, MessageDecoder
{
    ...
    public static final long MESSAGE_TYPE = 97L;
    ...
    public final IntHashSet messageFields = new IntHashSet(398);
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public QuoteStatusRequestEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteStatusRequestEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public QuoteStatusRequestEncoder.UnderlyingsGroupEncoder toEncoder(final QuoteStatusRequestEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final QuoteStatusRequestDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final QuoteStatusRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public QuoteStatusRequestEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteStatusRequestEncoder.LegsGroupEncoder)encoder);
    }

    public QuoteStatusRequestEncoder.LegsGroupEncoder toEncoder(final QuoteStatusRequestEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final QuoteStatusRequestDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return SubscriptionRequestType.NULL_VAL;
    ...
    public QuoteStatusRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteStatusRequestEncoder)encoder);
    }

    public QuoteStatusRequestEncoder toEncoder(final QuoteStatusRequestEncoder encoder)
    {
        encoder.reset();
        if (hasQuoteStatusReqID())
        {
