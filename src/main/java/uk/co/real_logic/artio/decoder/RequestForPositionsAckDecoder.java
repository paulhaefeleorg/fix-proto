...
import uk.co.real_logic.artio.builder.RequestForPositionsAckEncoder;
...
import static uk.co.real_logic.artio.builder.RequestForPositionsAckEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.RequestForPositionsAckEncoder.UnderlyingsGroupEncoder;
...
public class RequestForPositionsAckDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.POS_REQ_STATUS);
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.POS_REQ_STATUS);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(112);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !PosReqStatus.isValid(posReqStatus()))
        {
            invalidTagId = 729;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 20289L;

    public static final String MESSAGE_TYPE_AS_STRING = "AO";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(394);

    {
        ...
        messageFields.add(Constants.POS_REQ_STATUS);
    ...
    private int posReqStatus = MISSING_INT;
    ...
    private final CharArrayWrapper posReqStatusWrapper = new CharArrayWrapper();
    /* PosReqStatus = 729 */
    public PosReqStatus posReqStatusAsEnum()
    {
        return PosReqStatus.decode(posReqStatus);
    }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public RequestForPositionsAckEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RequestForPositionsAckEncoder.LegsGroupEncoder)encoder);
    }

    public RequestForPositionsAckEncoder.LegsGroupEncoder toEncoder(final RequestForPositionsAckEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final RequestForPositionsAckDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final RequestForPositionsAckDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public RequestForPositionsAckEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RequestForPositionsAckEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public RequestForPositionsAckEncoder.UnderlyingsGroupEncoder toEncoder(final RequestForPositionsAckEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final RequestForPositionsAckDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return ResponseTransportType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.POS_REQ_STATUS:
                posReqStatus = getInt(buffer, valueOffset, endOfField, 729, CODEC_VALIDATION_ENABLED);
                break;
    ...
    public RequestForPositionsAckEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RequestForPositionsAckEncoder)encoder);
    }

    public RequestForPositionsAckEncoder toEncoder(final RequestForPositionsAckEncoder encoder)
    {
        encoder.reset();
