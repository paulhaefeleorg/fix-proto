...
import uk.co.real_logic.artio.builder.SecurityStatusRequestEncoder;
...
import static uk.co.real_logic.artio.builder.SecurityStatusRequestEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.SecurityStatusRequestEncoder.LegsGroupEncoder;
...
public class SecurityStatusRequestDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrumentExtensionDecoder, MessageDecoder
{
...

    {
        ...
        {
            REQUIRED_FIELDS.add(Constants.SECURITY_STATUS_REQ_ID);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(96);
    ...
    public static final long MESSAGE_TYPE = 101L;
    ...
    public final IntHashSet messageFields = new IntHashSet(370);
    ...
    {
        return new String(securityStatusReqID, 0, securityStatusReqIDLength);
    }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public SecurityStatusRequestEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityStatusRequestEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public SecurityStatusRequestEncoder.UnderlyingsGroupEncoder toEncoder(final SecurityStatusRequestEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final SecurityStatusRequestDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final SecurityStatusRequestDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public SecurityStatusRequestEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityStatusRequestEncoder.LegsGroupEncoder)encoder);
    }

    public SecurityStatusRequestEncoder.LegsGroupEncoder toEncoder(final SecurityStatusRequestEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final SecurityStatusRequestDecoder parent)
        {
            this.parent = parent;
        }
    ...
    public SecurityStatusRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityStatusRequestEncoder)encoder);
    }

    public SecurityStatusRequestEncoder toEncoder(final SecurityStatusRequestEncoder encoder)
    {
        encoder.reset();
