...
import uk.co.real_logic.artio.builder.OrderMassCancelReportEncoder;
import static uk.co.real_logic.artio.builder.OrderMassCancelReportEncoder.AffectedOrdersGroupEncoder;
...
public class OrderMassCancelReportDecoder extends CommonDecoderImpl implements InstrumentDecoder, UnderlyingInstrumentDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.MASS_CANCEL_REQUEST_TYPE);
            REQUIRED_FIELDS.add(Constants.MASS_CANCEL_RESPONSE);
        }
    }

    public final IntHashSet GROUP_FIELDS = new IntHashSet(202);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.MASS_CANCEL_REQUEST_TYPE);
            GROUP_FIELDS.add(Constants.MASS_CANCEL_RESPONSE);
            GROUP_FIELDS.add(Constants.MASS_CANCEL_REJECT_REASON);
            GROUP_FIELDS.add(Constants.TOTAL_AFFECTED_ORDERS);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(202);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !MassCancelRequestType.isValid(massCancelRequestType()))
        {
            invalidTagId = 530;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !MassCancelResponse.isValid(massCancelResponse()))
        {
            invalidTagId = 531;
            rejectReason = 5;
            return false;
        ...
        {
        massCancelRejectReasonWrapper.wrap(this.massCancelRejectReason(), massCancelRejectReasonLength);
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !MassCancelRejectReason.isValid(massCancelRejectReasonWrapper))
        {
            invalidTagId = 532;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_VALIDATION_ENABLED && massCancelRequestTypeLength > 1)
        {
            invalidTagId = 530;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_VALIDATION_ENABLED && massCancelResponseLength > 1)
        {
            invalidTagId = 531;
            rejectReason = 5;
            return false;
        ...
        if (hasNoAffectedOrdersGroupCounter)
        {
            {
                int count = 0;
                final AffectedOrdersGroupIterator iterator = affectedOrdersGroupIterator.iterator();
                for (final AffectedOrdersGroupDecoder group : iterator)
                {
    ...
    public static final long MESSAGE_TYPE = 114L;
    ...
    public final IntHashSet messageFields = new IntHashSet(296);

    {
        ...
        messageFields.add(Constants.MASS_CANCEL_REQUEST_TYPE);
        messageFields.add(Constants.MASS_CANCEL_RESPONSE);
        messageFields.add(Constants.MASS_CANCEL_REJECT_REASON);
    ...
    private char massCancelRequestType = MISSING_CHAR;

    private int massCancelRequestTypeLength = 0;
    public int massCancelRequestTypeLength()    {
       return massCancelRequestTypeLength;
    }
    ...
    private final CharArrayWrapper massCancelRequestTypeWrapper = new CharArrayWrapper();
    /* MassCancelRequestType = 530 */
    public MassCancelRequestType massCancelRequestTypeAsEnum()
    {
        return MassCancelRequestType.decode(massCancelRequestType);
    }

    private char massCancelResponse = MISSING_CHAR;

    private int massCancelResponseLength = 0;
    public int massCancelResponseLength()    {
       return massCancelResponseLength;
    }
    ...
    private final CharArrayWrapper massCancelResponseWrapper = new CharArrayWrapper();
    /* MassCancelResponse = 531 */
    public MassCancelResponse massCancelResponseAsEnum()
    {
        return MassCancelResponse.decode(massCancelResponse);
    }

    private char[] massCancelRejectReason = new char[1];
    ...
    public char[] massCancelRejectReason()
    {
        if (!hasMassCancelRejectReason)
        {
            throw new IllegalArgumentException("No value for optional field: MassCancelRejectReason");
        }
    ...
    private int massCancelRejectReasonOffset;

    private int massCancelRejectReasonLength;

    /* MassCancelRejectReason = 532 */
    public int massCancelRejectReasonLength()
    {
        if (!hasMassCancelRejectReason)
        {
            throw new IllegalArgumentException("No value for optional field: MassCancelRejectReason");
        ...
        return massCancelRejectReasonLength;
    }

    /* MassCancelRejectReason = 532 */
    public String massCancelRejectReasonAsString()
    {
        return hasMassCancelRejectReason ? new String(massCancelRejectReason, 0, massCancelRejectReasonLength) : null;
    }

    /* MassCancelRejectReason = 532 */
    public AsciiSequenceView massCancelRejectReason(final AsciiSequenceView view)
    {
        if (!hasMassCancelRejectReason)
        {
            throw new IllegalArgumentException("No value for optional field: MassCancelRejectReason");
        ...
        return view.wrap(buffer, massCancelRejectReasonOffset, massCancelRejectReasonLength);
    }


    private final CharArrayWrapper massCancelRejectReasonWrapper = new CharArrayWrapper();
    /* MassCancelRejectReason = 532 */
    public MassCancelRejectReason massCancelRejectReasonAsEnum()
    {
        if (!hasMassCancelRejectReason)
 return MassCancelRejectReason.NULL_VAL;
        massCancelRejectReasonWrapper.wrap(this.massCancelRejectReason(), massCancelRejectReasonLength);
        return MassCancelRejectReason.decode(massCancelRejectReasonWrapper);
    }

    private int totalAffectedOrders = MISSING_INT;
    ...
    public int totalAffectedOrders()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: TotalAffectedOrders");
        }
...
public class AffectedOrdersGroupDecoder extends CommonDecoderImpl
{
    ...
    /* AffectedOrderID = 535 */
    public AsciiSequenceView affectedOrderID(final AsciiSequenceView view)
    {
        if (!hasAffectedOrderID)
        {
            throw new IllegalArgumentException("No value for optional field: AffectedOrderID");
        ...
        return view.wrap(buffer, affectedOrderIDOffset, affectedOrderIDLength);
    }
    ...
    /* AffectedSecondaryOrderID = 536 */
    public AsciiSequenceView affectedSecondaryOrderID(final AsciiSequenceView view)
    {
        if (!hasAffectedSecondaryOrderID)
        {
            throw new IllegalArgumentException("No value for optional field: AffectedSecondaryOrderID");
        ...
        return view.wrap(buffer, affectedSecondaryOrderIDOffset, affectedSecondaryOrderIDLength);
    }
    ...
    public OrderMassCancelReportEncoder.AffectedOrdersGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((OrderMassCancelReportEncoder.AffectedOrdersGroupEncoder)encoder);
    }

    public OrderMassCancelReportEncoder.AffectedOrdersGroupEncoder toEncoder(final OrderMassCancelReportEncoder.AffectedOrdersGroupEncoder encoder)
    {
        encoder.reset();
        if (hasOrigClOrdID())
        {
    ...
    {
        private final OrderMassCancelReportDecoder parent;
        private int remainder;
        private AffectedOrdersGroupDecoder current;

        public AffectedOrdersGroupIterator(final OrderMassCancelReportDecoder parent)
        {
            this.parent = parent;
        }
    ...
    private AffectedOrdersGroupDecoder affectedOrdersGroup = null;
    public AffectedOrdersGroupDecoder affectedOrdersGroup()
    {
        return affectedOrdersGroup;
    }

    private int noAffectedOrdersGroupCounter = MISSING_INT;
    ...
    public int noAffectedOrdersGroupCounter()
    {
        if (!hasNoAffectedOrdersGroupCounter)
        {
            throw new IllegalArgumentException("No value for optional field: NoAffectedOrdersGroupCounter");
        }
    ...
    private AffectedOrdersGroupIterator affectedOrdersGroupIterator = new AffectedOrdersGroupIterator(this);
    public AffectedOrdersGroupIterator affectedOrdersGroupIterator()
    {
        return affectedOrdersGroupIterator.iterator();
    }
 ...
 return Side.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.MASS_CANCEL_REQUEST_TYPE:
                massCancelRequestType = buffer.getChar(valueOffset);
                massCancelRequestTypeLength = valueLength;
                break;

            case Constants.MASS_CANCEL_RESPONSE:
                massCancelResponse = buffer.getChar(valueOffset);
                massCancelResponseLength = valueLength;
                break;

            case Constants.MASS_CANCEL_REJECT_REASON:
                hasMassCancelRejectReason = true;
                massCancelRejectReason = buffer.getChars(massCancelRejectReason, valueOffset, valueLength);
                massCancelRejectReasonOffset = valueOffset;
                massCancelRejectReasonLength = valueLength;
                break;

            case Constants.TOTAL_AFFECTED_ORDERS:
            ...
            case Constants.NO_AFFECTED_ORDERS_GROUP_COUNTER:
                ...
                {
                    affectedOrdersGroup = new AffectedOrdersGroupDecoder(trailer, messageFields);
                }
                AffectedOrdersGroupDecoder affectedOrdersGroupCurrent = affectedOrdersGroup;
                position = endOfField + 1;
                final int noAffectedOrdersGroupCounter = this.noAffectedOrdersGroupCounter;
                for (int i = 0; i < noAffectedOrdersGroupCounter && position < end; i++)
                {
                    if (affectedOrdersGroupCurrent != null)
                    {
                        positionIter = affectedOrdersGroupCurrent.decode(buffer, position, end - position);
                        ...
                        affectedOrdersGroupCurrent = affectedOrdersGroupCurrent.next();
                    }
                }
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (affectedOrdersGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (affectedOrdersGroupCurrent != null) 
                            {
                               position += affectedOrdersGroupCurrent.decode(buffer, position, end - position);
                               affectedOrdersGroupCurrent = affectedOrdersGroupCurrent.next();
                            }
                            return position - offset;
                        }
    ...
    {
        for (final AffectedOrdersGroupDecoder affectedOrdersGroupDecoder : affectedOrdersGroupIterator.iterator())
        {
            affectedOrdersGroupDecoder.reset();
            if (affectedOrdersGroupDecoder.next() == null)
            {
                break;
            }
        }
        noAffectedOrdersGroupCounter = MISSING_INT;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasMassCancelRejectReason())
        {
            ...
            builder.append(this.massCancelRejectReason(), 0, massCancelRejectReasonLength());
            builder.append("\",\n");
        }
    ...
    public OrderMassCancelReportEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((OrderMassCancelReportEncoder)encoder);
    }

    public OrderMassCancelReportEncoder toEncoder(final OrderMassCancelReportEncoder encoder)
    {
        encoder.reset();
        if (hasClOrdID())
        {
        ...
        if (hasMassCancelRejectReason())
        {
            encoder.massCancelRejectReason(this.massCancelRejectReason(), 0, massCancelRejectReasonLength());
        }
        ...
        if (hasNoAffectedOrdersGroupCounter)
        {
            ...
            for (int i = 0; i < size; i++)
            {
                if (affectedOrdersGroup != null)
                {
                    affectedOrdersGroup.toEncoder(affectedOrdersGroupEncoder);
                    affectedOrdersGroup = affectedOrdersGroup.next();
