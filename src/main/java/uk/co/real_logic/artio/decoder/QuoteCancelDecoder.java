...
import uk.co.real_logic.artio.builder.QuoteCancelEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteCancelEncoder.QuoteEntriesGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteCancelEncoder.QuoteEntriesGroupEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteCancelEncoder.QuoteEntriesGroupEncoder.LegsGroupEncoder;
...
public class QuoteCancelDecoder extends CommonDecoderImpl implements PartiesDecoder, MessageDecoder
{
...
@Generated("uk.co.real_logic.artio")
public class QuoteEntriesGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, FinancingDetailsDecoder
{
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public QuoteEntriesGroupEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteEntriesGroupEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public QuoteEntriesGroupEncoder.UnderlyingsGroupEncoder toEncoder(final QuoteEntriesGroupEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final QuoteEntriesGroupDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public QuoteCancelEncoder.QuoteEntriesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteCancelEncoder.QuoteEntriesGroupEncoder)encoder);
    }

    public QuoteCancelEncoder.QuoteEntriesGroupEncoder toEncoder(final QuoteCancelEncoder.QuoteEntriesGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final QuoteCancelDecoder parent;
        private int remainder;
        private QuoteEntriesGroupDecoder current;

        public QuoteEntriesGroupIterator(final QuoteCancelDecoder parent)
        {
            this.parent = parent;
        }
