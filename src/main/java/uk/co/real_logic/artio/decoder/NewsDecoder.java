...
import uk.co.real_logic.artio.builder.NewsEncoder;
import static uk.co.real_logic.artio.builder.NewsEncoder.RoutingIDsGroupEncoder;
import static uk.co.real_logic.artio.builder.NewsEncoder.RelatedSymGroupEncoder;
...
import static uk.co.real_logic.artio.builder.NewsEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.NewsEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.NewsEncoder.LinesOfTextGroupEncoder;

@Generated("uk.co.real_logic.artio")
public class NewsDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    public boolean validate()
    {
        ...
        if (hasUrgency)
        {
        if (CODEC_VALIDATION_ENABLED && urgencyLength > 1)
        {
            invalidTagId = 61;
            rejectReason = 5;
            return false;
    ...
    private int urgencyLength = 0;
    public int urgencyLength()    {
       return urgencyLength;
    }
 ...
 return Urgency.NULL_VAL;
    ...
    /* Headline = 148 */
    public AsciiSequenceView headline(final AsciiSequenceView view)
    {
        return view.wrap(buffer, headlineOffset, headlineLength);
    }
...
public class RoutingIDsGroupDecoder extends CommonDecoderImpl
{
 ...
 return RoutingType.NULL_VAL;
    ...
    public NewsEncoder.RoutingIDsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewsEncoder.RoutingIDsGroupEncoder)encoder);
    }

    public NewsEncoder.RoutingIDsGroupEncoder toEncoder(final NewsEncoder.RoutingIDsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasRoutingType())
        {
    ...
    {
        private final NewsDecoder parent;
        private int remainder;
        private RoutingIDsGroupDecoder current;

        public RoutingIDsGroupIterator(final NewsDecoder parent)
        {
            this.parent = parent;
        }
...
public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder
{
 ...
 return PutOrCall.NULL_VAL;
    ...
    public NewsEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewsEncoder.RelatedSymGroupEncoder)encoder);
    }

    public NewsEncoder.RelatedSymGroupEncoder toEncoder(final NewsEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class RelatedSymGroupIterator implements Iterable<RelatedSymGroupDecoder>, java.util.Iterator<RelatedSymGroupDecoder>
    {
        ...
        public RelatedSymGroupIterator(final NewsDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public NewsEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewsEncoder.LegsGroupEncoder)encoder);
    }

    public NewsEncoder.LegsGroupEncoder toEncoder(final NewsEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final NewsDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public NewsEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewsEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public NewsEncoder.UnderlyingsGroupEncoder toEncoder(final NewsEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final NewsDecoder parent)
        {
            this.parent = parent;
        }
...
public class LinesOfTextGroupDecoder extends CommonDecoderImpl
{
    ...
    public NewsEncoder.LinesOfTextGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewsEncoder.LinesOfTextGroupEncoder)encoder);
    }

    public NewsEncoder.LinesOfTextGroupEncoder toEncoder(final NewsEncoder.LinesOfTextGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LinesOfTextGroupIterator implements Iterable<LinesOfTextGroupDecoder>, java.util.Iterator<LinesOfTextGroupDecoder>
    {
        ...
        public LinesOfTextGroupIterator(final NewsDecoder parent)
        {
            this.parent = parent;
        }
