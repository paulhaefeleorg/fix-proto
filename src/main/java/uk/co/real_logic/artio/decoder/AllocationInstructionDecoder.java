...
import uk.co.real_logic.artio.builder.AllocationInstructionEncoder;
import static uk.co.real_logic.artio.builder.AllocationInstructionEncoder.OrdersGroupEncoder;
...
import static uk.co.real_logic.artio.builder.AllocationInstructionEncoder.ExecsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.AllocationInstructionEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.AllocationInstructionEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.AllocationInstructionEncoder.AllocsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.AllocationInstructionEncoder.AllocsGroupEncoder.MiscFeesGroupEncoder;
...
public class OrdersGroupDecoder extends CommonDecoderImpl implements NestedParties2Decoder
{
    ...
    public AllocationInstructionEncoder.OrdersGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocationInstructionEncoder.OrdersGroupEncoder)encoder);
    }

    public AllocationInstructionEncoder.OrdersGroupEncoder toEncoder(final AllocationInstructionEncoder.OrdersGroupEncoder encoder)
    {
        encoder.reset();
        if (hasClOrdID())
        {
...
public class ExecsGroupDecoder extends CommonDecoderImpl
{
 ...
 return LastCapacity.NULL_VAL;
    ...
    public AllocationInstructionEncoder.ExecsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocationInstructionEncoder.ExecsGroupEncoder)encoder);
    }

    public AllocationInstructionEncoder.ExecsGroupEncoder toEncoder(final AllocationInstructionEncoder.ExecsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasLastQty())
        {
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public AllocationInstructionEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocationInstructionEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public AllocationInstructionEncoder.UnderlyingsGroupEncoder toEncoder(final AllocationInstructionEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public AllocationInstructionEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocationInstructionEncoder.LegsGroupEncoder)encoder);
    }

    public AllocationInstructionEncoder.LegsGroupEncoder toEncoder(final AllocationInstructionEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
...
public class AllocsGroupDecoder extends CommonDecoderImpl implements NestedPartiesDecoder, CommissionDataDecoder, SettlInstructionsDataDecoder
{
    ...
    public boolean validate()
    {
        ...
        if (hasSettlInstMode)
        {
        if (CODEC_VALIDATION_ENABLED && settlInstModeLength > 1)
        {
            invalidTagId = 160;
            rejectReason = 5;
            return false;
 ...
 return SettlCurrFxRateCalc.NULL_VAL;
    ...
    private int settlInstModeLength = 0;
    public int settlInstModeLength()    {
       return settlInstModeLength;
    }
...
public class MiscFeesGroupDecoder extends CommonDecoderImpl
{
 ...
 return StandInstDbType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.SETTL_INST_MODE:
                ...
                settlInstModeLength = valueLength;
                break;
    ...
    public AllocationInstructionEncoder.AllocsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocationInstructionEncoder.AllocsGroupEncoder)encoder);
    }

    public AllocationInstructionEncoder.AllocsGroupEncoder toEncoder(final AllocationInstructionEncoder.AllocsGroupEncoder encoder)
    {
        encoder.reset();
