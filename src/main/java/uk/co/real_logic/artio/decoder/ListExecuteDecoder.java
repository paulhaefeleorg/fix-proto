...
import uk.co.real_logic.artio.builder.ListExecuteEncoder;

@Generated("uk.co.real_logic.artio")
public class ListExecuteDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    public static final long MESSAGE_TYPE = 76L;
    ...
    public ListExecuteEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((ListExecuteEncoder)encoder);
    }

    public ListExecuteEncoder toEncoder(final ListExecuteEncoder encoder)
    {
        encoder.reset();
