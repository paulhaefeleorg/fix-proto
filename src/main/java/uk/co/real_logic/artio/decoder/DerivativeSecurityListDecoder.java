...
import uk.co.real_logic.artio.builder.DerivativeSecurityListEncoder;
...
import static uk.co.real_logic.artio.builder.DerivativeSecurityListEncoder.RelatedSymGroupEncoder;
...
import static uk.co.real_logic.artio.builder.DerivativeSecurityListEncoder.RelatedSymGroupEncoder.LegsGroupEncoder;
...
public class DerivativeSecurityListDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder, MessageDecoder
{
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(100);
    ...
    public static final long MESSAGE_TYPE = 16705L;

    public static final String MESSAGE_TYPE_AS_STRING = "AA";
...
@Generated("uk.co.real_logic.artio")
public class RelatedSymGroupDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrumentExtensionDecoder
{
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public DerivativeSecurityListEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((DerivativeSecurityListEncoder.RelatedSymGroupEncoder)encoder);
    }

    public DerivativeSecurityListEncoder.RelatedSymGroupEncoder toEncoder(final DerivativeSecurityListEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final DerivativeSecurityListDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final DerivativeSecurityListDecoder parent)
        {
            this.parent = parent;
        }
    ...
    public DerivativeSecurityListEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((DerivativeSecurityListEncoder)encoder);
    }

    public DerivativeSecurityListEncoder toEncoder(final DerivativeSecurityListEncoder encoder)
    {
        encoder.reset();
