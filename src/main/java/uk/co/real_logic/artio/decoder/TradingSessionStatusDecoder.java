...
public class TradingSessionStatusDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    /* TradSesReqID = 335 */
    public AsciiSequenceView tradSesReqID(final AsciiSequenceView view)
    {
        if (!hasTradSesReqID)
        {
            throw new IllegalArgumentException("No value for optional field: TradSesReqID");
        ...
        return view.wrap(buffer, tradSesReqIDOffset, tradSesReqIDLength);
    }
 ...
 return TradSesStatusRejReason.NULL_VAL;
    ...
    /* TradSesStartTime = 341 */
    public AsciiSequenceView tradSesStartTime(final AsciiSequenceView view)
    {
        if (!hasTradSesStartTime)
        {
            throw new IllegalArgumentException("No value for optional field: TradSesStartTime");
        ...
        return view.wrap(buffer, tradSesStartTimeOffset, tradSesStartTimeLength);
    }
    ...
    /* TradSesOpenTime = 342 */
    public AsciiSequenceView tradSesOpenTime(final AsciiSequenceView view)
    {
        if (!hasTradSesOpenTime)
        {
            throw new IllegalArgumentException("No value for optional field: TradSesOpenTime");
        ...
        return view.wrap(buffer, tradSesOpenTimeOffset, tradSesOpenTimeLength);
    }
    ...
    /* TradSesPreCloseTime = 343 */
    public AsciiSequenceView tradSesPreCloseTime(final AsciiSequenceView view)
    {
        if (!hasTradSesPreCloseTime)
        {
            throw new IllegalArgumentException("No value for optional field: TradSesPreCloseTime");
        ...
        return view.wrap(buffer, tradSesPreCloseTimeOffset, tradSesPreCloseTimeLength);
    }
    ...
    /* TradSesCloseTime = 344 */
    public AsciiSequenceView tradSesCloseTime(final AsciiSequenceView view)
    {
        if (!hasTradSesCloseTime)
        {
            throw new IllegalArgumentException("No value for optional field: TradSesCloseTime");
        ...
        return view.wrap(buffer, tradSesCloseTimeOffset, tradSesCloseTimeLength);
    }
    ...
    /* TradSesEndTime = 345 */
    public AsciiSequenceView tradSesEndTime(final AsciiSequenceView view)
    {
        if (!hasTradSesEndTime)
        {
            throw new IllegalArgumentException("No value for optional field: TradSesEndTime");
        ...
        return view.wrap(buffer, tradSesEndTimeOffset, tradSesEndTimeLength);
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.TOTAL_VOLUME_TRADED:
                ...
                totalVolumeTraded = getFloat(buffer, totalVolumeTraded, valueOffset, valueLength, 387, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
