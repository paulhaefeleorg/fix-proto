...
import uk.co.real_logic.artio.builder.CollateralInquiryAckEncoder;
import static uk.co.real_logic.artio.builder.CollateralInquiryAckEncoder.CollInquiryQualifierGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralInquiryAckEncoder.ExecsGroupEncoder;
import static uk.co.real_logic.artio.builder.CollateralInquiryAckEncoder.TradesGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralInquiryAckEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralInquiryAckEncoder.UnderlyingsGroupEncoder;
...
public class CollateralInquiryAckDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, MessageDecoder
{
...

    {
        ...
        {
            REQUIRED_FIELDS.add(Constants.COLL_INQUIRY_ID);
            REQUIRED_FIELDS.add(Constants.COLL_INQUIRY_STATUS);
        }
    }
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.COLL_INQUIRY_STATUS);
            GROUP_FIELDS.add(Constants.COLL_INQUIRY_RESULT);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !CollInquiryStatus.isValid(collInquiryStatus()))
        {
            invalidTagId = 945;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !CollInquiryResult.isValid(collInquiryResult()))
        {
            invalidTagId = 946;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 18242L;

    public static final String MESSAGE_TYPE_AS_STRING = "BG";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(444);

    {
        ...
        messageFields.add(Constants.COLL_INQUIRY_STATUS);
        messageFields.add(Constants.COLL_INQUIRY_RESULT);
    ...
    {
        return new String(collInquiryID, 0, collInquiryIDLength);
    }
    ...
    private int collInquiryStatus = MISSING_INT;
    ...
    private final CharArrayWrapper collInquiryStatusWrapper = new CharArrayWrapper();
    /* CollInquiryStatus = 945 */
    public CollInquiryStatus collInquiryStatusAsEnum()
    {
        return CollInquiryStatus.decode(collInquiryStatus);
    }

    private int collInquiryResult = MISSING_INT;
    ...
    public int collInquiryResult()
    {
        if (!hasCollInquiryResult)
        {
            throw new IllegalArgumentException("No value for optional field: CollInquiryResult");
        }
    ...
    private final CharArrayWrapper collInquiryResultWrapper = new CharArrayWrapper();
    /* CollInquiryResult = 946 */
    public CollInquiryResult collInquiryResultAsEnum()
    {
        if (!hasCollInquiryResult)
 return CollInquiryResult.NULL_VAL;
        return CollInquiryResult.decode(collInquiryResult);
    }
...
public class CollInquiryQualifierGroupDecoder extends CommonDecoderImpl
{
 ...
 return CollInquiryQualifier.NULL_VAL;
    ...
    public CollateralInquiryAckEncoder.CollInquiryQualifierGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralInquiryAckEncoder.CollInquiryQualifierGroupEncoder)encoder);
    }

    public CollateralInquiryAckEncoder.CollInquiryQualifierGroupEncoder toEncoder(final CollateralInquiryAckEncoder.CollInquiryQualifierGroupEncoder encoder)
    {
        encoder.reset();
        if (hasCollInquiryQualifier())
        {
    ...
    {
        private final CollateralInquiryAckDecoder parent;
        private int remainder;
        private CollInquiryQualifierGroupDecoder current;

        public CollInquiryQualifierGroupIterator(final CollateralInquiryAckDecoder parent)
        {
            this.parent = parent;
        }
...
public class ExecsGroupDecoder extends CommonDecoderImpl
{
    ...
    public CollateralInquiryAckEncoder.ExecsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralInquiryAckEncoder.ExecsGroupEncoder)encoder);
    }

    public CollateralInquiryAckEncoder.ExecsGroupEncoder toEncoder(final CollateralInquiryAckEncoder.ExecsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasExecID())
        {
    ...
    public class ExecsGroupIterator implements Iterable<ExecsGroupDecoder>, java.util.Iterator<ExecsGroupDecoder>
    {
        ...
        public ExecsGroupIterator(final CollateralInquiryAckDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradesGroupDecoder extends CommonDecoderImpl
{
    ...
    public CollateralInquiryAckEncoder.TradesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralInquiryAckEncoder.TradesGroupEncoder)encoder);
    }

    public CollateralInquiryAckEncoder.TradesGroupEncoder toEncoder(final CollateralInquiryAckEncoder.TradesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradeReportID())
        {
    ...
    public class TradesGroupIterator implements Iterable<TradesGroupDecoder>, java.util.Iterator<TradesGroupDecoder>
    {
        ...
        public TradesGroupIterator(final CollateralInquiryAckDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public CollateralInquiryAckEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralInquiryAckEncoder.LegsGroupEncoder)encoder);
    }

    public CollateralInquiryAckEncoder.LegsGroupEncoder toEncoder(final CollateralInquiryAckEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final CollateralInquiryAckDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public CollateralInquiryAckEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralInquiryAckEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public CollateralInquiryAckEncoder.UnderlyingsGroupEncoder toEncoder(final CollateralInquiryAckEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final CollateralInquiryAckDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return ResponseTransportType.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.COLL_INQUIRY_STATUS:
                collInquiryStatus = getInt(buffer, valueOffset, endOfField, 945, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.COLL_INQUIRY_RESULT:
                hasCollInquiryResult = true;
                collInquiryResult = getInt(buffer, valueOffset, endOfField, 946, CODEC_VALIDATION_ENABLED);
                break;
    ...
    public CollateralInquiryAckEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralInquiryAckEncoder)encoder);
    }

    public CollateralInquiryAckEncoder toEncoder(final CollateralInquiryAckEncoder encoder)
    {
        encoder.reset();
