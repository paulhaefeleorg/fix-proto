...
import uk.co.real_logic.artio.builder.CollateralResponseEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralResponseEncoder.ExecsGroupEncoder;
import static uk.co.real_logic.artio.builder.CollateralResponseEncoder.TradesGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralResponseEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralResponseEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.CollateralResponseEncoder.MiscFeesGroupEncoder;
...
public class CollateralResponseDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, TrdRegTimestampsDecoder, SpreadOrBenchmarkCurveDataDecoder, StipulationsDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(178);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(178);
    ...
    public final IntHashSet messageFields = new IntHashSet(496);
    ...
    /* CollRespID = 904 */
    public AsciiSequenceView collRespID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, collRespIDOffset, collRespIDLength);
    }
...
public class ExecsGroupDecoder extends CommonDecoderImpl
{
    ...
    public CollateralResponseEncoder.ExecsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralResponseEncoder.ExecsGroupEncoder)encoder);
    }

    public CollateralResponseEncoder.ExecsGroupEncoder toEncoder(final CollateralResponseEncoder.ExecsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasExecID())
        {
    ...
    {
        private final CollateralResponseDecoder parent;
        private int remainder;
        private ExecsGroupDecoder current;

        public ExecsGroupIterator(final CollateralResponseDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradesGroupDecoder extends CommonDecoderImpl
{
    ...
    public CollateralResponseEncoder.TradesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralResponseEncoder.TradesGroupEncoder)encoder);
    }

    public CollateralResponseEncoder.TradesGroupEncoder toEncoder(final CollateralResponseEncoder.TradesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradeReportID())
        {
    ...
    public class TradesGroupIterator implements Iterable<TradesGroupDecoder>, java.util.Iterator<TradesGroupDecoder>
    {
        ...
        public TradesGroupIterator(final CollateralResponseDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public CollateralResponseEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralResponseEncoder.LegsGroupEncoder)encoder);
    }

    public CollateralResponseEncoder.LegsGroupEncoder toEncoder(final CollateralResponseEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final CollateralResponseDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return CollAction.NULL_VAL;
    ...
    public CollateralResponseEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralResponseEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public CollateralResponseEncoder.UnderlyingsGroupEncoder toEncoder(final CollateralResponseEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final CollateralResponseDecoder parent)
        {
            this.parent = parent;
        }
...
public class MiscFeesGroupDecoder extends CommonDecoderImpl
{
 ...
 return MiscFeeBasis.NULL_VAL;
    ...
    public CollateralResponseEncoder.MiscFeesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((CollateralResponseEncoder.MiscFeesGroupEncoder)encoder);
    }

    public CollateralResponseEncoder.MiscFeesGroupEncoder toEncoder(final CollateralResponseEncoder.MiscFeesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasMiscFeeAmt())
        {
    ...
    public class MiscFeesGroupIterator implements Iterable<MiscFeesGroupDecoder>, java.util.Iterator<MiscFeesGroupDecoder>
    {
        ...
        public MiscFeesGroupIterator(final CollateralResponseDecoder parent)
        {
            this.parent = parent;
        }
