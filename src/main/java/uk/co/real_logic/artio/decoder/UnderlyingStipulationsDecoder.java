...
public class UnderlyingStipsGroupDecoder extends CommonDecoderImpl
{
    ...
    /* UnderlyingStipType = 888 */
    public AsciiSequenceView underlyingStipType(final AsciiSequenceView view)
    {
        if (!hasUnderlyingStipType)
        {
            throw new IllegalArgumentException("No value for optional field: UnderlyingStipType");
        ...
        return view.wrap(buffer, underlyingStipTypeOffset, underlyingStipTypeLength);
    }
    ...
    /* UnderlyingStipValue = 889 */
    public AsciiSequenceView underlyingStipValue(final AsciiSequenceView view)
    {
        if (!hasUnderlyingStipValue)
        {
            throw new IllegalArgumentException("No value for optional field: UnderlyingStipValue");
        ...
        return view.wrap(buffer, underlyingStipValueOffset, underlyingStipValueLength);
    }
