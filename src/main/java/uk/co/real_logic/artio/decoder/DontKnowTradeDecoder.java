...
import uk.co.real_logic.artio.builder.DontKnowTradeEncoder;
...
import static uk.co.real_logic.artio.builder.DontKnowTradeEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.DontKnowTradeEncoder.LegsGroupEncoder;
...
public class DontKnowTradeDecoder extends CommonDecoderImpl implements InstrumentDecoder, OrderQtyDataDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.D_K_REASON);
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            GROUP_FIELDS.add(Constants.D_K_REASON);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !DKReason.isValid(dKReason()))
        {
            invalidTagId = 127;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_VALIDATION_ENABLED && dKReasonLength > 1)
        {
            invalidTagId = 127;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 81L;

    public static final String MESSAGE_TYPE_AS_STRING = "Q";
...

    {
        ...
        messageFields.add(Constants.D_K_REASON);
    ...
    private char dKReason = MISSING_CHAR;

    private int dKReasonLength = 0;
    public int dKReasonLength()    {
       return dKReasonLength;
    }
    /* DKReason = 127 */
    ...
    private final CharArrayWrapper dKReasonWrapper = new CharArrayWrapper();
    /* DKReason = 127 */
    public DKReason dKReasonAsEnum()
    {
        return DKReason.decode(dKReason);
    }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public DontKnowTradeEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((DontKnowTradeEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public DontKnowTradeEncoder.UnderlyingsGroupEncoder toEncoder(final DontKnowTradeEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final DontKnowTradeDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final DontKnowTradeDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public DontKnowTradeEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((DontKnowTradeEncoder.LegsGroupEncoder)encoder);
    }

    public DontKnowTradeEncoder.LegsGroupEncoder toEncoder(final DontKnowTradeEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final DontKnowTradeDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return RoundingDirection.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.D_K_REASON:
                dKReason = buffer.getChar(valueOffset);
                dKReasonLength = valueLength;
                break;
    ...
    public DontKnowTradeEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((DontKnowTradeEncoder)encoder);
    }

    public DontKnowTradeEncoder toEncoder(final DontKnowTradeEncoder encoder)
    {
        encoder.reset();
