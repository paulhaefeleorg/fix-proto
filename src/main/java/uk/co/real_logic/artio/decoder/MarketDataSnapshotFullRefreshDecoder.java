...
import uk.co.real_logic.artio.builder.MarketDataSnapshotFullRefreshEncoder;
...
import static uk.co.real_logic.artio.builder.MarketDataSnapshotFullRefreshEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MarketDataSnapshotFullRefreshEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.MarketDataSnapshotFullRefreshEncoder.MDEntriesGroupEncoder;

@Generated("uk.co.real_logic.artio")
public class MarketDataSnapshotFullRefreshDecoder extends CommonDecoderImpl implements InstrumentDecoder, MessageDecoder
{
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(94);
    ...
    public static final long MESSAGE_TYPE = 87L;
    ...
    public final IntHashSet messageFields = new IntHashSet(430);
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public MarketDataSnapshotFullRefreshEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MarketDataSnapshotFullRefreshEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public MarketDataSnapshotFullRefreshEncoder.UnderlyingsGroupEncoder toEncoder(final MarketDataSnapshotFullRefreshEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final MarketDataSnapshotFullRefreshDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final MarketDataSnapshotFullRefreshDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public MarketDataSnapshotFullRefreshEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MarketDataSnapshotFullRefreshEncoder.LegsGroupEncoder)encoder);
    }

    public MarketDataSnapshotFullRefreshEncoder.LegsGroupEncoder toEncoder(final MarketDataSnapshotFullRefreshEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final MarketDataSnapshotFullRefreshDecoder parent)
        {
            this.parent = parent;
        }
...
@Generated("uk.co.real_logic.artio")
public class MDEntriesGroupDecoder extends CommonDecoderImpl
{
    ...
    public final IntHashSet ALL_GROUP_FIELDS = new IntHashSet(66);
 ...
 return TimeInForce.NULL_VAL;
    ...
    public MarketDataSnapshotFullRefreshEncoder.MDEntriesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MarketDataSnapshotFullRefreshEncoder.MDEntriesGroupEncoder)encoder);
    }

    public MarketDataSnapshotFullRefreshEncoder.MDEntriesGroupEncoder toEncoder(final MarketDataSnapshotFullRefreshEncoder.MDEntriesGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class MDEntriesGroupIterator implements Iterable<MDEntriesGroupDecoder>, java.util.Iterator<MDEntriesGroupDecoder>
    {
        ...
        public MDEntriesGroupIterator(final MarketDataSnapshotFullRefreshDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return ApplQueueResolution.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        // Decode MarketDataSnapshotFullRefresh
        int seenFieldCount = 0;
        if (CODEC_VALIDATION_ENABLED)
        {
            missingRequiredFields.copy(REQUIRED_FIELDS);
    ...
    public MarketDataSnapshotFullRefreshEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((MarketDataSnapshotFullRefreshEncoder)encoder);
    }

    public MarketDataSnapshotFullRefreshEncoder toEncoder(final MarketDataSnapshotFullRefreshEncoder encoder)
    {
        encoder.reset();
        if (hasMDReqID())
        {
