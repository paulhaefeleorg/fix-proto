...
import uk.co.real_logic.artio.builder.AllocationInstructionAckEncoder;
...
import static uk.co.real_logic.artio.builder.AllocationInstructionAckEncoder.AllocsGroupEncoder;

@Generated("uk.co.real_logic.artio")
public class AllocationInstructionAckDecoder extends CommonDecoderImpl implements PartiesDecoder, MessageDecoder
{
...
public class AllocsGroupDecoder extends CommonDecoderImpl
{
    ...
    public AllocationInstructionAckEncoder.AllocsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((AllocationInstructionAckEncoder.AllocsGroupEncoder)encoder);
    }

    public AllocationInstructionAckEncoder.AllocsGroupEncoder toEncoder(final AllocationInstructionAckEncoder.AllocsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasAllocAccount())
        {
    ...
    {
        private final AllocationInstructionAckDecoder parent;
        private int remainder;
        private AllocsGroupDecoder current;

        public AllocsGroupIterator(final AllocationInstructionAckDecoder parent)
        {
            this.parent = parent;
        }
