...
import uk.co.real_logic.artio.builder.SecurityStatusEncoder;
...
import static uk.co.real_logic.artio.builder.SecurityStatusEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.SecurityStatusEncoder.LegsGroupEncoder;
...
public class SecurityStatusDecoder extends CommonDecoderImpl implements InstrumentDecoder, InstrumentExtensionDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(128);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            GROUP_FIELDS.add(Constants.SECURITY_STATUS_REQ_ID);
            ...
            GROUP_FIELDS.add(Constants.IN_VIEW_OF_COMMON);
            GROUP_FIELDS.add(Constants.DUE_TO_RELATED);
            GROUP_FIELDS.add(Constants.BUY_VOLUME);
            GROUP_FIELDS.add(Constants.SELL_VOLUME);
            ...
            GROUP_FIELDS.add(Constants.ADJUSTMENT);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(128);
    ...
    public boolean validate()
    {
        ...
        if (hasAdjustment)
        {
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !Adjustment.isValid(adjustment()))
        {
            invalidTagId = 334;
            rejectReason = 5;
            return false;
        ...
        if (hasHaltReason)
        {
        if (CODEC_VALIDATION_ENABLED && haltReasonLength > 1)
        {
            invalidTagId = 327;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_VALIDATION_ENABLED && inViewOfCommonLength > 1)
        {
            invalidTagId = 328;
            rejectReason = 5;
            return false;
        ...
        if (hasDueToRelated)
        {
        if (CODEC_VALIDATION_ENABLED && dueToRelatedLength > 1)
        {
            invalidTagId = 329;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 102L;
...

    {
        ...
        messageFields.add(Constants.SECURITY_STATUS_REQ_ID);
        ...
        messageFields.add(Constants.IN_VIEW_OF_COMMON);
        messageFields.add(Constants.DUE_TO_RELATED);
        messageFields.add(Constants.BUY_VOLUME);
        messageFields.add(Constants.SELL_VOLUME);
        ...
        messageFields.add(Constants.ADJUSTMENT);
    ...
    private char[] securityStatusReqID = new char[1];

    private boolean hasSecurityStatusReqID;

    /* SecurityStatusReqID = 324 */
    public char[] securityStatusReqID()
    {
        if (!hasSecurityStatusReqID)
        {
            throw new IllegalArgumentException("No value for optional field: SecurityStatusReqID");
        }
    ...
    {
        return hasSecurityStatusReqID;
    }


    private int securityStatusReqIDOffset;

    private int securityStatusReqIDLength;

    /* SecurityStatusReqID = 324 */
    public int securityStatusReqIDLength()
    {
        if (!hasSecurityStatusReqID)
        {
            throw new IllegalArgumentException("No value for optional field: SecurityStatusReqID");
        ...
        return securityStatusReqIDLength;
    }

    /* SecurityStatusReqID = 324 */
    public String securityStatusReqIDAsString()
    {
        return hasSecurityStatusReqID ? new String(securityStatusReqID, 0, securityStatusReqIDLength) : null;
    }

    /* SecurityStatusReqID = 324 */
    public AsciiSequenceView securityStatusReqID(final AsciiSequenceView view)
    {
        if (!hasSecurityStatusReqID)
        {
            throw new IllegalArgumentException("No value for optional field: SecurityStatusReqID");
        ...
        return view.wrap(buffer, securityStatusReqIDOffset, securityStatusReqIDLength);
    }


    private final CharArrayWrapper securityStatusReqIDWrapper = new CharArrayWrapper();
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public SecurityStatusEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityStatusEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public SecurityStatusEncoder.UnderlyingsGroupEncoder toEncoder(final SecurityStatusEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final SecurityStatusDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final SecurityStatusDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public SecurityStatusEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityStatusEncoder.LegsGroupEncoder)encoder);
    }

    public SecurityStatusEncoder.LegsGroupEncoder toEncoder(final SecurityStatusEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final SecurityStatusDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return SecurityTradingStatus.NULL_VAL;
    ...
    private char haltReason = MISSING_CHAR;

    private int haltReasonLength = 0;
    public int haltReasonLength()    {
       return haltReasonLength;
    }
 ...
 return HaltReason.NULL_VAL;
    ...
    private int inViewOfCommonLength = 0;
    public int inViewOfCommonLength()    {
       return inViewOfCommonLength;
    }
    ...
    public boolean inViewOfCommon()
    {
        if (!hasInViewOfCommon)
        {
            throw new IllegalArgumentException("No value for optional field: InViewOfCommon");
        }
    ...
    private int dueToRelatedLength = 0;
    public int dueToRelatedLength()    {
       return dueToRelatedLength;
    }
    ...
    public boolean dueToRelated()
    {
        if (!hasDueToRelated)
        {
            throw new IllegalArgumentException("No value for optional field: DueToRelated");
        }
    ...
    private DecimalFloat buyVolume = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat buyVolume()
    {
        if (!hasBuyVolume)
        {
            throw new IllegalArgumentException("No value for optional field: BuyVolume");
        }
    ...
    private DecimalFloat sellVolume = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat sellVolume()
    {
        if (!hasSellVolume)
        {
            throw new IllegalArgumentException("No value for optional field: SellVolume");
        }
    ...
    private int adjustment = MISSING_INT;
    ...
    public int adjustment()
    {
        if (!hasAdjustment)
        {
            throw new IllegalArgumentException("No value for optional field: Adjustment");
        }
    ...
    private final CharArrayWrapper adjustmentWrapper = new CharArrayWrapper();
    /* Adjustment = 334 */
    public Adjustment adjustmentAsEnum()
    {
        if (!hasAdjustment)
 return Adjustment.NULL_VAL;
        return Adjustment.decode(adjustment);
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            switch (tag)
            {
            case Constants.SECURITY_STATUS_REQ_ID:
                hasSecurityStatusReqID = true;
                securityStatusReqID = buffer.getChars(securityStatusReqID, valueOffset, valueLength);
                securityStatusReqIDOffset = valueOffset;
                securityStatusReqIDLength = valueLength;
                break;
            ...
            case Constants.HALT_REASON:
                hasHaltReason = true;
                haltReason = buffer.getChar(valueOffset);
                haltReasonLength = valueLength;
                break;

            case Constants.IN_VIEW_OF_COMMON:
                hasInViewOfCommon = true;
                inViewOfCommon = buffer.getBoolean(valueOffset);
                inViewOfCommonLength = valueLength;
                break;

            case Constants.DUE_TO_RELATED:
                hasDueToRelated = true;
                dueToRelated = buffer.getBoolean(valueOffset);
                dueToRelatedLength = valueLength;
                break;

            case Constants.BUY_VOLUME:
                hasBuyVolume = true;
                buyVolume = getFloat(buffer, buyVolume, valueOffset, valueLength, 330, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.SELL_VOLUME:
                hasSellVolume = true;
                sellVolume = getFloat(buffer, sellVolume, valueOffset, valueLength, 331, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.HIGH_PX:
                hasHighPx = true;
                highPx = getFloat(buffer, highPx, valueOffset, valueLength, 332, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.LOW_PX:
                hasLowPx = true;
                lowPx = getFloat(buffer, lowPx, valueOffset, valueLength, 333, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.ADJUSTMENT:
                hasAdjustment = true;
                adjustment = getInt(buffer, valueOffset, endOfField, 334, CODEC_VALIDATION_ENABLED);
                break;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasSecurityStatusReqID())
        {
            ...
            builder.append(this.securityStatusReqID(), 0, securityStatusReqIDLength());
            builder.append("\",\n");
        }
    ...
    public SecurityStatusEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((SecurityStatusEncoder)encoder);
    }

    public SecurityStatusEncoder toEncoder(final SecurityStatusEncoder encoder)
    {
        encoder.reset();
        if (hasSecurityStatusReqID())
        {
            encoder.securityStatusReqID(this.securityStatusReqID(), 0, securityStatusReqIDLength());
        }
