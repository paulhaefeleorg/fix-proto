...
import uk.co.real_logic.artio.builder.OrderMassCancelRequestEncoder;
...
public class OrderMassCancelRequestDecoder extends CommonDecoderImpl implements InstrumentDecoder, UnderlyingInstrumentDecoder, MessageDecoder
{
    ...
    public static final long MESSAGE_TYPE = 113L;
    ...
    public final IntHashSet messageFields = new IntHashSet(278);
 ...
 return Side.NULL_VAL;
    ...
    public OrderMassCancelRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((OrderMassCancelRequestEncoder)encoder);
    }

    public OrderMassCancelRequestEncoder toEncoder(final OrderMassCancelRequestEncoder encoder)
    {
        encoder.reset();
