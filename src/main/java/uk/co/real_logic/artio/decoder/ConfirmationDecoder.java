...
import uk.co.real_logic.artio.builder.ConfirmationEncoder;
...
import static uk.co.real_logic.artio.builder.ConfirmationEncoder.OrdersGroupEncoder;
...
import static uk.co.real_logic.artio.builder.ConfirmationEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.ConfirmationEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.ConfirmationEncoder.CapacitiesGroupEncoder;
...
import static uk.co.real_logic.artio.builder.ConfirmationEncoder.MiscFeesGroupEncoder;

@Generated("uk.co.real_logic.artio")
public class ConfirmationDecoder extends CommonDecoderImpl implements PartiesDecoder, TrdRegTimestampsDecoder, InstrumentDecoder, InstrumentExtensionDecoder, FinancingDetailsDecoder, YieldDataDecoder, SpreadOrBenchmarkCurveDataDecoder, SettlInstructionsDataDecoder, CommissionDataDecoder, StipulationsDecoder, MessageDecoder
{
    public final IntHashSet REQUIRED_FIELDS = new IntHashSet(32);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            REQUIRED_FIELDS.add(Constants.CONFIRM_ID);
            REQUIRED_FIELDS.add(Constants.CONFIRM_TRANS_TYPE);
            REQUIRED_FIELDS.add(Constants.CONFIRM_TYPE);
            REQUIRED_FIELDS.add(Constants.CONFIRM_STATUS);
            REQUIRED_FIELDS.add(Constants.TRANSACT_TIME);
            REQUIRED_FIELDS.add(Constants.TRADE_DATE);
            REQUIRED_FIELDS.add(Constants.SYMBOL);
            REQUIRED_FIELDS.add(Constants.NO_UNDERLYINGS_GROUP_COUNTER);
            ...
            REQUIRED_FIELDS.add(Constants.NO_CAPACITIES_GROUP_COUNTER);
            REQUIRED_FIELDS.add(Constants.ALLOC_ACCOUNT);
            REQUIRED_FIELDS.add(Constants.AVG_PX);
            REQUIRED_FIELDS.add(Constants.GROSS_TRADE_AMT);
            REQUIRED_FIELDS.add(Constants.NET_MONEY);
        }
    }

    public final IntHashSet GROUP_FIELDS = new IntHashSet(248);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            GROUP_FIELDS.add(Constants.CONFIRM_ID);
            GROUP_FIELDS.add(Constants.CONFIRM_REF_ID);
            GROUP_FIELDS.add(Constants.CONFIRM_REQ_ID);
            GROUP_FIELDS.add(Constants.CONFIRM_TRANS_TYPE);
            ...
            GROUP_FIELDS.add(Constants.CONFIRM_STATUS);
            ...
            GROUP_FIELDS.add(Constants.REPORTED_PX);
            ...
            GROUP_FIELDS.add(Constants.MATURITY_NET_MONEY);
            ...
            GROUP_FIELDS.add(Constants.SHARED_COMMISSION);
        }
    }

    private final IntHashSet alreadyVisitedFields = new IntHashSet(248);

    private final IntHashSet unknownFields = new IntHashSet(10);

    private final IntHashSet missingRequiredFields = new IntHashSet(32);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !ConfirmTransType.isValid(confirmTransType()))
        {
            invalidTagId = 666;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !ConfirmStatus.isValid(confirmStatus()))
        {
            invalidTagId = 665;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_VALIDATION_ENABLED && copyMsgIndicatorLength > 1)
        {
            invalidTagId = 797;
            rejectReason = 5;
            return false;
        ...
        {
            int count = 0;
            final CapacitiesGroupIterator iterator = capacitiesGroupIterator.iterator();
            for (final CapacitiesGroupDecoder group : iterator)
            {
                count++;                if (!group.validate())
                {
                    invalidTagId = group.invalidTagId();
    ...
    public static final long MESSAGE_TYPE = 19265L;

    public static final String MESSAGE_TYPE_AS_STRING = "AK";
...

    {
        ...
        messageFields.add(Constants.CONFIRM_REF_ID);
        messageFields.add(Constants.CONFIRM_REQ_ID);
        messageFields.add(Constants.CONFIRM_TRANS_TYPE);
        ...
        messageFields.add(Constants.CONFIRM_STATUS);
        ...
        messageFields.add(Constants.NO_CAPACITIES_GROUP_COUNTER);
        messageFields.add(Constants.ORDER_CAPACITY);
        messageFields.add(Constants.ORDER_RESTRICTIONS);
        messageFields.add(Constants.ORDER_CAPACITY_QTY);
        ...
        messageFields.add(Constants.REPORTED_PX);
        ...
        messageFields.add(Constants.MATURITY_NET_MONEY);
        ...
        messageFields.add(Constants.SHARED_COMMISSION);
    ...
    /* ConfirmID = 664 */
    public AsciiSequenceView confirmID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, confirmIDOffset, confirmIDLength);
    }


    private final CharArrayWrapper confirmIDWrapper = new CharArrayWrapper();
    private char[] confirmRefID = new char[1];

    private boolean hasConfirmRefID;

    /* ConfirmRefID = 772 */
    public char[] confirmRefID()
    {
        if (!hasConfirmRefID)
        {
            throw new IllegalArgumentException("No value for optional field: ConfirmRefID");
        }
    ...
    {
        return hasConfirmRefID;
    }


    private int confirmRefIDOffset;

    private int confirmRefIDLength;

    /* ConfirmRefID = 772 */
    public int confirmRefIDLength()
    {
        if (!hasConfirmRefID)
        {
            throw new IllegalArgumentException("No value for optional field: ConfirmRefID");
        ...
        return confirmRefIDLength;
    }

    /* ConfirmRefID = 772 */
    public String confirmRefIDAsString()
    {
        return hasConfirmRefID ? new String(confirmRefID, 0, confirmRefIDLength) : null;
    }

    /* ConfirmRefID = 772 */
    public AsciiSequenceView confirmRefID(final AsciiSequenceView view)
    {
        if (!hasConfirmRefID)
        {
            throw new IllegalArgumentException("No value for optional field: ConfirmRefID");
        ...
        return view.wrap(buffer, confirmRefIDOffset, confirmRefIDLength);
    }


    private final CharArrayWrapper confirmRefIDWrapper = new CharArrayWrapper();
    private char[] confirmReqID = new char[1];

    private boolean hasConfirmReqID;
    ...
    public char[] confirmReqID()
    {
        if (!hasConfirmReqID)
        {
            throw new IllegalArgumentException("No value for optional field: ConfirmReqID");
        }
    ...
    {
        return hasConfirmReqID ? new String(confirmReqID, 0, confirmReqIDLength) : null;
    }

    /* ConfirmReqID = 859 */
    public AsciiSequenceView confirmReqID(final AsciiSequenceView view)
    {
        if (!hasConfirmReqID)
        {
            throw new IllegalArgumentException("No value for optional field: ConfirmReqID");
        ...
        return view.wrap(buffer, confirmReqIDOffset, confirmReqIDLength);
    }


    private final CharArrayWrapper confirmReqIDWrapper = new CharArrayWrapper();
    private int confirmTransType = MISSING_INT;
    ...
    private final CharArrayWrapper confirmTransTypeWrapper = new CharArrayWrapper();
    /* ConfirmTransType = 666 */
    public ConfirmTransType confirmTransTypeAsEnum()
    {
        return ConfirmTransType.decode(confirmTransType);
    }
    ...
    private int copyMsgIndicatorLength = 0;
    public int copyMsgIndicatorLength()    {
       return copyMsgIndicatorLength;
    }
    ...
    private int confirmStatus = MISSING_INT;
    ...
    private final CharArrayWrapper confirmStatusWrapper = new CharArrayWrapper();
    /* ConfirmStatus = 665 */
    public ConfirmStatus confirmStatusAsEnum()
    {
        return ConfirmStatus.decode(confirmStatus);
    }
...
public class OrdersGroupDecoder extends CommonDecoderImpl implements NestedParties2Decoder
{
    ...
    public ConfirmationEncoder.OrdersGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((ConfirmationEncoder.OrdersGroupEncoder)encoder);
    }

    public ConfirmationEncoder.OrdersGroupEncoder toEncoder(final ConfirmationEncoder.OrdersGroupEncoder encoder)
    {
        encoder.reset();
        if (hasClOrdID())
        {
    ...
    {
        private final ConfirmationDecoder parent;
        private int remainder;
        private OrdersGroupDecoder current;

        public OrdersGroupIterator(final ConfirmationDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public ConfirmationEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((ConfirmationEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public ConfirmationEncoder.UnderlyingsGroupEncoder toEncoder(final ConfirmationEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final ConfirmationDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public ConfirmationEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((ConfirmationEncoder.LegsGroupEncoder)encoder);
    }

    public ConfirmationEncoder.LegsGroupEncoder toEncoder(final ConfirmationEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final ConfirmationDecoder parent)
        {
            this.parent = parent;
        }
...
public class CapacitiesGroupDecoder extends CommonDecoderImpl
{
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.ORDER_CAPACITY_QTY:
                orderCapacityQty = getFloat(buffer, orderCapacityQty, valueOffset, valueLength, 863, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    public ConfirmationEncoder.CapacitiesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((ConfirmationEncoder.CapacitiesGroupEncoder)encoder);
    }

    public ConfirmationEncoder.CapacitiesGroupEncoder toEncoder(final ConfirmationEncoder.CapacitiesGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class CapacitiesGroupIterator implements Iterable<CapacitiesGroupDecoder>, java.util.Iterator<CapacitiesGroupDecoder>
    {
        ...
        public CapacitiesGroupIterator(final ConfirmationDecoder parent)
        {
            this.parent = parent;
        }
    ...
    private CapacitiesGroupDecoder capacitiesGroup = null;
    public CapacitiesGroupDecoder capacitiesGroup()
    {
        return capacitiesGroup;
    }

    private int noCapacitiesGroupCounter = MISSING_INT;
    ...
    public int noCapacitiesGroupCounter()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: NoCapacitiesGroupCounter");
        }
    ...
    private CapacitiesGroupIterator capacitiesGroupIterator = new CapacitiesGroupIterator(this);
    public CapacitiesGroupIterator capacitiesGroupIterator()
    {
        return capacitiesGroupIterator.iterator();
    }
 ...
 return BenchmarkSecurityIDSource.NULL_VAL;
    ...
    private DecimalFloat reportedPx = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat reportedPx()
    {
        if (!hasReportedPx)
        {
            throw new IllegalArgumentException("No value for optional field: ReportedPx");
        }
 ...
 return ProcessCode.NULL_VAL;
    ...
    private DecimalFloat maturityNetMoney = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat maturityNetMoney()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: MaturityNetMoney");
        }
 ...
 return FundRenewWaiv.NULL_VAL;
    ...
    private DecimalFloat sharedCommission = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat sharedCommission()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: SharedCommission");
        }
...
public class MiscFeesGroupDecoder extends CommonDecoderImpl
{
 ...
 return MiscFeeBasis.NULL_VAL;
    ...
    public ConfirmationEncoder.MiscFeesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((ConfirmationEncoder.MiscFeesGroupEncoder)encoder);
    }

    public ConfirmationEncoder.MiscFeesGroupEncoder toEncoder(final ConfirmationEncoder.MiscFeesGroupEncoder encoder)
    {
        encoder.reset();
        if (hasMiscFeeAmt())
        {
    ...
    public class MiscFeesGroupIterator implements Iterable<MiscFeesGroupDecoder>, java.util.Iterator<MiscFeesGroupDecoder>
    {
        ...
        public MiscFeesGroupIterator(final ConfirmationDecoder parent)
        {
            this.parent = parent;
        }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.CONFIRM_REF_ID:
                hasConfirmRefID = true;
                confirmRefID = buffer.getChars(confirmRefID, valueOffset, valueLength);
                confirmRefIDOffset = valueOffset;
                confirmRefIDLength = valueLength;
                break;

            case Constants.CONFIRM_REQ_ID:
                hasConfirmReqID = true;
            ...
            case Constants.CONFIRM_TRANS_TYPE:
                confirmTransType = getInt(buffer, valueOffset, endOfField, 666, CODEC_VALIDATION_ENABLED);
                break;
            ...
            case Constants.COPY_MSG_INDICATOR:
                ...
                copyMsgIndicatorLength = valueLength;
                break;
            ...
            case Constants.CONFIRM_STATUS:
                confirmStatus = getInt(buffer, valueOffset, endOfField, 665, CODEC_VALIDATION_ENABLED);
                break;
            ...
            case Constants.NO_CAPACITIES_GROUP_COUNTER:
                hasNoCapacitiesGroupCounter = true;
                noCapacitiesGroupCounter = getInt(buffer, valueOffset, endOfField, 862, CODEC_VALIDATION_ENABLED);
                if (capacitiesGroup == null)
                {
                    capacitiesGroup = new CapacitiesGroupDecoder(trailer, messageFields);
                }
                CapacitiesGroupDecoder capacitiesGroupCurrent = capacitiesGroup;
                position = endOfField + 1;
                final int noCapacitiesGroupCounter = this.noCapacitiesGroupCounter;
                for (int i = 0; i < noCapacitiesGroupCounter && position < end; i++)
                {
                    if (capacitiesGroupCurrent != null)
                    {
                        positionIter = capacitiesGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                        ...
                        capacitiesGroupCurrent = capacitiesGroupCurrent.next();
                    }
                }
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    {
                        final int checkTag = buffer.getInt(position, checkEqualsPosition);
                        if (capacitiesGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (capacitiesGroupCurrent != null) 
                            {
                               position += capacitiesGroupCurrent.decode(buffer, position, end - position);
                               capacitiesGroupCurrent = capacitiesGroupCurrent.next();
                            }
                            return position - offset;
                        }
            ...
            case Constants.REPORTED_PX:
                hasReportedPx = true;
                reportedPx = getFloat(buffer, reportedPx, valueOffset, valueLength, 861, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.MATURITY_NET_MONEY:
                hasMaturityNetMoney = true;
                maturityNetMoney = getFloat(buffer, maturityNetMoney, valueOffset, valueLength, 890, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.SHARED_COMMISSION:
                hasSharedCommission = true;
                sharedCommission = getFloat(buffer, sharedCommission, valueOffset, valueLength, 858, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    {
        hasConfirmRefID = false;
    }

    public void resetConfirmReqID()
    {
        hasConfirmReqID = false;
    }

    public void resetConfirmTransType()
    {
        confirmTransType = MISSING_INT;
    }
    ...
    {
        for (final CapacitiesGroupDecoder capacitiesGroupDecoder : capacitiesGroupIterator.iterator())
        {
            capacitiesGroupDecoder.reset();
            if (capacitiesGroupDecoder.next() == null)
            {
                break;
            }
        }
        noCapacitiesGroupCounter = MISSING_INT;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasConfirmRefID())
        {
            ...
            builder.append(this.confirmRefID(), 0, confirmRefIDLength());
            builder.append("\",\n");
        }
        ...
        if (hasNoCapacitiesGroupCounter)
        {
            ...
            CapacitiesGroupDecoder capacitiesGroup = this.capacitiesGroup;
            for (int i = 0, size = this.noCapacitiesGroupCounter; i < size; i++)
            {
                indent(builder, level);
                capacitiesGroup.appendTo(builder, level + 1);
                if (capacitiesGroup.next() != null)
                {
                    builder.append(',');
                }
                builder.append('\n');
    ...
    public ConfirmationEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((ConfirmationEncoder)encoder);
    }

    public ConfirmationEncoder toEncoder(final ConfirmationEncoder encoder)
    {
        encoder.reset();
        encoder.confirmID(this.confirmID(), 0, confirmIDLength());
        if (hasConfirmRefID())
        {
            encoder.confirmRefID(this.confirmRefID(), 0, confirmRefIDLength());
        }
        ...
        if (hasNoCapacitiesGroupCounter)
        {
            ...
            for (int i = 0; i < size; i++)
            {
                if (capacitiesGroup != null)
                {
                    capacitiesGroup.toEncoder(capacitiesGroupEncoder);
                    capacitiesGroup = capacitiesGroup.next();
