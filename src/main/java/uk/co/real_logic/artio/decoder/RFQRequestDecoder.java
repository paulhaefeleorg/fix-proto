...
import uk.co.real_logic.artio.builder.RFQRequestEncoder;
import static uk.co.real_logic.artio.builder.RFQRequestEncoder.RelatedSymGroupEncoder;
...
import static uk.co.real_logic.artio.builder.RFQRequestEncoder.RelatedSymGroupEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.RFQRequestEncoder.RelatedSymGroupEncoder.LegsGroupEncoder;
...
public class RFQRequestDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    public final IntHashSet messageFields = new IntHashSet(366);
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
 ...
 return QuoteType.NULL_VAL;
    ...
    public RFQRequestEncoder.RelatedSymGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RFQRequestEncoder.RelatedSymGroupEncoder)encoder);
    }

    public RFQRequestEncoder.RelatedSymGroupEncoder toEncoder(final RFQRequestEncoder.RelatedSymGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final RFQRequestDecoder parent;
        private int remainder;
        private RelatedSymGroupDecoder current;

        public RelatedSymGroupIterator(final RFQRequestDecoder parent)
        {
            this.parent = parent;
        }
