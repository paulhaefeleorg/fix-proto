...
import uk.co.real_logic.artio.builder.QuoteStatusReportEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteStatusReportEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteStatusReportEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.QuoteStatusReportEncoder.QuoteQualifiersGroupEncoder;
...
public class QuoteStatusReportDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, FinancingDetailsDecoder, OrderQtyDataDecoder, StipulationsDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            GROUP_FIELDS.add(Constants.QUOTE_STATUS_REQ_ID);
    ...
    public static final long MESSAGE_TYPE = 18753L;

    public static final String MESSAGE_TYPE_AS_STRING = "AI";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(560);

    {
        ...
        messageFields.add(Constants.QUOTE_STATUS_REQ_ID);
    ...
    private char[] quoteStatusReqID = new char[1];

    private boolean hasQuoteStatusReqID;

    /* QuoteStatusReqID = 649 */
    public char[] quoteStatusReqID()
    {
        if (!hasQuoteStatusReqID)
        {
            throw new IllegalArgumentException("No value for optional field: QuoteStatusReqID");
        }
    ...
    {
        return hasQuoteStatusReqID;
    }


    private int quoteStatusReqIDOffset;

    private int quoteStatusReqIDLength;

    /* QuoteStatusReqID = 649 */
    public int quoteStatusReqIDLength()
    {
        if (!hasQuoteStatusReqID)
        {
            throw new IllegalArgumentException("No value for optional field: QuoteStatusReqID");
        ...
        return quoteStatusReqIDLength;
    }

    /* QuoteStatusReqID = 649 */
    public String quoteStatusReqIDAsString()
    {
        return hasQuoteStatusReqID ? new String(quoteStatusReqID, 0, quoteStatusReqIDLength) : null;
    }

    /* QuoteStatusReqID = 649 */
    public AsciiSequenceView quoteStatusReqID(final AsciiSequenceView view)
    {
        if (!hasQuoteStatusReqID)
        {
            throw new IllegalArgumentException("No value for optional field: QuoteStatusReqID");
        ...
        return view.wrap(buffer, quoteStatusReqIDOffset, quoteStatusReqIDLength);
    }
    ...
    /* QuoteReqID = 131 */
    public AsciiSequenceView quoteReqID(final AsciiSequenceView view)
    {
        if (!hasQuoteReqID)
        {
            throw new IllegalArgumentException("No value for optional field: QuoteReqID");
        ...
        return view.wrap(buffer, quoteReqIDOffset, quoteReqIDLength);
    }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public QuoteStatusReportEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteStatusReportEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public QuoteStatusReportEncoder.UnderlyingsGroupEncoder toEncoder(final QuoteStatusReportEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final QuoteStatusReportDecoder parent;
        private int remainder;
        private UnderlyingsGroupDecoder current;

        public UnderlyingsGroupIterator(final QuoteStatusReportDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder, LegStipulationsDecoder, NestedPartiesDecoder
{
    ...
    private IntHashSet seenFields = new IntHashSet(14);
 ...
 return LegSwapType.NULL_VAL;
    ...
    public QuoteStatusReportEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteStatusReportEncoder.LegsGroupEncoder)encoder);
    }

    public QuoteStatusReportEncoder.LegsGroupEncoder toEncoder(final QuoteStatusReportEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final QuoteStatusReportDecoder parent)
        {
            this.parent = parent;
        }
...
public class QuoteQualifiersGroupDecoder extends CommonDecoderImpl
{
    ...
    public boolean validate()
    {
        ...
        {
        if (CODEC_VALIDATION_ENABLED && quoteQualifierLength > 1)
        {
            invalidTagId = 695;
            rejectReason = 5;
            return false;
    ...
    private int quoteQualifierLength = 0;
    public int quoteQualifierLength()    {
       return quoteQualifierLength;
    }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            case Constants.QUOTE_QUALIFIER:
                ...
                quoteQualifierLength = valueLength;
                break;
    ...
    public QuoteStatusReportEncoder.QuoteQualifiersGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteStatusReportEncoder.QuoteQualifiersGroupEncoder)encoder);
    }

    public QuoteStatusReportEncoder.QuoteQualifiersGroupEncoder toEncoder(final QuoteStatusReportEncoder.QuoteQualifiersGroupEncoder encoder)
    {
        encoder.reset();
        if (hasQuoteQualifier())
        {
    ...
    public class QuoteQualifiersGroupIterator implements Iterable<QuoteQualifiersGroupDecoder>, java.util.Iterator<QuoteQualifiersGroupDecoder>
    {
        ...
        public QuoteQualifiersGroupIterator(final QuoteStatusReportDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return CustOrderCapacity.NULL_VAL;
    ...
    public int quoteStatus()
    {
        if (!hasQuoteStatus)
        {
            throw new IllegalArgumentException("No value for optional field: QuoteStatus");
        }
 ...
 return QuoteStatus.NULL_VAL;
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        ...
        while (position < end)
        {
            ...
            switch (tag)
            {
            case Constants.QUOTE_STATUS_REQ_ID:
                hasQuoteStatusReqID = true;
                quoteStatusReqID = buffer.getChars(quoteStatusReqID, valueOffset, valueLength);
                quoteStatusReqIDOffset = valueOffset;
                quoteStatusReqIDLength = valueLength;
                break;
            ...
            case Constants.NO_QUOTE_QUALIFIERS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noQuoteQualifiersGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = quoteQualifiersGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (quoteQualifiersGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (quoteQualifiersGroupCurrent != null) 
                            {
            ...
            case Constants.BID_PX:
                hasBidPx = true;
                bidPx = getFloat(buffer, bidPx, valueOffset, valueLength, 132, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.OFFER_PX:
                hasOfferPx = true;
                offerPx = getFloat(buffer, offerPx, valueOffset, valueLength, 133, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.MKT_BID_PX:
                hasMktBidPx = true;
                mktBidPx = getFloat(buffer, mktBidPx, valueOffset, valueLength, 645, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.MKT_OFFER_PX:
                hasMktOfferPx = true;
                mktOfferPx = getFloat(buffer, mktOfferPx, valueOffset, valueLength, 646, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.MIN_BID_SIZE:
                hasMinBidSize = true;
                minBidSize = getFloat(buffer, minBidSize, valueOffset, valueLength, 647, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.BID_SIZE:
                hasBidSize = true;
                bidSize = getFloat(buffer, bidSize, valueOffset, valueLength, 134, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.MIN_OFFER_SIZE:
                hasMinOfferSize = true;
                minOfferSize = getFloat(buffer, minOfferSize, valueOffset, valueLength, 648, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.OFFER_SIZE:
                hasOfferSize = true;
                offerSize = getFloat(buffer, offerSize, valueOffset, valueLength, 135, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.BID_SPOT_RATE:
                hasBidSpotRate = true;
                bidSpotRate = getFloat(buffer, bidSpotRate, valueOffset, valueLength, 188, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.OFFER_SPOT_RATE:
                hasOfferSpotRate = true;
                offerSpotRate = getFloat(buffer, offerSpotRate, valueOffset, valueLength, 190, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.BID_FORWARD_POINTS:
                hasBidForwardPoints = true;
                bidForwardPoints = getFloat(buffer, bidForwardPoints, valueOffset, valueLength, 189, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.OFFER_FORWARD_POINTS:
                hasOfferForwardPoints = true;
                offerForwardPoints = getFloat(buffer, offerForwardPoints, valueOffset, valueLength, 191, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.MID_PX:
                hasMidPx = true;
                midPx = getFloat(buffer, midPx, valueOffset, valueLength, 631, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.BID_YIELD:
                hasBidYield = true;
                bidYield = getFloat(buffer, bidYield, valueOffset, valueLength, 632, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.MID_YIELD:
                hasMidYield = true;
                midYield = getFloat(buffer, midYield, valueOffset, valueLength, 633, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.OFFER_YIELD:
                hasOfferYield = true;
                offerYield = getFloat(buffer, offerYield, valueOffset, valueLength, 634, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
            ...
            case Constants.BID_FORWARD_POINTS2:
                ...
                bidForwardPoints2 = getFloat(buffer, bidForwardPoints2, valueOffset, valueLength, 642, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.OFFER_FORWARD_POINTS2:
                hasOfferForwardPoints2 = true;
                offerForwardPoints2 = getFloat(buffer, offerForwardPoints2, valueOffset, valueLength, 643, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.SETTL_CURR_BID_FX_RATE:
                hasSettlCurrBidFxRate = true;
                settlCurrBidFxRate = getFloat(buffer, settlCurrBidFxRate, valueOffset, valueLength, 656, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;

            case Constants.SETTL_CURR_OFFER_FX_RATE:
                hasSettlCurrOfferFxRate = true;
                settlCurrOfferFxRate = getFloat(buffer, settlCurrOfferFxRate, valueOffset, valueLength, 657, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasQuoteStatusReqID())
        {
            ...
            builder.append(this.quoteStatusReqID(), 0, quoteStatusReqIDLength());
            builder.append("\",\n");
        }
    ...
    public QuoteStatusReportEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((QuoteStatusReportEncoder)encoder);
    }

    public QuoteStatusReportEncoder toEncoder(final QuoteStatusReportEncoder encoder)
    {
        encoder.reset();
        if (hasQuoteStatusReqID())
        {
            encoder.quoteStatusReqID(this.quoteStatusReqID(), 0, quoteStatusReqIDLength());
        }
