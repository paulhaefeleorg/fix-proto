...
import uk.co.real_logic.artio.builder.PositionMaintenanceReportEncoder;
...
import static uk.co.real_logic.artio.builder.PositionMaintenanceReportEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.PositionMaintenanceReportEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.PositionMaintenanceReportEncoder.TradingSessionsGroupEncoder;
import uk.co.real_logic.artio.builder.PositionQtyEncoder;
import static uk.co.real_logic.artio.builder.PositionQtyEncoder.PositionsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.PositionAmountDataEncoder.PosAmtGroupEncoder;

@Generated("uk.co.real_logic.artio")
public class PositionMaintenanceReportDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, PositionQtyDecoder, PositionAmountDataDecoder, MessageDecoder
{
    public final IntHashSet REQUIRED_FIELDS = new IntHashSet(24);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            REQUIRED_FIELDS.add(Constants.POS_MAINT_RPT_ID);
            REQUIRED_FIELDS.add(Constants.POS_TRANS_TYPE);
            REQUIRED_FIELDS.add(Constants.POS_MAINT_ACTION);
            REQUIRED_FIELDS.add(Constants.ORIG_POS_REQ_REF_ID);
            REQUIRED_FIELDS.add(Constants.POS_MAINT_STATUS);
            REQUIRED_FIELDS.add(Constants.CLEARING_BUSINESS_DATE);
            REQUIRED_FIELDS.add(Constants.ACCOUNT);
            REQUIRED_FIELDS.add(Constants.ACCOUNT_TYPE);
            REQUIRED_FIELDS.add(Constants.SYMBOL);
            REQUIRED_FIELDS.add(Constants.TRANSACT_TIME);
            REQUIRED_FIELDS.add(Constants.NO_POSITIONS_GROUP_COUNTER);
            REQUIRED_FIELDS.add(Constants.NO_POS_AMT_GROUP_COUNTER);
        }
    }

    public final IntHashSet GROUP_FIELDS = new IntHashSet(122);

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            GROUP_FIELDS.add(Constants.POS_MAINT_RPT_ID);
            GROUP_FIELDS.add(Constants.POS_TRANS_TYPE);
            GROUP_FIELDS.add(Constants.POS_REQ_ID);
            GROUP_FIELDS.add(Constants.POS_MAINT_ACTION);
            GROUP_FIELDS.add(Constants.ORIG_POS_REQ_REF_ID);
            GROUP_FIELDS.add(Constants.POS_MAINT_STATUS);
            GROUP_FIELDS.add(Constants.POS_MAINT_RESULT);
            ...
            GROUP_FIELDS.add(Constants.ADJUSTMENT_TYPE);
            GROUP_FIELDS.add(Constants.THRESHOLD_AMOUNT);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(122);

    private final IntHashSet unknownFields = new IntHashSet(10);

    private final IntHashSet missingRequiredFields = new IntHashSet(24);
    ...
    public boolean validate()
    {
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !PosTransType.isValid(posTransType()))
        {
            invalidTagId = 709;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !PosMaintAction.isValid(posMaintAction()))
        {
            invalidTagId = 712;
            rejectReason = 5;
            return false;
        ...
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !PosMaintStatus.isValid(posMaintStatus()))
        {
            invalidTagId = 722;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !PosMaintResult.isValid(posMaintResult()))
        {
            invalidTagId = 723;
            rejectReason = 5;
            return false;
        ...
        {
        if (CODEC_REJECT_UNKNOWN_ENUM_VALUE_ENABLED && !AdjustmentType.isValid(adjustmentType()))
        {
            invalidTagId = 718;
            rejectReason = 5;
            return false;
    ...
    public static final long MESSAGE_TYPE = 19777L;

    public static final String MESSAGE_TYPE_AS_STRING = "AM";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(440);

    {
        ...
        messageFields.add(Constants.POS_TRANS_TYPE);
        messageFields.add(Constants.POS_REQ_ID);
        messageFields.add(Constants.POS_MAINT_ACTION);
        messageFields.add(Constants.ORIG_POS_REQ_REF_ID);
        messageFields.add(Constants.POS_MAINT_STATUS);
        messageFields.add(Constants.POS_MAINT_RESULT);
        ...
        messageFields.add(Constants.ADJUSTMENT_TYPE);
        messageFields.add(Constants.THRESHOLD_AMOUNT);
    ...
    /* PosMaintRptID = 721 */
    public AsciiSequenceView posMaintRptID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, posMaintRptIDOffset, posMaintRptIDLength);
    }


    private final CharArrayWrapper posMaintRptIDWrapper = new CharArrayWrapper();
    private int posTransType = MISSING_INT;
    ...
    private final CharArrayWrapper posTransTypeWrapper = new CharArrayWrapper();
    /* PosTransType = 709 */
    public PosTransType posTransTypeAsEnum()
    {
        return PosTransType.decode(posTransType);
    }

    private char[] posReqID = new char[1];

    private boolean hasPosReqID;

    /* PosReqID = 710 */
    public char[] posReqID()
    {
        if (!hasPosReqID)
        {
            throw new IllegalArgumentException("No value for optional field: PosReqID");
        }
    ...
    private int posReqIDOffset;

    private int posReqIDLength;

    /* PosReqID = 710 */
    public int posReqIDLength()
    {
        if (!hasPosReqID)
        {
            throw new IllegalArgumentException("No value for optional field: PosReqID");
        ...
        return posReqIDLength;
    }

    /* PosReqID = 710 */
    public String posReqIDAsString()
    {
        return hasPosReqID ? new String(posReqID, 0, posReqIDLength) : null;
    }

    /* PosReqID = 710 */
    public AsciiSequenceView posReqID(final AsciiSequenceView view)
    {
        if (!hasPosReqID)
        {
            throw new IllegalArgumentException("No value for optional field: PosReqID");
        ...
        return view.wrap(buffer, posReqIDOffset, posReqIDLength);
    }


    private final CharArrayWrapper posReqIDWrapper = new CharArrayWrapper();
    private int posMaintAction = MISSING_INT;
    ...
    private final CharArrayWrapper posMaintActionWrapper = new CharArrayWrapper();
    /* PosMaintAction = 712 */
    public PosMaintAction posMaintActionAsEnum()
    {
        return PosMaintAction.decode(posMaintAction);
    }

    private char[] origPosReqRefID = new char[1];

    /* OrigPosReqRefID = 713 */
    public char[] origPosReqRefID()
    {
        return origPosReqRefID;
    }


    private int origPosReqRefIDOffset;

    private int origPosReqRefIDLength;

    /* OrigPosReqRefID = 713 */
    public int origPosReqRefIDLength()
    {
        return origPosReqRefIDLength;
    }

    /* OrigPosReqRefID = 713 */
    public String origPosReqRefIDAsString()
    {
        return new String(origPosReqRefID, 0, origPosReqRefIDLength);
    }

    /* OrigPosReqRefID = 713 */
    public AsciiSequenceView origPosReqRefID(final AsciiSequenceView view)
    {
        return view.wrap(buffer, origPosReqRefIDOffset, origPosReqRefIDLength);
    }


    private final CharArrayWrapper origPosReqRefIDWrapper = new CharArrayWrapper();
    private int posMaintStatus = MISSING_INT;
    ...
    private final CharArrayWrapper posMaintStatusWrapper = new CharArrayWrapper();
    /* PosMaintStatus = 722 */
    public PosMaintStatus posMaintStatusAsEnum()
    {
        return PosMaintStatus.decode(posMaintStatus);
    }

    private int posMaintResult = MISSING_INT;
    ...
    public int posMaintResult()
    {
        if (!hasPosMaintResult)
        {
            throw new IllegalArgumentException("No value for optional field: PosMaintResult");
        }
    ...
    private final CharArrayWrapper posMaintResultWrapper = new CharArrayWrapper();
    /* PosMaintResult = 723 */
    public PosMaintResult posMaintResultAsEnum()
    {
        if (!hasPosMaintResult)
 return PosMaintResult.NULL_VAL;
        return PosMaintResult.decode(posMaintResult);
    }
    ...
    /* SettlSessID = 716 */
    public AsciiSequenceView settlSessID(final AsciiSequenceView view)
    {
        if (!hasSettlSessID)
        {
            throw new IllegalArgumentException("No value for optional field: SettlSessID");
        ...
        return view.wrap(buffer, settlSessIDOffset, settlSessIDLength);
    }
    ...
    /* SettlSessSubID = 717 */
    public AsciiSequenceView settlSessSubID(final AsciiSequenceView view)
    {
        if (!hasSettlSessSubID)
        {
            throw new IllegalArgumentException("No value for optional field: SettlSessSubID");
        ...
        return view.wrap(buffer, settlSessSubIDOffset, settlSessSubIDLength);
    }
    ...
    {
        return new String(account, 0, accountLength);
    }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public PositionMaintenanceReportEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((PositionMaintenanceReportEncoder.LegsGroupEncoder)encoder);
    }

    public PositionMaintenanceReportEncoder.LegsGroupEncoder toEncoder(final PositionMaintenanceReportEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final PositionMaintenanceReportDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final PositionMaintenanceReportDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public PositionMaintenanceReportEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((PositionMaintenanceReportEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public PositionMaintenanceReportEncoder.UnderlyingsGroupEncoder toEncoder(final PositionMaintenanceReportEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final PositionMaintenanceReportDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradingSessionsGroupDecoder extends CommonDecoderImpl
{
    ...
    public PositionMaintenanceReportEncoder.TradingSessionsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((PositionMaintenanceReportEncoder.TradingSessionsGroupEncoder)encoder);
    }

    public PositionMaintenanceReportEncoder.TradingSessionsGroupEncoder toEncoder(final PositionMaintenanceReportEncoder.TradingSessionsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradingSessionID())
        {
    ...
    public class TradingSessionsGroupIterator implements Iterable<TradingSessionsGroupDecoder>, java.util.Iterator<TradingSessionsGroupDecoder>
    {
        ...
        public TradingSessionsGroupIterator(final PositionMaintenanceReportDecoder parent)
        {
            this.parent = parent;
        }
    ...
    private int adjustmentType = MISSING_INT;
    ...
    public int adjustmentType()
    {
        if (!hasAdjustmentType)
        {
            throw new IllegalArgumentException("No value for optional field: AdjustmentType");
        }
    ...
    private final CharArrayWrapper adjustmentTypeWrapper = new CharArrayWrapper();
    /* AdjustmentType = 718 */
    public AdjustmentType adjustmentTypeAsEnum()
    {
        if (!hasAdjustmentType)
 return AdjustmentType.NULL_VAL;
        return AdjustmentType.decode(adjustmentType);
    }

    private DecimalFloat thresholdAmount = DecimalFloat.newNaNValue();
    ...
    public DecimalFloat thresholdAmount()
    {
        ...
        {
            throw new IllegalArgumentException("No value for optional field: ThresholdAmount");
        }
    ...
    public int decode(final AsciiBuffer buffer, final int offset, final int length)
    {
        // Decode PositionMaintenanceReport
        int seenFieldCount = 0;
        if (CODEC_VALIDATION_ENABLED)
        {
            missingRequiredFields.copy(REQUIRED_FIELDS);
        ...
        while (position < end)
        {
            ...
            case Constants.POS_TRANS_TYPE:
                posTransType = getInt(buffer, valueOffset, endOfField, 709, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.POS_REQ_ID:
                hasPosReqID = true;
                posReqID = buffer.getChars(posReqID, valueOffset, valueLength);
                posReqIDOffset = valueOffset;
                posReqIDLength = valueLength;
                break;

            case Constants.POS_MAINT_ACTION:
                posMaintAction = getInt(buffer, valueOffset, endOfField, 712, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.ORIG_POS_REQ_REF_ID:
                origPosReqRefID = buffer.getChars(origPosReqRefID, valueOffset, valueLength);
                origPosReqRefIDOffset = valueOffset;
                origPosReqRefIDLength = valueLength;
                break;

            case Constants.POS_MAINT_STATUS:
                posMaintStatus = getInt(buffer, valueOffset, endOfField, 722, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.POS_MAINT_RESULT:
                hasPosMaintResult = true;
                posMaintResult = getInt(buffer, valueOffset, endOfField, 723, CODEC_VALIDATION_ENABLED);
                break;
            ...
            case Constants.NO_TRADING_SESSIONS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noTradingSessionsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = tradingSessionsGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (tradingSessionsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (tradingSessionsGroupCurrent != null) 
                            {
            ...
            case Constants.NO_POSITIONS_GROUP_COUNTER:
                ...
                for (int i = 0; i < noPositionsGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = positionsGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
                ...
                if (CODEC_VALIDATION_ENABLED)
                {
                    ...
                    if (checkEqualsPosition != AsciiBuffer.UNKNOWN_INDEX)
                    {
                        ...
                        if (positionsGroup.ALL_GROUP_FIELDS.contains(checkTag))
                        {
                            invalidTagId = tag;
                            rejectReason = 16;
                            while (positionsGroupCurrent != null) 
                            {
            ...
            case Constants.NO_POS_AMT_GROUP_COUNTER:
                ...
                for (int i = 0; i < noPosAmtGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = posAmtGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
            ...
            case Constants.ADJUSTMENT_TYPE:
                hasAdjustmentType = true;
                adjustmentType = getInt(buffer, valueOffset, endOfField, 718, CODEC_VALIDATION_ENABLED);
                break;

            case Constants.THRESHOLD_AMOUNT:
                hasThresholdAmount = true;
                thresholdAmount = getFloat(buffer, thresholdAmount, valueOffset, valueLength, 834, CODEC_VALIDATION_ENABLED, decimalFloatOverflowHandler);
                break;
    ...
    public StringBuilder appendTo(final StringBuilder builder, final int level)
    {
        ...
        if (hasPosReqID())
        {
            ...
            builder.append(this.posReqID(), 0, posReqIDLength());
            builder.append("\",\n");
        }
        ...
        builder.append(this.origPosReqRefID(), 0, origPosReqRefIDLength());
        builder.append("\",\n");
    ...
    public PositionMaintenanceReportEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((PositionMaintenanceReportEncoder)encoder);
    }

    public PositionMaintenanceReportEncoder toEncoder(final PositionMaintenanceReportEncoder encoder)
    {
        encoder.reset();
        ...
        if (hasPosReqID())
        {
            encoder.posReqID(this.posReqID(), 0, posReqIDLength());
        }

        encoder.posMaintAction(this.posMaintAction());
        encoder.origPosReqRefID(this.origPosReqRefID(), 0, origPosReqRefIDLength());
