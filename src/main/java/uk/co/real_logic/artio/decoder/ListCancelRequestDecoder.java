...
import uk.co.real_logic.artio.builder.ListCancelRequestEncoder;

@Generated("uk.co.real_logic.artio")
public class ListCancelRequestDecoder extends CommonDecoderImpl implements MessageDecoder
{
    ...
    public static final long MESSAGE_TYPE = 75L;
    ...
    public ListCancelRequestEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((ListCancelRequestEncoder)encoder);
    }

    public ListCancelRequestEncoder toEncoder(final ListCancelRequestEncoder encoder)
    {
        encoder.reset();
