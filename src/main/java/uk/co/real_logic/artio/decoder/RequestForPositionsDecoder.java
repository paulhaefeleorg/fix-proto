...
import uk.co.real_logic.artio.builder.RequestForPositionsEncoder;
...
import static uk.co.real_logic.artio.builder.RequestForPositionsEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.RequestForPositionsEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.RequestForPositionsEncoder.TradingSessionsGroupEncoder;

@Generated("uk.co.real_logic.artio")
public class RequestForPositionsDecoder extends CommonDecoderImpl implements PartiesDecoder, InstrumentDecoder, MessageDecoder
{
...

    {
        if (CODEC_VALIDATION_ENABLED)
        {
            ...
            REQUIRED_FIELDS.add(Constants.POS_REQ_TYPE);
    ...
    public static final long MESSAGE_TYPE = 20033L;

    public static final String MESSAGE_TYPE_AS_STRING = "AN";

    public static final char[] MESSAGE_TYPE_CHARS = MESSAGE_TYPE_AS_STRING.toCharArray();

    public static final byte[] MESSAGE_TYPE_BYTES = MESSAGE_TYPE_AS_STRING.getBytes(US_ASCII);

    public final IntHashSet messageFields = new IntHashSet(404);
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public RequestForPositionsEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RequestForPositionsEncoder.LegsGroupEncoder)encoder);
    }

    public RequestForPositionsEncoder.LegsGroupEncoder toEncoder(final RequestForPositionsEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final RequestForPositionsDecoder parent;
        private int remainder;
        private LegsGroupDecoder current;

        public LegsGroupIterator(final RequestForPositionsDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public RequestForPositionsEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RequestForPositionsEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public RequestForPositionsEncoder.UnderlyingsGroupEncoder toEncoder(final RequestForPositionsEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final RequestForPositionsDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradingSessionsGroupDecoder extends CommonDecoderImpl
{
    ...
    public RequestForPositionsEncoder.TradingSessionsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RequestForPositionsEncoder.TradingSessionsGroupEncoder)encoder);
    }

    public RequestForPositionsEncoder.TradingSessionsGroupEncoder toEncoder(final RequestForPositionsEncoder.TradingSessionsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradingSessionID())
        {
    ...
    public class TradingSessionsGroupIterator implements Iterable<TradingSessionsGroupDecoder>, java.util.Iterator<TradingSessionsGroupDecoder>
    {
        ...
        public TradingSessionsGroupIterator(final RequestForPositionsDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return ResponseTransportType.NULL_VAL;
    ...
    public RequestForPositionsEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((RequestForPositionsEncoder)encoder);
    }

    public RequestForPositionsEncoder toEncoder(final RequestForPositionsEncoder encoder)
    {
        encoder.reset();
