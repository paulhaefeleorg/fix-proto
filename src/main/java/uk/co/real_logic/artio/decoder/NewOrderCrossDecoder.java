...
import uk.co.real_logic.artio.builder.NewOrderCrossEncoder;
import static uk.co.real_logic.artio.builder.NewOrderCrossEncoder.SidesGroupEncoder;
...
import static uk.co.real_logic.artio.builder.NewOrderCrossEncoder.SidesGroupEncoder.AllocsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.NewOrderCrossEncoder.UnderlyingsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.NewOrderCrossEncoder.LegsGroupEncoder;
...
import static uk.co.real_logic.artio.builder.NewOrderCrossEncoder.TradingSessionsGroupEncoder;
...
public class NewOrderCrossDecoder extends CommonDecoderImpl implements InstrumentDecoder, StipulationsDecoder, SpreadOrBenchmarkCurveDataDecoder, YieldDataDecoder, PegInstructionsDecoder, DiscretionInstructionsDecoder, MessageDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(206);
    ...
    private final IntHashSet alreadyVisitedFields = new IntHashSet(206);
    ...
    public static final long MESSAGE_TYPE = 115L;
...
public class SidesGroupDecoder extends CommonDecoderImpl implements PartiesDecoder, OrderQtyDataDecoder, CommissionDataDecoder
{
    ...
    public final IntHashSet GROUP_FIELDS = new IntHashSet(76);
    ...
    private IntHashSet seenFields = new IntHashSet(66);
...
public class AllocsGroupDecoder extends CommonDecoderImpl implements NestedPartiesDecoder
{
 ...
 return ClearingFeeIndicator.NULL_VAL;
    ...
    /* SideComplianceID = 659 */
    public AsciiSequenceView sideComplianceID(final AsciiSequenceView view)
    {
        if (!hasSideComplianceID)
        {
            throw new IllegalArgumentException("No value for optional field: SideComplianceID");
        ...
        return view.wrap(buffer, sideComplianceIDOffset, sideComplianceIDLength);
    }
    ...
    public NewOrderCrossEncoder.SidesGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewOrderCrossEncoder.SidesGroupEncoder)encoder);
    }

    public NewOrderCrossEncoder.SidesGroupEncoder toEncoder(final NewOrderCrossEncoder.SidesGroupEncoder encoder)
    {
        encoder.reset();
    ...
    {
        private final NewOrderCrossDecoder parent;
        private int remainder;
        private SidesGroupDecoder current;

        public SidesGroupIterator(final NewOrderCrossDecoder parent)
        {
            this.parent = parent;
        }
...
public class UnderlyingsGroupDecoder extends CommonDecoderImpl implements UnderlyingInstrumentDecoder
{
 ...
 return UnderlyingPutOrCall.NULL_VAL;
    ...
    public NewOrderCrossEncoder.UnderlyingsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewOrderCrossEncoder.UnderlyingsGroupEncoder)encoder);
    }

    public NewOrderCrossEncoder.UnderlyingsGroupEncoder toEncoder(final NewOrderCrossEncoder.UnderlyingsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class UnderlyingsGroupIterator implements Iterable<UnderlyingsGroupDecoder>, java.util.Iterator<UnderlyingsGroupDecoder>
    {
        ...
        public UnderlyingsGroupIterator(final NewOrderCrossDecoder parent)
        {
            this.parent = parent;
        }
...
public class LegsGroupDecoder extends CommonDecoderImpl implements InstrumentLegDecoder
{
    ...
    public NewOrderCrossEncoder.LegsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewOrderCrossEncoder.LegsGroupEncoder)encoder);
    }

    public NewOrderCrossEncoder.LegsGroupEncoder toEncoder(final NewOrderCrossEncoder.LegsGroupEncoder encoder)
    {
        encoder.reset();
    ...
    public class LegsGroupIterator implements Iterable<LegsGroupDecoder>, java.util.Iterator<LegsGroupDecoder>
    {
        ...
        public LegsGroupIterator(final NewOrderCrossDecoder parent)
        {
            this.parent = parent;
        }
...
public class TradingSessionsGroupDecoder extends CommonDecoderImpl
{
    ...
    public NewOrderCrossEncoder.TradingSessionsGroupEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewOrderCrossEncoder.TradingSessionsGroupEncoder)encoder);
    }

    public NewOrderCrossEncoder.TradingSessionsGroupEncoder toEncoder(final NewOrderCrossEncoder.TradingSessionsGroupEncoder encoder)
    {
        encoder.reset();
        if (hasTradingSessionID())
        {
    ...
    public class TradingSessionsGroupIterator implements Iterable<TradingSessionsGroupDecoder>, java.util.Iterator<TradingSessionsGroupDecoder>
    {
        ...
        public TradingSessionsGroupIterator(final NewOrderCrossDecoder parent)
        {
            this.parent = parent;
        }
 ...
 return MoneyLaunderingStatus.NULL_VAL;
        ...
        while (position < end)
        {
            ...
            case Constants.NO_SIDES_GROUP_COUNTER:
                ...
                for (int i = 0; i < noSidesGroupCounter && position < end; i++)
                {
                    ...
                    {
                        positionIter = sidesGroupCurrent.decode(buffer, position, end - position);
                        if (positionIter == 0 && CODEC_VALIDATION_ENABLED)
                        {
                                invalidTagId = tag;
                                rejectReason = 16;
    ...
    public NewOrderCrossEncoder toEncoder(final Encoder encoder)
    {
        return toEncoder((NewOrderCrossEncoder)encoder);
    }

    public NewOrderCrossEncoder toEncoder(final NewOrderCrossEncoder encoder)
    {
        encoder.reset();
