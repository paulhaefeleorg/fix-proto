...
public class LegStipulationsGroupDecoder extends CommonDecoderImpl
{
    ...
    /* LegStipulationType = 688 */
    public AsciiSequenceView legStipulationType(final AsciiSequenceView view)
    {
        if (!hasLegStipulationType)
        {
            throw new IllegalArgumentException("No value for optional field: LegStipulationType");
        ...
        return view.wrap(buffer, legStipulationTypeOffset, legStipulationTypeLength);
    }
    ...
    /* LegStipulationValue = 689 */
    public AsciiSequenceView legStipulationValue(final AsciiSequenceView view)
    {
        if (!hasLegStipulationValue)
        {
            throw new IllegalArgumentException("No value for optional field: LegStipulationValue");
        ...
        return view.wrap(buffer, legStipulationValueOffset, legStipulationValueLength);
    }
