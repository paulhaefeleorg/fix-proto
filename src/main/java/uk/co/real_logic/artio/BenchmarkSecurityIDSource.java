...
public enum BenchmarkSecurityIDSource implements StringRepresentable
{
    CUSIP("1"),
    SEDOL("2"),
    QUIK("3"),
    ...
    BenchmarkSecurityIDSource(final String representation)
    {
    ...
    private static final CharArrayMap<BenchmarkSecurityIDSource> charMap;
    static
    {
        final Map<String, BenchmarkSecurityIDSource> stringMap = new HashMap<>();
    ...
    public static BenchmarkSecurityIDSource decode(final CharArrayWrapper key)
    {
        final BenchmarkSecurityIDSource value = charMap.get(key);
        if (value == null)
        {
    ...
    public static BenchmarkSecurityIDSource decode(final String representation)
    {
