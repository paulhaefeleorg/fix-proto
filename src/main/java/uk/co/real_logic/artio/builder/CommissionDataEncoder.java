...
public class CommissionDataEncoder
{
    ...
    /* Commission = 12 */
    public CommissionDataEncoder commission(ReadOnlyDecimalFloat value)
    {
    ...
    private byte[] commCurrencyInternalBuffer = commCurrency.byteArray();
    ...
    {
        if (copyInto(commCurrency, value, offset, length))
        {
            commCurrencyInternalBuffer = commCurrency.byteArray();
        }
    ...
    {
        if (toBytes(value, commCurrency, offset, length))
        {
            commCurrencyInternalBuffer = commCurrency.byteArray();
        }
        commCurrencyOffset = 0;
    ...
    public void resetCommCurrency()
    {
        ...
        commCurrency.wrap(commCurrencyInternalBuffer);
    }
