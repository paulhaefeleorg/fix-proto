...
public class UserResponseEncoder implements Encoder
{
    ...
    private byte[] userStatusTextInternalBuffer = userStatusText.byteArray();
    ...
    {
        if (copyInto(userStatusText, value, offset, length))
        {
            userStatusTextInternalBuffer = userStatusText.byteArray();
        }
    ...
    {
        if (toBytes(value, userStatusText))
        {
            userStatusTextInternalBuffer = userStatusText.byteArray();
        }
        userStatusTextOffset = 0;
    ...
    {
        if (toBytes(value, userStatusText, offset, length))
        {
            userStatusTextInternalBuffer = userStatusText.byteArray();
        }
        userStatusTextOffset = 0;
    ...
    public void resetUserStatusText()
    {
        ...
        userStatusText.wrap(userStatusTextInternalBuffer);
    }
