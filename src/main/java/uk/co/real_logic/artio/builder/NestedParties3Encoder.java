...
public static class Nested3PartyIDsGroupEncoder
{
    ...
    private byte[] nested3PartyIDInternalBuffer = nested3PartyID.byteArray();
    ...
    {
        if (copyInto(nested3PartyID, value, offset, length))
        {
            nested3PartyIDInternalBuffer = nested3PartyID.byteArray();
        }
    ...
    {
        if (toBytes(value, nested3PartyID))
        {
            nested3PartyIDInternalBuffer = nested3PartyID.byteArray();
        }
        nested3PartyIDOffset = 0;
    ...
    {
        if (toBytes(value, nested3PartyID, offset, length))
        {
            nested3PartyIDInternalBuffer = nested3PartyID.byteArray();
        }
        nested3PartyIDOffset = 0;
...
public static class Nested3PartySubIDsGroupEncoder
{
    ...
    private byte[] nested3PartySubIDInternalBuffer = nested3PartySubID.byteArray();
    ...
    {
        if (copyInto(nested3PartySubID, value, offset, length))
        {
            nested3PartySubIDInternalBuffer = nested3PartySubID.byteArray();
        }
    ...
    {
        if (toBytes(value, nested3PartySubID))
        {
            nested3PartySubIDInternalBuffer = nested3PartySubID.byteArray();
        }
        nested3PartySubIDOffset = 0;
    ...
    {
        if (toBytes(value, nested3PartySubID, offset, length))
        {
            nested3PartySubIDInternalBuffer = nested3PartySubID.byteArray();
        }
        nested3PartySubIDOffset = 0;
    ...
    public void resetNested3PartySubID()
    {
        ...
        nested3PartySubID.wrap(nested3PartySubIDInternalBuffer);
    }
    ...
    public void resetNested3PartyID()
    {
        ...
        nested3PartyID.wrap(nested3PartyIDInternalBuffer);
    }
