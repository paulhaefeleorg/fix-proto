...
public class RegistrationInstructionsResponseEncoder implements Encoder
{
    ...
    private byte[] registRejReasonTextInternalBuffer = registRejReasonText.byteArray();
    ...
    {
        if (copyInto(registRejReasonText, value, offset, length))
        {
            registRejReasonTextInternalBuffer = registRejReasonText.byteArray();
        }
    ...
    {
        if (toBytes(value, registRejReasonText))
        {
            registRejReasonTextInternalBuffer = registRejReasonText.byteArray();
        }
        registRejReasonTextOffset = 0;
    ...
    {
        if (toBytes(value, registRejReasonText, offset, length))
        {
            registRejReasonTextInternalBuffer = registRejReasonText.byteArray();
        }
        registRejReasonTextOffset = 0;
    ...
    public void resetRegistRejReasonText()
    {
        ...
        registRejReasonText.wrap(registRejReasonTextInternalBuffer);
    }
