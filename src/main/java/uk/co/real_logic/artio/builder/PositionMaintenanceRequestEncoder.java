...
public class PositionMaintenanceRequestEncoder implements Encoder
{
    ...
    private byte[] posMaintRptRefIDInternalBuffer = posMaintRptRefID.byteArray();
    ...
    {
        if (copyInto(posMaintRptRefID, value, offset, length))
        {
            posMaintRptRefIDInternalBuffer = posMaintRptRefID.byteArray();
        }
    ...
    {
        if (toBytes(value, posMaintRptRefID))
        {
            posMaintRptRefIDInternalBuffer = posMaintRptRefID.byteArray();
        }
        posMaintRptRefIDOffset = 0;
    ...
    {
        if (toBytes(value, posMaintRptRefID, offset, length))
        {
            posMaintRptRefIDInternalBuffer = posMaintRptRefID.byteArray();
        }
        posMaintRptRefIDOffset = 0;
...
public static class TradingSessionsGroupEncoder
{
    ...
    public void resetPosMaintRptRefID()
    {
        ...
        posMaintRptRefID.wrap(posMaintRptRefIDInternalBuffer);
    }
