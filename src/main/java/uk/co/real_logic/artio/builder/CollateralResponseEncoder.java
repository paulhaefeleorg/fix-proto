...
public class CollateralResponseEncoder implements Encoder
{
    ...
    private byte[] collRespIDInternalBuffer = collRespID.byteArray();
    ...
    {
        if (copyInto(collRespID, value, offset, length))
        {
            collRespIDInternalBuffer = collRespID.byteArray();
        }
        collRespIDOffset = 0;
        collRespIDLength = length;
        return this;
    ...
    {
        if (toBytes(value, collRespID, offset, length))
        {
            collRespIDInternalBuffer = collRespID.byteArray();
        }
        collRespIDOffset = 0;
...
public static class TradesGroupEncoder
{
    ...
    /* Quantity = 53 */
    public CollateralResponseEncoder quantity(ReadOnlyDecimalFloat value)
    {
        quantity.set(value);
        hasQuantity = true;
        return this;
...
public static class UnderlyingsGroupEncoder
{
    ...
    /* MarginExcess = 899 */
    public CollateralResponseEncoder marginExcess(ReadOnlyDecimalFloat value)
    {
    ...
    /* TotalNetValue = 900 */
    public CollateralResponseEncoder totalNetValue(ReadOnlyDecimalFloat value)
    {
    ...
    /* CashOutstanding = 901 */
    public CollateralResponseEncoder cashOutstanding(ReadOnlyDecimalFloat value)
    {
...
public static class MiscFeesGroupEncoder
{
    ...
    /* Price = 44 */
    public CollateralResponseEncoder price(ReadOnlyDecimalFloat value)
    {
        price.set(value);
        hasPrice = true;
        return this;
    ...
    public CollateralResponseEncoder accruedInterestAmt(ReadOnlyDecimalFloat value)
    {
    ...
    public CollateralResponseEncoder endAccruedInterestAmt(ReadOnlyDecimalFloat value)
    {
    ...
    /* StartCash = 921 */
    public CollateralResponseEncoder startCash(ReadOnlyDecimalFloat value)
    {
        startCash.set(value);
        hasStartCash = true;
        return this;
    ...
    /* EndCash = 922 */
    public CollateralResponseEncoder endCash(ReadOnlyDecimalFloat value)
    {
        endCash.set(value);
        hasEndCash = true;
        return this;
    ...
    {
        collRespIDLength = 0;
        collRespID.wrap(collRespIDInternalBuffer);
    }
