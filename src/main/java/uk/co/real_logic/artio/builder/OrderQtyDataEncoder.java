...
public class OrderQtyDataEncoder
{
    ...
    /* CashOrderQty = 152 */
    public OrderQtyDataEncoder cashOrderQty(ReadOnlyDecimalFloat value)
    {
    ...
    /* OrderPercent = 516 */
    public OrderQtyDataEncoder orderPercent(ReadOnlyDecimalFloat value)
    {
    ...
    /* RoundingModulus = 469 */
    public OrderQtyDataEncoder roundingModulus(ReadOnlyDecimalFloat value)
    {
