...
public class MassQuoteEncoder implements Encoder
{
    ...
    /* DefBidSize = 293 */
    public MassQuoteEncoder defBidSize(ReadOnlyDecimalFloat value)
    {
    ...
    /* DefOfferSize = 294 */
    public MassQuoteEncoder defOfferSize(ReadOnlyDecimalFloat value)
    {
...
public static class QuoteSetsGroupEncoder
{
    ...
    private byte[] quoteSetValidUntilTimeInternalBuffer = quoteSetValidUntilTime.byteArray();
    ...
    {
        if (copyInto(quoteSetValidUntilTime, value, offset, length))
        {
            quoteSetValidUntilTimeInternalBuffer = quoteSetValidUntilTime.byteArray();
        }
        quoteSetValidUntilTimeOffset = 0;
        quoteSetValidUntilTimeLength = length;
        return this;
    }
...
public static class LegsGroupEncoder
{
    ...
    public void resetQuoteSetValidUntilTime()
    {
        ...
        quoteSetValidUntilTime.wrap(quoteSetValidUntilTimeInternalBuffer);
    }
