...
public class YieldDataEncoder
{
    ...
    private byte[] yieldTypeInternalBuffer = yieldType.byteArray();
    ...
    {
        if (copyInto(yieldType, value, offset, length))
        {
            yieldTypeInternalBuffer = yieldType.byteArray();
        }
        yieldTypeOffset = 0;
        yieldTypeLength = length;
        return this;
    ...
    {
        if (toBytes(value, yieldType, offset, length))
        {
            yieldTypeInternalBuffer = yieldType.byteArray();
        }
        yieldTypeOffset = 0;
    ...
    /* Yield = 236 */
    public YieldDataEncoder yield(ReadOnlyDecimalFloat value)
    {
        yield.set(value);
        hasYield = true;
        return this;
    ...
    private byte[] yieldCalcDateInternalBuffer = yieldCalcDate.byteArray();
    ...
    {
        if (copyInto(yieldCalcDate, value, offset, length))
        {
            yieldCalcDateInternalBuffer = yieldCalcDate.byteArray();
        }
        yieldCalcDateOffset = 0;
        yieldCalcDateLength = length;
        return this;
    }
    ...
    private byte[] yieldRedemptionDateInternalBuffer = yieldRedemptionDate.byteArray();
    ...
    {
        if (copyInto(yieldRedemptionDate, value, offset, length))
        {
            yieldRedemptionDateInternalBuffer = yieldRedemptionDate.byteArray();
        }
        yieldRedemptionDateOffset = 0;
        yieldRedemptionDateLength = length;
        return this;
    }
    ...
    public YieldDataEncoder yieldRedemptionPrice(ReadOnlyDecimalFloat value)
    {
    ...
    {
        yieldTypeLength = 0;
        yieldType.wrap(yieldTypeInternalBuffer);
    }
    ...
    public void resetYieldCalcDate()
    {
        ...
        yieldCalcDate.wrap(yieldCalcDateInternalBuffer);
    }

    public void resetYieldRedemptionDate()
    {
        yieldRedemptionDateLength = 0;
        yieldRedemptionDate.wrap(yieldRedemptionDateInternalBuffer);
    }
