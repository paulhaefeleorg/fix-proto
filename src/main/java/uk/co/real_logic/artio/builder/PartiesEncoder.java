...
public static class PartyIDsGroupEncoder
{
    ...
    private byte[] partyIDInternalBuffer = partyID.byteArray();
    ...
    {
        if (copyInto(partyID, value, offset, length))
        {
            partyIDInternalBuffer = partyID.byteArray();
        }
        partyIDOffset = 0;
        partyIDLength = length;
        return this;
    ...
    {
        if (toBytes(value, partyID, offset, length))
        {
            partyIDInternalBuffer = partyID.byteArray();
        }
        partyIDOffset = 0;
...
public static class PartySubIDsGroupEncoder
{
    ...
    private byte[] partySubIDInternalBuffer = partySubID.byteArray();
    ...
    {
        if (copyInto(partySubID, value, offset, length))
        {
            partySubIDInternalBuffer = partySubID.byteArray();
        }
        partySubIDOffset = 0;
        partySubIDLength = length;
        return this;
    ...
    {
        if (toBytes(value, partySubID, offset, length))
        {
            partySubIDInternalBuffer = partySubID.byteArray();
        }
        partySubIDOffset = 0;
    ...
    {
        partySubIDLength = 0;
        partySubID.wrap(partySubIDInternalBuffer);
    }
    ...
    {
        partyIDLength = 0;
        partyID.wrap(partyIDInternalBuffer);
    }
