...
public static class AllocsGroupEncoder
{
    ...
    private byte[] sideComplianceIDInternalBuffer = sideComplianceID.byteArray();
    ...
    {
        if (copyInto(sideComplianceID, value, offset, length))
        {
            sideComplianceIDInternalBuffer = sideComplianceID.byteArray();
        }
    ...
    {
        if (toBytes(value, sideComplianceID))
        {
            sideComplianceIDInternalBuffer = sideComplianceID.byteArray();
        }
        sideComplianceIDOffset = 0;
    ...
    {
        if (toBytes(value, sideComplianceID, offset, length))
        {
            sideComplianceIDInternalBuffer = sideComplianceID.byteArray();
        }
        sideComplianceIDOffset = 0;
    ...
    public void resetSideComplianceID()
    {
        ...
        sideComplianceID.wrap(sideComplianceIDInternalBuffer);
    }
    ...
    public NewOrderCrossEncoder noSidesGroupCounter(int value)
    {
...
public static class UnderlyingsGroupEncoder
{
    ...
    public NewOrderCrossEncoder noUnderlyingsGroupCounter(int value)
    {
...
public static class LegsGroupEncoder
{
    ...
    public NewOrderCrossEncoder noLegsGroupCounter(int value)
    {
    ...
    /* SettlType = 63 */
    public NewOrderCrossEncoder settlType(char value)
    {
        settlType = value;
        hasSettlType = true;
        return this;
    ...
    /* MinQty = 110 */
    public NewOrderCrossEncoder minQty(ReadOnlyDecimalFloat value)
    {
        minQty.set(value);
        hasMinQty = true;
        return this;
    ...
    /* MaxFloor = 111 */
    public NewOrderCrossEncoder maxFloor(ReadOnlyDecimalFloat value)
    {
        maxFloor.set(value);
        hasMaxFloor = true;
        return this;
...
public static class TradingSessionsGroupEncoder
{
    ...
    public NewOrderCrossEncoder noTradingSessionsGroupCounter(int value)
    {
    ...
    /* PrevClosePx = 140 */
    public NewOrderCrossEncoder prevClosePx(ReadOnlyDecimalFloat value)
    {
    ...
    /* Price = 44 */
    public NewOrderCrossEncoder price(ReadOnlyDecimalFloat value)
    {
        price.set(value);
        hasPrice = true;
        return this;
    ...
    /* StopPx = 99 */
    public NewOrderCrossEncoder stopPx(ReadOnlyDecimalFloat value)
    {
        stopPx.set(value);
        hasStopPx = true;
        return this;
    ...
    /* MaxShow = 210 */
    public NewOrderCrossEncoder maxShow(ReadOnlyDecimalFloat value)
    {
        maxShow.set(value);
        hasMaxShow = true;
        return this;
    ...
    public NewOrderCrossEncoder participationRate(ReadOnlyDecimalFloat value)
    {
