...
public class ListStatusEncoder implements Encoder
{
    ...
    private byte[] listStatusTextInternalBuffer = listStatusText.byteArray();
    ...
    {
        if (copyInto(listStatusText, value, offset, length))
        {
            listStatusTextInternalBuffer = listStatusText.byteArray();
        }
    ...
    {
        if (toBytes(value, listStatusText))
        {
            listStatusTextInternalBuffer = listStatusText.byteArray();
        }
        listStatusTextOffset = 0;
    ...
    {
        if (toBytes(value, listStatusText, offset, length))
        {
            listStatusTextInternalBuffer = listStatusText.byteArray();
        }
        listStatusTextOffset = 0;
...
public static class OrdersGroupEncoder
{
    ...
    /* CumQty = 14 */
    public OrdersGroupEncoder cumQty(ReadOnlyDecimalFloat value)
    {
        cumQty.set(value);
        hasCumQty = true;
        return this;
    ...
    /* LeavesQty = 151 */
    public OrdersGroupEncoder leavesQty(ReadOnlyDecimalFloat value)
    {
        leavesQty.set(value);
        hasLeavesQty = true;
        return this;
    ...
    /* CxlQty = 84 */
    public OrdersGroupEncoder cxlQty(ReadOnlyDecimalFloat value)
    {
        cxlQty.set(value);
        hasCxlQty = true;
        return this;
    ...
    /* AvgPx = 6 */
    public OrdersGroupEncoder avgPx(ReadOnlyDecimalFloat value)
    {
        avgPx.set(value);
        hasAvgPx = true;
        return this;
    ...
    public void resetListStatusText()
    {
        ...
        listStatusText.wrap(listStatusTextInternalBuffer);
    }
