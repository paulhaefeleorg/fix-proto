...
public static class PositionsGroupEncoder
{
    ...
    private byte[] posTypeInternalBuffer = posType.byteArray();
    ...
    {
        if (copyInto(posType, value, offset, length))
        {
            posTypeInternalBuffer = posType.byteArray();
        }
        posTypeOffset = 0;
        posTypeLength = length;
        return this;
    ...
    {
        if (toBytes(value, posType, offset, length))
        {
            posTypeInternalBuffer = posType.byteArray();
        }
        posTypeOffset = 0;
    ...
    /* LongQty = 704 */
    public PositionsGroupEncoder longQty(ReadOnlyDecimalFloat value)
    {
        longQty.set(value);
        hasLongQty = true;
        return this;
    ...
    /* ShortQty = 705 */
    public PositionsGroupEncoder shortQty(ReadOnlyDecimalFloat value)
    {
        shortQty.set(value);
        hasShortQty = true;
        return this;
    ...
    {
        posTypeLength = 0;
        posType.wrap(posTypeInternalBuffer);
    }
