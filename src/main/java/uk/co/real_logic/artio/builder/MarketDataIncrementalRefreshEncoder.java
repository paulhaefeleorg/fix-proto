...
public static class MDEntriesGroupEncoder
{
    ...
    private byte[] mDEntryIDInternalBuffer = mDEntryID.byteArray();
    ...
    {
        if (copyInto(mDEntryID, value, offset, length))
        {
            mDEntryIDInternalBuffer = mDEntryID.byteArray();
        }
        mDEntryIDOffset = 0;
        mDEntryIDLength = length;
        return this;
    ...
    {
        if (toBytes(value, mDEntryID, offset, length))
        {
            mDEntryIDInternalBuffer = mDEntryID.byteArray();
        }
        mDEntryIDOffset = 0;
    ...
    private byte[] mDEntryRefIDInternalBuffer = mDEntryRefID.byteArray();
    ...
    {
        if (copyInto(mDEntryRefID, value, offset, length))
        {
            mDEntryRefIDInternalBuffer = mDEntryRefID.byteArray();
        }
    ...
    {
        if (toBytes(value, mDEntryRefID, offset, length))
        {
            mDEntryRefIDInternalBuffer = mDEntryRefID.byteArray();
        }
        mDEntryRefIDOffset = 0;
...
public static class LegsGroupEncoder
{
    ...
    /* NetChgPrevDay = 451 */
    public MDEntriesGroupEncoder netChgPrevDay(ReadOnlyDecimalFloat value)
    {
    ...
    {
        mDEntryIDLength = 0;
        mDEntryID.wrap(mDEntryIDInternalBuffer);
    }

    public void resetMDEntryRefID()
    {
        mDEntryRefIDLength = 0;
        mDEntryRefID.wrap(mDEntryRefIDInternalBuffer);
    }
