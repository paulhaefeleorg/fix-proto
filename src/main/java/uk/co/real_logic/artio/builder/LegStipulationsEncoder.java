...
public static class LegStipulationsGroupEncoder
{
    ...
    private byte[] legStipulationTypeInternalBuffer = legStipulationType.byteArray();
    ...
    {
        if (copyInto(legStipulationType, value, offset, length))
        {
            legStipulationTypeInternalBuffer = legStipulationType.byteArray();
        }
    ...
    {
        if (toBytes(value, legStipulationType))
        {
            legStipulationTypeInternalBuffer = legStipulationType.byteArray();
        }
        legStipulationTypeOffset = 0;
    ...
    {
        if (toBytes(value, legStipulationType, offset, length))
        {
            legStipulationTypeInternalBuffer = legStipulationType.byteArray();
        }
        legStipulationTypeOffset = 0;
    ...
    private byte[] legStipulationValueInternalBuffer = legStipulationValue.byteArray();
    ...
    {
        if (copyInto(legStipulationValue, value, offset, length))
        {
            legStipulationValueInternalBuffer = legStipulationValue.byteArray();
        }
    ...
    {
        if (toBytes(value, legStipulationValue))
        {
            legStipulationValueInternalBuffer = legStipulationValue.byteArray();
        }
        legStipulationValueOffset = 0;
    ...
    {
        if (toBytes(value, legStipulationValue, offset, length))
        {
            legStipulationValueInternalBuffer = legStipulationValue.byteArray();
        }
        legStipulationValueOffset = 0;
    ...
    public void resetLegStipulationType()
    {
        ...
        legStipulationType.wrap(legStipulationTypeInternalBuffer);
    }

    public void resetLegStipulationValue()
    {
        legStipulationValueLength = 0;
        legStipulationValue.wrap(legStipulationValueInternalBuffer);
    }
