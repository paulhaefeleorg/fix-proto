...
public class ExecutionReportEncoder implements Encoder
{
    ...
    private byte[] ordStatusReqIDInternalBuffer = ordStatusReqID.byteArray();
    ...
    {
        if (copyInto(ordStatusReqID, value, offset, length))
        {
            ordStatusReqIDInternalBuffer = ordStatusReqID.byteArray();
        }
    ...
    {
        if (toBytes(value, ordStatusReqID))
        {
            ordStatusReqIDInternalBuffer = ordStatusReqID.byteArray();
        }
        ordStatusReqIDOffset = 0;
    ...
    {
        if (toBytes(value, ordStatusReqID, offset, length))
        {
            ordStatusReqIDInternalBuffer = ordStatusReqID.byteArray();
        }
        ordStatusReqIDOffset = 0;
...
public static class ContraBrokersGroupEncoder
{
    ...
    private byte[] contraBrokerInternalBuffer = contraBroker.byteArray();
    ...
    {
        if (copyInto(contraBroker, value, offset, length))
        {
            contraBrokerInternalBuffer = contraBroker.byteArray();
        }
    ...
    {
        if (toBytes(value, contraBroker, offset, length))
        {
            contraBrokerInternalBuffer = contraBroker.byteArray();
        }
        contraBrokerOffset = 0;
    ...
    private byte[] contraTraderInternalBuffer = contraTrader.byteArray();
    ...
    {
        if (copyInto(contraTrader, value, offset, length))
        {
            contraTraderInternalBuffer = contraTrader.byteArray();
        }
    ...
    {
        if (toBytes(value, contraTrader, offset, length))
        {
            contraTraderInternalBuffer = contraTrader.byteArray();
        }
        contraTraderOffset = 0;
    ...
    /* ContraTradeQty = 437 */
    public ContraBrokersGroupEncoder contraTradeQty(ReadOnlyDecimalFloat value)
    {
    ...
    private byte[] contraTradeTimeInternalBuffer = contraTradeTime.byteArray();
    ...
    {
        if (copyInto(contraTradeTime, value, offset, length))
        {
            contraTradeTimeInternalBuffer = contraTradeTime.byteArray();
        }
        contraTradeTimeOffset = 0;
        contraTradeTimeLength = length;
        return this;
    }
    ...
    private byte[] contraLegRefIDInternalBuffer = contraLegRefID.byteArray();
    ...
    {
        if (copyInto(contraLegRefID, value, offset, length))
        {
            contraLegRefIDInternalBuffer = contraLegRefID.byteArray();
        }
    ...
    {
        if (toBytes(value, contraLegRefID))
        {
            contraLegRefIDInternalBuffer = contraLegRefID.byteArray();
        }
        contraLegRefIDOffset = 0;
    ...
    {
        if (toBytes(value, contraLegRefID, offset, length))
        {
            contraLegRefIDInternalBuffer = contraLegRefID.byteArray();
        }
        contraLegRefIDOffset = 0;
    ...
    public void resetContraBroker()
    {
        ...
        contraBroker.wrap(contraBrokerInternalBuffer);
    }

    public void resetContraTrader()
    {
        contraTraderLength = 0;
        contraTrader.wrap(contraTraderInternalBuffer);
    }
    ...
    public void resetContraTradeTime()
    {
        ...
        contraTradeTime.wrap(contraTradeTimeInternalBuffer);
    }

    public void resetContraLegRefID()
    {
        contraLegRefIDLength = 0;
        contraLegRefID.wrap(contraLegRefIDInternalBuffer);
    }
    ...
    private byte[] execRefIDInternalBuffer = execRefID.byteArray();
    ...
    {
        if (copyInto(execRefID, value, offset, length))
        {
            execRefIDInternalBuffer = execRefID.byteArray();
        }
        execRefIDOffset = 0;
        execRefIDLength = length;
        return this;
    ...
    {
        if (toBytes(value, execRefID, offset, length))
        {
            execRefIDInternalBuffer = execRefID.byteArray();
        }
        execRefIDOffset = 0;
...
public static class UnderlyingsGroupEncoder
{
    ...
    /* Price = 44 */
    public ExecutionReportEncoder price(ReadOnlyDecimalFloat value)
    {
        price.set(value);
        hasPrice = true;
        return this;
    ...
    /* StopPx = 99 */
    public ExecutionReportEncoder stopPx(ReadOnlyDecimalFloat value)
    {
        stopPx.set(value);
        hasStopPx = true;
        return this;
    ...
    /* PeggedPrice = 839 */
    public ExecutionReportEncoder peggedPrice(ReadOnlyDecimalFloat value)
    {
    ...
    /* DiscretionPrice = 845 */
    public ExecutionReportEncoder discretionPrice(ReadOnlyDecimalFloat value)
    {
    ...
    public ExecutionReportEncoder participationRate(ReadOnlyDecimalFloat value)
    {
    ...
    public ExecutionReportEncoder targetStrategyPerformance(ReadOnlyDecimalFloat value)
    {
    ...
    /* LastQty = 32 */
    public ExecutionReportEncoder lastQty(ReadOnlyDecimalFloat value)
    {
        lastQty.set(value);
        hasLastQty = true;
        return this;
    ...
    public ExecutionReportEncoder underlyingLastQty(ReadOnlyDecimalFloat value)
    {
    ...
    /* LastPx = 31 */
    public ExecutionReportEncoder lastPx(ReadOnlyDecimalFloat value)
    {
        lastPx.set(value);
        hasLastPx = true;
        return this;
    ...
    public ExecutionReportEncoder underlyingLastPx(ReadOnlyDecimalFloat value)
    {
    ...
    /* LastParPx = 669 */
    public ExecutionReportEncoder lastParPx(ReadOnlyDecimalFloat value)
    {
        lastParPx.set(value);
        hasLastParPx = true;
        return this;
    ...
    /* LastSpotRate = 194 */
    public ExecutionReportEncoder lastSpotRate(ReadOnlyDecimalFloat value)
    {
    ...
    public ExecutionReportEncoder lastForwardPoints(ReadOnlyDecimalFloat value)
    {
    ...
    /* LeavesQty = 151 */
    public ExecutionReportEncoder leavesQty(ReadOnlyDecimalFloat value)
    {
        leavesQty.set(value);
        hasLeavesQty = true;
        return this;
    ...
    /* CumQty = 14 */
    public ExecutionReportEncoder cumQty(ReadOnlyDecimalFloat value)
    {
        cumQty.set(value);
        hasCumQty = true;
        return this;
    ...
    /* AvgPx = 6 */
    public ExecutionReportEncoder avgPx(ReadOnlyDecimalFloat value)
    {
        avgPx.set(value);
        hasAvgPx = true;
        return this;
    ...
    /* DayOrderQty = 424 */
    public ExecutionReportEncoder dayOrderQty(ReadOnlyDecimalFloat value)
    {
    ...
    /* DayCumQty = 425 */
    public ExecutionReportEncoder dayCumQty(ReadOnlyDecimalFloat value)
    {
        dayCumQty.set(value);
        hasDayCumQty = true;
        return this;
    ...
    /* DayAvgPx = 426 */
    public ExecutionReportEncoder dayAvgPx(ReadOnlyDecimalFloat value)
    {
        dayAvgPx.set(value);
        hasDayAvgPx = true;
        return this;
    ...
    /* GrossTradeAmt = 381 */
    public ExecutionReportEncoder grossTradeAmt(ReadOnlyDecimalFloat value)
    {
    ...
    public ExecutionReportEncoder accruedInterestRate(ReadOnlyDecimalFloat value)
    {
    ...
    public ExecutionReportEncoder accruedInterestAmt(ReadOnlyDecimalFloat value)
    {
    ...
    public ExecutionReportEncoder interestAtMaturity(ReadOnlyDecimalFloat value)
    {
    ...
    public ExecutionReportEncoder endAccruedInterestAmt(ReadOnlyDecimalFloat value)
    {
    ...
    /* StartCash = 921 */
    public ExecutionReportEncoder startCash(ReadOnlyDecimalFloat value)
    {
        startCash.set(value);
        hasStartCash = true;
        return this;
    ...
    /* EndCash = 922 */
    public ExecutionReportEncoder endCash(ReadOnlyDecimalFloat value)
    {
        endCash.set(value);
        hasEndCash = true;
        return this;
    ...
    private byte[] basisFeatureDateInternalBuffer = basisFeatureDate.byteArray();
    ...
    {
        if (copyInto(basisFeatureDate, value, offset, length))
        {
            basisFeatureDateInternalBuffer = basisFeatureDate.byteArray();
        }
        basisFeatureDateOffset = 0;
        basisFeatureDateLength = length;
        return this;
    }
    ...
    public ExecutionReportEncoder basisFeaturePrice(ReadOnlyDecimalFloat value)
    {
    ...
    /* Concession = 238 */
    public ExecutionReportEncoder concession(ReadOnlyDecimalFloat value)
    {
    ...
    /* TotalTakedown = 237 */
    public ExecutionReportEncoder totalTakedown(ReadOnlyDecimalFloat value)
    {
    ...
    /* NetMoney = 118 */
    public ExecutionReportEncoder netMoney(ReadOnlyDecimalFloat value)
    {
        netMoney.set(value);
        hasNetMoney = true;
        return this;
    ...
    /* SettlCurrAmt = 119 */
    public ExecutionReportEncoder settlCurrAmt(ReadOnlyDecimalFloat value)
    {
    ...
    /* SettlCurrFxRate = 155 */
    public ExecutionReportEncoder settlCurrFxRate(ReadOnlyDecimalFloat value)
    {
    ...
    /* MinQty = 110 */
    public ExecutionReportEncoder minQty(ReadOnlyDecimalFloat value)
    {
        minQty.set(value);
        hasMinQty = true;
        return this;
    ...
    /* MaxFloor = 111 */
    public ExecutionReportEncoder maxFloor(ReadOnlyDecimalFloat value)
    {
        maxFloor.set(value);
        hasMaxFloor = true;
        return this;
    ...
    /* MaxShow = 210 */
    public ExecutionReportEncoder maxShow(ReadOnlyDecimalFloat value)
    {
        maxShow.set(value);
        hasMaxShow = true;
        return this;
    ...
    /* OrderQty2 = 192 */
    public ExecutionReportEncoder orderQty2(ReadOnlyDecimalFloat value)
    {
        orderQty2.set(value);
        hasOrderQty2 = true;
        return this;
    ...
    public ExecutionReportEncoder lastForwardPoints2(ReadOnlyDecimalFloat value)
    {
    ...
    private byte[] execValuationPointInternalBuffer = execValuationPoint.byteArray();
    ...
    {
        if (copyInto(execValuationPoint, value, offset, length))
        {
            execValuationPointInternalBuffer = execValuationPoint.byteArray();
        }
        execValuationPointOffset = 0;
        execValuationPointLength = length;
        return this;
    }
    ...
    public ExecutionReportEncoder execPriceAdjustment(ReadOnlyDecimalFloat value)
    {
    ...
    public ExecutionReportEncoder priceImprovement(ReadOnlyDecimalFloat value)
    {
...
public static class MiscFeesGroupEncoder
{
    ...
    public void resetOrdStatusReqID()
    {
        ...
        ordStatusReqID.wrap(ordStatusReqIDInternalBuffer);
    }
    ...
    {
        execRefIDLength = 0;
        execRefID.wrap(execRefIDInternalBuffer);
    }
    ...
    public void resetBasisFeatureDate()
    {
        ...
        basisFeatureDate.wrap(basisFeatureDateInternalBuffer);
    }
    ...
    public void resetExecValuationPoint()
    {
        ...
        execValuationPoint.wrap(execValuationPointInternalBuffer);
    }
