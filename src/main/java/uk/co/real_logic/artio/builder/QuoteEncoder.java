...
public static class UnderlyingsGroupEncoder
{
    ...
    /* OrderQty2 = 192 */
    public QuoteEncoder orderQty2(ReadOnlyDecimalFloat value)
    {
        orderQty2.set(value);
        hasOrderQty2 = true;
        return this;
...
public static class LegsGroupEncoder
{
    ...
    /* BidPx = 132 */
    public QuoteEncoder bidPx(ReadOnlyDecimalFloat value)
    {
        bidPx.set(value);
        hasBidPx = true;
        return this;
    ...
    /* OfferPx = 133 */
    public QuoteEncoder offerPx(ReadOnlyDecimalFloat value)
    {
        offerPx.set(value);
        hasOfferPx = true;
        return this;
    ...
    /* MktBidPx = 645 */
    public QuoteEncoder mktBidPx(ReadOnlyDecimalFloat value)
    {
        mktBidPx.set(value);
        hasMktBidPx = true;
        return this;
    ...
    /* MktOfferPx = 646 */
    public QuoteEncoder mktOfferPx(ReadOnlyDecimalFloat value)
    {
    ...
    /* MinBidSize = 647 */
    public QuoteEncoder minBidSize(ReadOnlyDecimalFloat value)
    {
    ...
    /* BidSize = 134 */
    public QuoteEncoder bidSize(ReadOnlyDecimalFloat value)
    {
        bidSize.set(value);
        hasBidSize = true;
        return this;
    ...
    /* MinOfferSize = 648 */
    public QuoteEncoder minOfferSize(ReadOnlyDecimalFloat value)
    {
    ...
    /* OfferSize = 135 */
    public QuoteEncoder offerSize(ReadOnlyDecimalFloat value)
    {
        offerSize.set(value);
        hasOfferSize = true;
        return this;
    ...
    /* BidSpotRate = 188 */
    public QuoteEncoder bidSpotRate(ReadOnlyDecimalFloat value)
    {
    ...
    /* OfferSpotRate = 190 */
    public QuoteEncoder offerSpotRate(ReadOnlyDecimalFloat value)
    {
    ...
    public QuoteEncoder bidForwardPoints(ReadOnlyDecimalFloat value)
    {
    ...
    public QuoteEncoder offerForwardPoints(ReadOnlyDecimalFloat value)
    {
    ...
    /* MidPx = 631 */
    public QuoteEncoder midPx(ReadOnlyDecimalFloat value)
    {
        midPx.set(value);
        hasMidPx = true;
        return this;
    ...
    /* BidYield = 632 */
    public QuoteEncoder bidYield(ReadOnlyDecimalFloat value)
    {
        bidYield.set(value);
        hasBidYield = true;
        return this;
    ...
    /* MidYield = 633 */
    public QuoteEncoder midYield(ReadOnlyDecimalFloat value)
    {
        midYield.set(value);
        hasMidYield = true;
        return this;
    ...
    /* OfferYield = 634 */
    public QuoteEncoder offerYield(ReadOnlyDecimalFloat value)
    {
    ...
    public QuoteEncoder bidForwardPoints2(ReadOnlyDecimalFloat value)
    {
    ...
    public QuoteEncoder offerForwardPoints2(ReadOnlyDecimalFloat value)
    {
    ...
    public QuoteEncoder settlCurrBidFxRate(ReadOnlyDecimalFloat value)
    {
    ...
    public QuoteEncoder settlCurrOfferFxRate(ReadOnlyDecimalFloat value)
    {
    ...
    /* Commission = 12 */
    public QuoteEncoder commission(ReadOnlyDecimalFloat value)
    {
