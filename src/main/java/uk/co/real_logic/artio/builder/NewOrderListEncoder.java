...
public class NewOrderListEncoder implements Encoder
{
    ...
    private byte[] listExecInstInternalBuffer = listExecInst.byteArray();
    ...
    {
        if (copyInto(listExecInst, value, offset, length))
        {
            listExecInstInternalBuffer = listExecInst.byteArray();
        }
    ...
    {
        if (toBytes(value, listExecInst, offset, length))
        {
            listExecInstInternalBuffer = listExecInst.byteArray();
        }
        listExecInstOffset = 0;
    ...
    public NewOrderListEncoder allowableOneSidednessPct(ReadOnlyDecimalFloat value)
    {
    ...
    public NewOrderListEncoder allowableOneSidednessValue(ReadOnlyDecimalFloat value)
    {
    ...
    private byte[] allowableOneSidednessCurrInternalBuffer = allowableOneSidednessCurr.byteArray();
    ...
    {
        if (copyInto(allowableOneSidednessCurr, value, offset, length))
        {
            allowableOneSidednessCurrInternalBuffer = allowableOneSidednessCurr.byteArray();
        }
    ...
    {
        if (toBytes(value, allowableOneSidednessCurr))
        {
            allowableOneSidednessCurrInternalBuffer = allowableOneSidednessCurr.byteArray();
        }
        allowableOneSidednessCurrOffset = 0;
    ...
    {
        if (toBytes(value, allowableOneSidednessCurr, offset, length))
        {
            allowableOneSidednessCurrInternalBuffer = allowableOneSidednessCurr.byteArray();
        }
        allowableOneSidednessCurrOffset = 0;
...
public static class AllocsGroupEncoder
{
    ...
    /* MinQty = 110 */
    public OrdersGroupEncoder minQty(ReadOnlyDecimalFloat value)
    {
        minQty.set(value);
        hasMinQty = true;
        return this;
    ...
    /* MaxFloor = 111 */
    public OrdersGroupEncoder maxFloor(ReadOnlyDecimalFloat value)
    {
        maxFloor.set(value);
        hasMaxFloor = true;
        return this;
...
public static class UnderlyingsGroupEncoder
{
    ...
    /* PrevClosePx = 140 */
    public OrdersGroupEncoder prevClosePx(ReadOnlyDecimalFloat value)
    {
    ...
    /* Price = 44 */
    public OrdersGroupEncoder price(ReadOnlyDecimalFloat value)
    {
        price.set(value);
        hasPrice = true;
        return this;
    ...
    /* StopPx = 99 */
    public OrdersGroupEncoder stopPx(ReadOnlyDecimalFloat value)
    {
        stopPx.set(value);
        hasStopPx = true;
        return this;
    ...
    /* OrderQty2 = 192 */
    public OrdersGroupEncoder orderQty2(ReadOnlyDecimalFloat value)
    {
        orderQty2.set(value);
        hasOrderQty2 = true;
        return this;
    ...
    /* Price2 = 640 */
    public OrdersGroupEncoder price2(ReadOnlyDecimalFloat value)
    {
        price2.set(value);
        hasPrice2 = true;
        return this;
    ...
    /* MaxShow = 210 */
    public OrdersGroupEncoder maxShow(ReadOnlyDecimalFloat value)
    {
        maxShow.set(value);
        hasMaxShow = true;
        return this;
    ...
    public OrdersGroupEncoder participationRate(ReadOnlyDecimalFloat value)
    {
    ...
    public void resetListExecInst()
    {
        ...
        listExecInst.wrap(listExecInstInternalBuffer);
    }
    ...
    public void resetAllowableOneSidednessCurr()
    {
        ...
        allowableOneSidednessCurr.wrap(allowableOneSidednessCurrInternalBuffer);
    }
