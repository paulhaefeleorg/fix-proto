...
public class InstrumentExtensionEncoder
{
    ...
    /* PctAtRisk = 869 */
    public InstrumentExtensionEncoder pctAtRisk(ReadOnlyDecimalFloat value)
    {
        pctAtRisk.set(value);
        hasPctAtRisk = true;
        return this;
...
public static class InstrAttribGroupEncoder
{
    ...
    private byte[] instrAttribValueInternalBuffer = instrAttribValue.byteArray();
    ...
    {
        if (copyInto(instrAttribValue, value, offset, length))
        {
            instrAttribValueInternalBuffer = instrAttribValue.byteArray();
        }
    ...
    {
        if (toBytes(value, instrAttribValue))
        {
            instrAttribValueInternalBuffer = instrAttribValue.byteArray();
        }
        instrAttribValueOffset = 0;
    ...
    {
        if (toBytes(value, instrAttribValue, offset, length))
        {
            instrAttribValueInternalBuffer = instrAttribValue.byteArray();
        }
        instrAttribValueOffset = 0;
    ...
    public void resetInstrAttribValue()
    {
        ...
        instrAttribValue.wrap(instrAttribValueInternalBuffer);
    }
