...
public static class NestedPartyIDsGroupEncoder
{
    ...
    private byte[] nestedPartyIDInternalBuffer = nestedPartyID.byteArray();
    ...
    {
        if (copyInto(nestedPartyID, value, offset, length))
        {
            nestedPartyIDInternalBuffer = nestedPartyID.byteArray();
        }
    ...
    {
        if (toBytes(value, nestedPartyID))
        {
            nestedPartyIDInternalBuffer = nestedPartyID.byteArray();
        }
        nestedPartyIDOffset = 0;
    ...
    {
        if (toBytes(value, nestedPartyID, offset, length))
        {
            nestedPartyIDInternalBuffer = nestedPartyID.byteArray();
        }
        nestedPartyIDOffset = 0;
...
public static class NestedPartySubIDsGroupEncoder
{
    ...
    private byte[] nestedPartySubIDInternalBuffer = nestedPartySubID.byteArray();
    ...
    {
        if (copyInto(nestedPartySubID, value, offset, length))
        {
            nestedPartySubIDInternalBuffer = nestedPartySubID.byteArray();
        }
    ...
    {
        if (toBytes(value, nestedPartySubID))
        {
            nestedPartySubIDInternalBuffer = nestedPartySubID.byteArray();
        }
        nestedPartySubIDOffset = 0;
    ...
    {
        if (toBytes(value, nestedPartySubID, offset, length))
        {
            nestedPartySubIDInternalBuffer = nestedPartySubID.byteArray();
        }
        nestedPartySubIDOffset = 0;
    ...
    public void resetNestedPartySubID()
    {
        ...
        nestedPartySubID.wrap(nestedPartySubIDInternalBuffer);
    }
    ...
    public void resetNestedPartyID()
    {
        ...
        nestedPartyID.wrap(nestedPartyIDInternalBuffer);
    }
