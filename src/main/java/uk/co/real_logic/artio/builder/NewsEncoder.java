...
public class NewsEncoder implements Encoder
{
    ...
    private byte[] headlineInternalBuffer = headline.byteArray();
    ...
    {
        if (copyInto(headline, value, offset, length))
        {
            headlineInternalBuffer = headline.byteArray();
        }
        headlineOffset = 0;
        headlineLength = length;
        return this;
    ...
    {
        if (toBytes(value, headline, offset, length))
        {
            headlineInternalBuffer = headline.byteArray();
        }
        headlineOffset = 0;
...
public static class LinesOfTextGroupEncoder
{
    ...
    {
        headlineLength = 0;
        headline.wrap(headlineInternalBuffer);
    }
