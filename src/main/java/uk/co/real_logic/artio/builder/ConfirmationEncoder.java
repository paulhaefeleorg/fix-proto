...
public class ConfirmationEncoder implements Encoder
{
    ...
    private byte[] confirmRefIDInternalBuffer = confirmRefID.byteArray();
    ...
    {
        if (copyInto(confirmRefID, value, offset, length))
        {
            confirmRefIDInternalBuffer = confirmRefID.byteArray();
        }
    ...
    {
        if (toBytes(value, confirmRefID, offset, length))
        {
            confirmRefIDInternalBuffer = confirmRefID.byteArray();
        }
        confirmRefIDOffset = 0;
...
public static class MiscFeesGroupEncoder
{
    ...
    public void resetConfirmRefID()
    {
        ...
        confirmRefID.wrap(confirmRefIDInternalBuffer);
    }
