...
public static class SettlPartyIDsGroupEncoder
{
    ...
    private byte[] settlPartyIDInternalBuffer = settlPartyID.byteArray();
    ...
    {
        if (copyInto(settlPartyID, value, offset, length))
        {
            settlPartyIDInternalBuffer = settlPartyID.byteArray();
        }
    ...
    {
        if (toBytes(value, settlPartyID, offset, length))
        {
            settlPartyIDInternalBuffer = settlPartyID.byteArray();
        }
        settlPartyIDOffset = 0;
...
public static class SettlPartySubIDsGroupEncoder
{
    ...
    private byte[] settlPartySubIDInternalBuffer = settlPartySubID.byteArray();
    ...
    {
        if (copyInto(settlPartySubID, value, offset, length))
        {
            settlPartySubIDInternalBuffer = settlPartySubID.byteArray();
        }
    ...
    {
        if (toBytes(value, settlPartySubID))
        {
            settlPartySubIDInternalBuffer = settlPartySubID.byteArray();
        }
        settlPartySubIDOffset = 0;
    ...
    {
        if (toBytes(value, settlPartySubID, offset, length))
        {
            settlPartySubIDInternalBuffer = settlPartySubID.byteArray();
        }
        settlPartySubIDOffset = 0;
    ...
    public void resetSettlPartySubID()
    {
        ...
        settlPartySubID.wrap(settlPartySubIDInternalBuffer);
    }
    ...
    public void resetSettlPartyID()
    {
        ...
        settlPartyID.wrap(settlPartyIDInternalBuffer);
    }
