...
public static class Nested2PartyIDsGroupEncoder
{
    ...
    private byte[] nested2PartyIDInternalBuffer = nested2PartyID.byteArray();
    ...
    {
        if (copyInto(nested2PartyID, value, offset, length))
        {
            nested2PartyIDInternalBuffer = nested2PartyID.byteArray();
        }
    ...
    {
        if (toBytes(value, nested2PartyID))
        {
            nested2PartyIDInternalBuffer = nested2PartyID.byteArray();
        }
        nested2PartyIDOffset = 0;
    ...
    {
        if (toBytes(value, nested2PartyID, offset, length))
        {
            nested2PartyIDInternalBuffer = nested2PartyID.byteArray();
        }
        nested2PartyIDOffset = 0;
...
public static class Nested2PartySubIDsGroupEncoder
{
    ...
    private byte[] nested2PartySubIDInternalBuffer = nested2PartySubID.byteArray();
    ...
    {
        if (copyInto(nested2PartySubID, value, offset, length))
        {
            nested2PartySubIDInternalBuffer = nested2PartySubID.byteArray();
        }
    ...
    {
        if (toBytes(value, nested2PartySubID))
        {
            nested2PartySubIDInternalBuffer = nested2PartySubID.byteArray();
        }
        nested2PartySubIDOffset = 0;
    ...
    {
        if (toBytes(value, nested2PartySubID, offset, length))
        {
            nested2PartySubIDInternalBuffer = nested2PartySubID.byteArray();
        }
        nested2PartySubIDOffset = 0;
    ...
    public void resetNested2PartySubID()
    {
        ...
        nested2PartySubID.wrap(nested2PartySubIDInternalBuffer);
    }
    ...
    public void resetNested2PartyID()
    {
        ...
        nested2PartyID.wrap(nested2PartyIDInternalBuffer);
    }
