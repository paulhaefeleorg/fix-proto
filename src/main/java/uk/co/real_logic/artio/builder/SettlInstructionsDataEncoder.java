...
public class SettlInstructionsDataEncoder
{
    ...
    private byte[] standInstDbNameInternalBuffer = standInstDbName.byteArray();
    ...
    {
        if (copyInto(standInstDbName, value, offset, length))
        {
            standInstDbNameInternalBuffer = standInstDbName.byteArray();
        }
    ...
    {
        if (toBytes(value, standInstDbName))
        {
            standInstDbNameInternalBuffer = standInstDbName.byteArray();
        }
        standInstDbNameOffset = 0;
    ...
    {
        if (toBytes(value, standInstDbName, offset, length))
        {
            standInstDbNameInternalBuffer = standInstDbName.byteArray();
        }
        standInstDbNameOffset = 0;
    ...
    private byte[] standInstDbIDInternalBuffer = standInstDbID.byteArray();
    ...
    {
        if (copyInto(standInstDbID, value, offset, length))
        {
            standInstDbIDInternalBuffer = standInstDbID.byteArray();
        }
    ...
    {
        if (toBytes(value, standInstDbID))
        {
            standInstDbIDInternalBuffer = standInstDbID.byteArray();
        }
        standInstDbIDOffset = 0;
    ...
    {
        if (toBytes(value, standInstDbID, offset, length))
        {
            standInstDbIDInternalBuffer = standInstDbID.byteArray();
        }
        standInstDbIDOffset = 0;
...
public static class DlvyInstGroupEncoder
{
    ...
    public void resetStandInstDbName()
    {
        ...
        standInstDbName.wrap(standInstDbNameInternalBuffer);
    }

    public void resetStandInstDbID()
    {
        standInstDbIDLength = 0;
        standInstDbID.wrap(standInstDbIDInternalBuffer);
    }
