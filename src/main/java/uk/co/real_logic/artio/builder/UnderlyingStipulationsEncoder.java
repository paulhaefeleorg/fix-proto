...
public static class UnderlyingStipsGroupEncoder
{
    ...
    private byte[] underlyingStipTypeInternalBuffer = underlyingStipType.byteArray();
    ...
    {
        if (copyInto(underlyingStipType, value, offset, length))
        {
            underlyingStipTypeInternalBuffer = underlyingStipType.byteArray();
        }
    ...
    {
        if (toBytes(value, underlyingStipType))
        {
            underlyingStipTypeInternalBuffer = underlyingStipType.byteArray();
        }
        underlyingStipTypeOffset = 0;
    ...
    {
        if (toBytes(value, underlyingStipType, offset, length))
        {
            underlyingStipTypeInternalBuffer = underlyingStipType.byteArray();
        }
        underlyingStipTypeOffset = 0;
    ...
    private byte[] underlyingStipValueInternalBuffer = underlyingStipValue.byteArray();
    ...
    {
        if (copyInto(underlyingStipValue, value, offset, length))
        {
            underlyingStipValueInternalBuffer = underlyingStipValue.byteArray();
        }
    ...
    {
        if (toBytes(value, underlyingStipValue))
        {
            underlyingStipValueInternalBuffer = underlyingStipValue.byteArray();
        }
        underlyingStipValueOffset = 0;
    ...
    {
        if (toBytes(value, underlyingStipValue, offset, length))
        {
            underlyingStipValueInternalBuffer = underlyingStipValue.byteArray();
        }
        underlyingStipValueOffset = 0;
    ...
    public void resetUnderlyingStipType()
    {
        ...
        underlyingStipType.wrap(underlyingStipTypeInternalBuffer);
    }

    public void resetUnderlyingStipValue()
    {
        underlyingStipValueLength = 0;
        underlyingStipValue.wrap(underlyingStipValueInternalBuffer);
    }
