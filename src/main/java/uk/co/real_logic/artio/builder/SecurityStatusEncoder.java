...
public class SecurityStatusEncoder implements Encoder
{
    ...
    private byte[] securityStatusReqIDInternalBuffer = securityStatusReqID.byteArray();
    ...
    {
        if (copyInto(securityStatusReqID, value, offset, length))
        {
            securityStatusReqIDInternalBuffer = securityStatusReqID.byteArray();
        }
    ...
    {
        if (toBytes(value, securityStatusReqID))
        {
            securityStatusReqIDInternalBuffer = securityStatusReqID.byteArray();
        }
        securityStatusReqIDOffset = 0;
    ...
    {
        if (toBytes(value, securityStatusReqID, offset, length))
        {
            securityStatusReqIDInternalBuffer = securityStatusReqID.byteArray();
        }
        securityStatusReqIDOffset = 0;
...
public static class LegsGroupEncoder
{
    ...
    /* BuyVolume = 330 */
    public SecurityStatusEncoder buyVolume(ReadOnlyDecimalFloat value)
    {
        buyVolume.set(value);
        hasBuyVolume = true;
        return this;
    ...
    /* SellVolume = 331 */
    public SecurityStatusEncoder sellVolume(ReadOnlyDecimalFloat value)
    {
    ...
    /* HighPx = 332 */
    public SecurityStatusEncoder highPx(ReadOnlyDecimalFloat value)
    {
        highPx.set(value);
        hasHighPx = true;
        return this;
    ...
    /* LowPx = 333 */
    public SecurityStatusEncoder lowPx(ReadOnlyDecimalFloat value)
    {
        lowPx.set(value);
        hasLowPx = true;
        return this;
    ...
    /* LastPx = 31 */
    public SecurityStatusEncoder lastPx(ReadOnlyDecimalFloat value)
    {
        lastPx.set(value);
        hasLastPx = true;
        return this;
    ...
    public void resetSecurityStatusReqID()
    {
        ...
        securityStatusReqID.wrap(securityStatusReqIDInternalBuffer);
    }
