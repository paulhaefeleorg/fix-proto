...
public class IndicationOfInterestEncoder implements Encoder
{
    ...
    private byte[] iOIRefIDInternalBuffer = iOIRefID.byteArray();
    ...
    {
        if (copyInto(iOIRefID, value, offset, length))
        {
            iOIRefIDInternalBuffer = iOIRefID.byteArray();
        }
        iOIRefIDOffset = 0;
        iOIRefIDLength = length;
        return this;
    ...
    {
        if (toBytes(value, iOIRefID, offset, length))
        {
            iOIRefIDInternalBuffer = iOIRefID.byteArray();
        }
        iOIRefIDOffset = 0;
...
public static class UnderlyingsGroupEncoder
{
    ...
    private byte[] iOIQtyInternalBuffer = iOIQty.byteArray();
    ...
    {
        if (copyInto(iOIQty, value, offset, length))
        {
            iOIQtyInternalBuffer = iOIQty.byteArray();
        }
        iOIQtyOffset = 0;
        iOIQtyLength = length;
        return this;
    ...
    {
        if (toBytes(value, iOIQty, offset, length))
        {
            iOIQtyInternalBuffer = iOIQty.byteArray();
        }
        iOIQtyOffset = 0;
...
public static class LegsGroupEncoder
{
    ...
    private byte[] legIOIQtyInternalBuffer = legIOIQty.byteArray();
    ...
    {
        if (copyInto(legIOIQty, value, offset, length))
        {
            legIOIQtyInternalBuffer = legIOIQty.byteArray();
        }
        legIOIQtyOffset = 0;
        legIOIQtyLength = length;
        return this;
    ...
    {
        if (toBytes(value, legIOIQty, offset, length))
        {
            legIOIQtyInternalBuffer = legIOIQty.byteArray();
        }
        legIOIQtyOffset = 0;
    ...
    {
        legIOIQtyLength = 0;
        legIOIQty.wrap(legIOIQtyInternalBuffer);
    }
    ...
    /* Price = 44 */
    public IndicationOfInterestEncoder price(ReadOnlyDecimalFloat value)
    {
        price.set(value);
        hasPrice = true;
        return this;
...
public static class RoutingIDsGroupEncoder
{
    ...
    {
        iOIRefIDLength = 0;
        iOIRefID.wrap(iOIRefIDInternalBuffer);
    }
    ...
    {
        iOIQtyLength = 0;
        iOIQty.wrap(iOIQtyInternalBuffer);
    }
