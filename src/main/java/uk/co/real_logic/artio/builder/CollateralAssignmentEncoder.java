...
public class CollateralAssignmentEncoder implements Encoder
{
    ...
    private byte[] collAsgnIDInternalBuffer = collAsgnID.byteArray();
    ...
    {
        if (copyInto(collAsgnID, value, offset, length))
        {
            collAsgnIDInternalBuffer = collAsgnID.byteArray();
        }
        collAsgnIDOffset = 0;
        collAsgnIDLength = length;
        return this;
    ...
    {
        if (toBytes(value, collAsgnID, offset, length))
        {
            collAsgnIDInternalBuffer = collAsgnID.byteArray();
        }
        collAsgnIDOffset = 0;
    ...
    private byte[] collAsgnRefIDInternalBuffer = collAsgnRefID.byteArray();
    ...
    {
        if (copyInto(collAsgnRefID, value, offset, length))
        {
            collAsgnRefIDInternalBuffer = collAsgnRefID.byteArray();
        }
    ...
    {
        if (toBytes(value, collAsgnRefID))
        {
            collAsgnRefIDInternalBuffer = collAsgnRefID.byteArray();
        }
        collAsgnRefIDOffset = 0;
    ...
    {
        if (toBytes(value, collAsgnRefID, offset, length))
        {
            collAsgnRefIDInternalBuffer = collAsgnRefID.byteArray();
        }
        collAsgnRefIDOffset = 0;
...
public static class TradesGroupEncoder
{
    ...
    /* Quantity = 53 */
    public CollateralAssignmentEncoder quantity(ReadOnlyDecimalFloat value)
    {
        quantity.set(value);
        hasQuantity = true;
        return this;
...
public static class UnderlyingsGroupEncoder
{
    ...
    /* MarginExcess = 899 */
    public CollateralAssignmentEncoder marginExcess(ReadOnlyDecimalFloat value)
    {
    ...
    /* TotalNetValue = 900 */
    public CollateralAssignmentEncoder totalNetValue(ReadOnlyDecimalFloat value)
    {
    ...
    /* CashOutstanding = 901 */
    public CollateralAssignmentEncoder cashOutstanding(ReadOnlyDecimalFloat value)
    {
...
public static class MiscFeesGroupEncoder
{
    ...
    /* Price = 44 */
    public CollateralAssignmentEncoder price(ReadOnlyDecimalFloat value)
    {
        price.set(value);
        hasPrice = true;
        return this;
    ...
    public CollateralAssignmentEncoder accruedInterestAmt(ReadOnlyDecimalFloat value)
    {
    ...
    public CollateralAssignmentEncoder endAccruedInterestAmt(ReadOnlyDecimalFloat value)
    {
    ...
    /* StartCash = 921 */
    public CollateralAssignmentEncoder startCash(ReadOnlyDecimalFloat value)
    {
        startCash.set(value);
        hasStartCash = true;
        return this;
    ...
    /* EndCash = 922 */
    public CollateralAssignmentEncoder endCash(ReadOnlyDecimalFloat value)
    {
        endCash.set(value);
        hasEndCash = true;
        return this;
    ...
    {
        collAsgnIDLength = 0;
        collAsgnID.wrap(collAsgnIDInternalBuffer);
    }
    ...
    public void resetCollAsgnRefID()
    {
        ...
        collAsgnRefID.wrap(collAsgnRefIDInternalBuffer);
    }
