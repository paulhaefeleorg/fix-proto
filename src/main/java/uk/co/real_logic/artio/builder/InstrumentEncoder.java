...
public class InstrumentEncoder
{
    ...
    private byte[] symbolSfxInternalBuffer = symbolSfx.byteArray();
    ...
    {
        if (copyInto(symbolSfx, value, offset, length))
        {
            symbolSfxInternalBuffer = symbolSfx.byteArray();
        }
        symbolSfxOffset = 0;
        symbolSfxLength = length;
        return this;
    ...
    {
        if (toBytes(value, symbolSfx, offset, length))
        {
            symbolSfxInternalBuffer = symbolSfx.byteArray();
        }
        symbolSfxOffset = 0;
    ...
    private byte[] securityIDInternalBuffer = securityID.byteArray();
    ...
    {
        if (copyInto(securityID, value, offset, length))
        {
            securityIDInternalBuffer = securityID.byteArray();
        }
        securityIDOffset = 0;
        securityIDLength = length;
        return this;
    ...
    {
        if (toBytes(value, securityID, offset, length))
        {
            securityIDInternalBuffer = securityID.byteArray();
        }
        securityIDOffset = 0;
    ...
    private byte[] securityIDSourceInternalBuffer = securityIDSource.byteArray();
    ...
    {
        if (copyInto(securityIDSource, value, offset, length))
        {
            securityIDSourceInternalBuffer = securityIDSource.byteArray();
        }
    ...
    {
        if (toBytes(value, securityIDSource))
        {
            securityIDSourceInternalBuffer = securityIDSource.byteArray();
        }
        securityIDSourceOffset = 0;
    ...
    {
        if (toBytes(value, securityIDSource, offset, length))
        {
            securityIDSourceInternalBuffer = securityIDSource.byteArray();
        }
        securityIDSourceOffset = 0;
...
public static class SecurityAltIDGroupEncoder
{
    ...
    private byte[] securityAltIDInternalBuffer = securityAltID.byteArray();
    ...
    {
        if (copyInto(securityAltID, value, offset, length))
        {
            securityAltIDInternalBuffer = securityAltID.byteArray();
        }
    ...
    {
        if (toBytes(value, securityAltID))
        {
            securityAltIDInternalBuffer = securityAltID.byteArray();
        }
        securityAltIDOffset = 0;
    ...
    {
        if (toBytes(value, securityAltID, offset, length))
        {
            securityAltIDInternalBuffer = securityAltID.byteArray();
        }
        securityAltIDOffset = 0;
    ...
    private byte[] securityAltIDSourceInternalBuffer = securityAltIDSource.byteArray();
    ...
    {
        if (copyInto(securityAltIDSource, value, offset, length))
        {
            securityAltIDSourceInternalBuffer = securityAltIDSource.byteArray();
        }
    ...
    {
        if (toBytes(value, securityAltIDSource))
        {
            securityAltIDSourceInternalBuffer = securityAltIDSource.byteArray();
        }
        securityAltIDSourceOffset = 0;
    ...
    {
        if (toBytes(value, securityAltIDSource, offset, length))
        {
            securityAltIDSourceInternalBuffer = securityAltIDSource.byteArray();
        }
        securityAltIDSourceOffset = 0;
    ...
    public void resetSecurityAltID()
    {
        ...
        securityAltID.wrap(securityAltIDInternalBuffer);
    }

    public void resetSecurityAltIDSource()
    {
        securityAltIDSourceLength = 0;
        securityAltIDSource.wrap(securityAltIDSourceInternalBuffer);
    }
    ...
    private byte[] maturityMonthYearInternalBuffer = maturityMonthYear.byteArray();
    ...
    {
        if (copyInto(maturityMonthYear, value, offset, length))
        {
            maturityMonthYearInternalBuffer = maturityMonthYear.byteArray();
        }
        maturityMonthYearOffset = 0;
        maturityMonthYearLength = length;
        return this;
    }
    ...
    private byte[] maturityDateInternalBuffer = maturityDate.byteArray();
    ...
    {
        if (copyInto(maturityDate, value, offset, length))
        {
            maturityDateInternalBuffer = maturityDate.byteArray();
        }
    ...
    private byte[] couponPaymentDateInternalBuffer = couponPaymentDate.byteArray();
    ...
    {
        if (copyInto(couponPaymentDate, value, offset, length))
        {
            couponPaymentDateInternalBuffer = couponPaymentDate.byteArray();
        }
        couponPaymentDateOffset = 0;
        couponPaymentDateLength = length;
        return this;
    }
    ...
    private byte[] issueDateInternalBuffer = issueDate.byteArray();
    ...
    {
        if (copyInto(issueDate, value, offset, length))
        {
            issueDateInternalBuffer = issueDate.byteArray();
        }
        issueDateOffset = 0;
        issueDateLength = length;
        return this;
    ...
    private byte[] repoCollateralSecurityTypeInternalBuffer = repoCollateralSecurityType.byteArray();
    ...
    {
        if (copyInto(repoCollateralSecurityType, value, offset, length))
        {
            repoCollateralSecurityTypeInternalBuffer = repoCollateralSecurityType.byteArray();
        }
    ...
    {
        if (toBytes(value, repoCollateralSecurityType))
        {
            repoCollateralSecurityTypeInternalBuffer = repoCollateralSecurityType.byteArray();
        }
        repoCollateralSecurityTypeOffset = 0;
    ...
    {
        if (toBytes(value, repoCollateralSecurityType, offset, length))
        {
            repoCollateralSecurityTypeInternalBuffer = repoCollateralSecurityType.byteArray();
        }
        repoCollateralSecurityTypeOffset = 0;
    ...
    /* RepurchaseRate = 227 */
    public InstrumentEncoder repurchaseRate(ReadOnlyDecimalFloat value)
    {
    ...
    /* Factor = 228 */
    public InstrumentEncoder factor(ReadOnlyDecimalFloat value)
    {
        factor.set(value);
        hasFactor = true;
        return this;
    ...
    private byte[] creditRatingInternalBuffer = creditRating.byteArray();
    ...
    {
        if (copyInto(creditRating, value, offset, length))
        {
            creditRatingInternalBuffer = creditRating.byteArray();
        }
    ...
    {
        if (toBytes(value, creditRating, offset, length))
        {
            creditRatingInternalBuffer = creditRating.byteArray();
        }
        creditRatingOffset = 0;
    ...
    private byte[] instrRegistryInternalBuffer = instrRegistry.byteArray();
    ...
    {
        if (copyInto(instrRegistry, value, offset, length))
        {
            instrRegistryInternalBuffer = instrRegistry.byteArray();
        }
    ...
    {
        if (toBytes(value, instrRegistry))
        {
            instrRegistryInternalBuffer = instrRegistry.byteArray();
        }
        instrRegistryOffset = 0;
    ...
    {
        if (toBytes(value, instrRegistry, offset, length))
        {
            instrRegistryInternalBuffer = instrRegistry.byteArray();
        }
        instrRegistryOffset = 0;
    ...
    private byte[] countryOfIssueInternalBuffer = countryOfIssue.byteArray();
    ...
    {
        if (copyInto(countryOfIssue, value, offset, length))
        {
            countryOfIssueInternalBuffer = countryOfIssue.byteArray();
        }
    ...
    {
        if (toBytes(value, countryOfIssue))
        {
            countryOfIssueInternalBuffer = countryOfIssue.byteArray();
        }
        countryOfIssueOffset = 0;
    ...
    {
        if (toBytes(value, countryOfIssue, offset, length))
        {
            countryOfIssueInternalBuffer = countryOfIssue.byteArray();
        }
        countryOfIssueOffset = 0;
    ...
    private byte[] stateOrProvinceOfIssueInternalBuffer = stateOrProvinceOfIssue.byteArray();
    ...
    {
        if (copyInto(stateOrProvinceOfIssue, value, offset, length))
        {
            stateOrProvinceOfIssueInternalBuffer = stateOrProvinceOfIssue.byteArray();
        }
    ...
    {
        if (toBytes(value, stateOrProvinceOfIssue))
        {
            stateOrProvinceOfIssueInternalBuffer = stateOrProvinceOfIssue.byteArray();
        }
        stateOrProvinceOfIssueOffset = 0;
    ...
    {
        if (toBytes(value, stateOrProvinceOfIssue, offset, length))
        {
            stateOrProvinceOfIssueInternalBuffer = stateOrProvinceOfIssue.byteArray();
        }
        stateOrProvinceOfIssueOffset = 0;
    ...
    private byte[] localeOfIssueInternalBuffer = localeOfIssue.byteArray();
    ...
    {
        if (copyInto(localeOfIssue, value, offset, length))
        {
            localeOfIssueInternalBuffer = localeOfIssue.byteArray();
        }
    ...
    {
        if (toBytes(value, localeOfIssue))
        {
            localeOfIssueInternalBuffer = localeOfIssue.byteArray();
        }
        localeOfIssueOffset = 0;
    ...
    {
        if (toBytes(value, localeOfIssue, offset, length))
        {
            localeOfIssueInternalBuffer = localeOfIssue.byteArray();
        }
        localeOfIssueOffset = 0;
    ...
    private byte[] redemptionDateInternalBuffer = redemptionDate.byteArray();
    ...
    {
        if (copyInto(redemptionDate, value, offset, length))
        {
            redemptionDateInternalBuffer = redemptionDate.byteArray();
        }
        redemptionDateOffset = 0;
        redemptionDateLength = length;
        return this;
    }
    ...
    /* StrikePrice = 202 */
    public InstrumentEncoder strikePrice(ReadOnlyDecimalFloat value)
    {
    ...
    private byte[] strikeCurrencyInternalBuffer = strikeCurrency.byteArray();
    ...
    {
        if (copyInto(strikeCurrency, value, offset, length))
        {
            strikeCurrencyInternalBuffer = strikeCurrency.byteArray();
        }
    ...
    {
        if (toBytes(value, strikeCurrency))
        {
            strikeCurrencyInternalBuffer = strikeCurrency.byteArray();
        }
        strikeCurrencyOffset = 0;
    ...
    {
        if (toBytes(value, strikeCurrency, offset, length))
        {
            strikeCurrencyInternalBuffer = strikeCurrency.byteArray();
        }
        strikeCurrencyOffset = 0;
    ...
    public InstrumentEncoder contractMultiplier(ReadOnlyDecimalFloat value)
    {
    ...
    /* CouponRate = 223 */
    public InstrumentEncoder couponRate(ReadOnlyDecimalFloat value)
    {
    ...
    private byte[] securityExchangeInternalBuffer = securityExchange.byteArray();
    ...
    {
        if (copyInto(securityExchange, value, offset, length))
        {
            securityExchangeInternalBuffer = securityExchange.byteArray();
        }
    ...
    {
        if (toBytes(value, securityExchange))
        {
            securityExchangeInternalBuffer = securityExchange.byteArray();
        }
        securityExchangeOffset = 0;
    ...
    {
        if (toBytes(value, securityExchange, offset, length))
        {
            securityExchangeInternalBuffer = securityExchange.byteArray();
        }
        securityExchangeOffset = 0;
    ...
    private byte[] issuerInternalBuffer = issuer.byteArray();
    ...
    {
        if (copyInto(issuer, value, offset, length))
        {
            issuerInternalBuffer = issuer.byteArray();
        }
        issuerOffset = 0;
        issuerLength = length;
        return this;
    ...
    {
        if (toBytes(value, issuer, offset, length))
        {
            issuerInternalBuffer = issuer.byteArray();
        }
        issuerOffset = 0;
    ...
    private byte[] securityDescInternalBuffer = securityDesc.byteArray();
    ...
    {
        if (copyInto(securityDesc, value, offset, length))
        {
            securityDescInternalBuffer = securityDesc.byteArray();
        }
    ...
    {
        if (toBytes(value, securityDesc, offset, length))
        {
            securityDescInternalBuffer = securityDesc.byteArray();
        }
        securityDescOffset = 0;
    ...
    private byte[] poolInternalBuffer = pool.byteArray();
    ...
    {
        if (copyInto(pool, value, offset, length))
        {
            poolInternalBuffer = pool.byteArray();
        }
        poolOffset = 0;
        poolLength = length;
        return this;
    ...
    {
        if (toBytes(value, pool, offset, length))
        {
            poolInternalBuffer = pool.byteArray();
        }
        poolOffset = 0;
    ...
    private byte[] contractSettlMonthInternalBuffer = contractSettlMonth.byteArray();
    ...
    {
        if (copyInto(contractSettlMonth, value, offset, length))
        {
            contractSettlMonthInternalBuffer = contractSettlMonth.byteArray();
        }
        contractSettlMonthOffset = 0;
        contractSettlMonthLength = length;
        return this;
    }
    ...
    private byte[] cPRegTypeInternalBuffer = cPRegType.byteArray();
    ...
    {
        if (copyInto(cPRegType, value, offset, length))
        {
            cPRegTypeInternalBuffer = cPRegType.byteArray();
        }
        cPRegTypeOffset = 0;
        cPRegTypeLength = length;
        return this;
    ...
    {
        if (toBytes(value, cPRegType, offset, length))
        {
            cPRegTypeInternalBuffer = cPRegType.byteArray();
        }
        cPRegTypeOffset = 0;
...
public static class EventsGroupEncoder
{
    ...
    private byte[] eventDateInternalBuffer = eventDate.byteArray();
    ...
    {
        if (copyInto(eventDate, value, offset, length))
        {
            eventDateInternalBuffer = eventDate.byteArray();
        }
        eventDateOffset = 0;
        eventDateLength = length;
        return this;
    ...
    /* EventPx = 867 */
    public EventsGroupEncoder eventPx(ReadOnlyDecimalFloat value)
    {
        eventPx.set(value);
        hasEventPx = true;
        return this;
    ...
    private byte[] eventTextInternalBuffer = eventText.byteArray();
    ...
    {
        if (copyInto(eventText, value, offset, length))
        {
            eventTextInternalBuffer = eventText.byteArray();
        }
        eventTextOffset = 0;
        eventTextLength = length;
        return this;
    ...
    {
        if (toBytes(value, eventText, offset, length))
        {
            eventTextInternalBuffer = eventText.byteArray();
        }
        eventTextOffset = 0;
    ...
    {
        eventDateLength = 0;
        eventDate.wrap(eventDateInternalBuffer);
    }
    ...
    {
        eventTextLength = 0;
        eventText.wrap(eventTextInternalBuffer);
    }
    ...
    private byte[] datedDateInternalBuffer = datedDate.byteArray();
    ...
    {
        if (copyInto(datedDate, value, offset, length))
        {
            datedDateInternalBuffer = datedDate.byteArray();
        }
        datedDateOffset = 0;
        datedDateLength = length;
        return this;
    ...
    private byte[] interestAccrualDateInternalBuffer = interestAccrualDate.byteArray();
    ...
    {
        if (copyInto(interestAccrualDate, value, offset, length))
        {
            interestAccrualDateInternalBuffer = interestAccrualDate.byteArray();
        }
        interestAccrualDateOffset = 0;
        interestAccrualDateLength = length;
        return this;
    }
    ...
    {
        symbolSfxLength = 0;
        symbolSfx.wrap(symbolSfxInternalBuffer);
    }

    public void resetSecurityID()
    {
        securityIDLength = 0;
        securityID.wrap(securityIDInternalBuffer);
    }

    public void resetSecurityIDSource()
    {
        securityIDSourceLength = 0;
        securityIDSource.wrap(securityIDSourceInternalBuffer);
    }
    ...
    public void resetMaturityMonthYear()
    {
        ...
        maturityMonthYear.wrap(maturityMonthYearInternalBuffer);
    }

    public void resetMaturityDate()
    {
        maturityDateLength = 0;
        maturityDate.wrap(maturityDateInternalBuffer);
    }
    ...
    public void resetCouponPaymentDate()
    {
        ...
        couponPaymentDate.wrap(couponPaymentDateInternalBuffer);
    }

    public void resetIssueDate()
    {
        issueDateLength = 0;
        issueDate.wrap(issueDateInternalBuffer);
    }

    public void resetRepoCollateralSecurityType()
    {
        repoCollateralSecurityTypeLength = 0;
        repoCollateralSecurityType.wrap(repoCollateralSecurityTypeInternalBuffer);
    }
    ...
    public void resetCreditRating()
    {
        ...
        creditRating.wrap(creditRatingInternalBuffer);
    }

    public void resetInstrRegistry()
    {
        instrRegistryLength = 0;
        instrRegistry.wrap(instrRegistryInternalBuffer);
    }

    public void resetCountryOfIssue()
    {
        countryOfIssueLength = 0;
        countryOfIssue.wrap(countryOfIssueInternalBuffer);
    }

    public void resetStateOrProvinceOfIssue()
    {
        stateOrProvinceOfIssueLength = 0;
        stateOrProvinceOfIssue.wrap(stateOrProvinceOfIssueInternalBuffer);
    }

    public void resetLocaleOfIssue()
    {
        localeOfIssueLength = 0;
        localeOfIssue.wrap(localeOfIssueInternalBuffer);
    }

    public void resetRedemptionDate()
    {
        redemptionDateLength = 0;
        redemptionDate.wrap(redemptionDateInternalBuffer);
    }
    ...
    public void resetStrikeCurrency()
    {
        ...
        strikeCurrency.wrap(strikeCurrencyInternalBuffer);
    }
    ...
    public void resetSecurityExchange()
    {
        ...
        securityExchange.wrap(securityExchangeInternalBuffer);
    }

    public void resetIssuer()
    {
        issuerLength = 0;
        issuer.wrap(issuerInternalBuffer);
    }
    ...
    public void resetSecurityDesc()
    {
        ...
        securityDesc.wrap(securityDescInternalBuffer);
    }
    ...
    {
        poolLength = 0;
        pool.wrap(poolInternalBuffer);
    }

    public void resetContractSettlMonth()
    {
        contractSettlMonthLength = 0;
        contractSettlMonth.wrap(contractSettlMonthInternalBuffer);
    }
    ...
    {
        cPRegTypeLength = 0;
        cPRegType.wrap(cPRegTypeInternalBuffer);
    }

    public void resetDatedDate()
    {
        datedDateLength = 0;
        datedDate.wrap(datedDateInternalBuffer);
    }

    public void resetInterestAccrualDate()
    {
        interestAccrualDateLength = 0;
        interestAccrualDate.wrap(interestAccrualDateInternalBuffer);
    }
